...
@EnableJpaRepositories(basePackages = "com.wms.spark.core.repository", entityManagerFactoryRef = "entityManager", transactionManagerRef = "multiTransactionManager")
public class DataSourceConfig {
    ...
    public DynamicDataSource dataSource() {
        ...
        DataSource db4 = createDataSource("AHM");
    ...
    private DataSource createDataSource(String dbName) {
        ...
        switch (dbName) {
            ...
            case "CMP":
                dataSource.setDriverClassName("com.microsoft.sqlserver.jdbc.SQLServerDriver");
                dataSource.setUrl("jdbc:sqlserver://10.20.0.19;databaseName=WMS_CBE");
                dataSource.setUsername("sa");
                dataSource.setPassword("TvHcGBR84nxvyJx6EPpoOsL5V");
                break;
            case "CHN":
                dataSource.setDriverClassName("com.microsoft.sqlserver.jdbc.SQLServerDriver");
                dataSource.setUrl("jdbc:sqlserver://10.20.0.19;databaseName=WMS_CHN");
                dataSource.setUsername("sa");
                dataSource.setPassword("TvHcGBR84nxvyJx6EPpoOsL5V");
                break;
            case "AHM":
                dataSource.setDriverClassName("com.microsoft.sqlserver.jdbc.SQLServerDriver");
                dataSource.setUrl("jdbc:sqlserver://10.10.10.61;databaseName=WMS_AHM");
                dataSource.setUsername("sa");
    ...
    public LocalContainerEntityManagerFactoryBean entityManager() throws PropertyVetoException {
        ...
        entityManagerFactory.setPackagesToScan("com.wms.spark.core.model");
