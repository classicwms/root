...
public class QualityLineService {
    ...
    public QualityLineService() throws ParseException {
        ...
        //Read from Sql Table
        val df2 = sparkSession.read().jdbc("jdbc:sqlserver://10.10.10.61;databaseName=WMS_ALMPRD", "tblqualityline", connProp)
                .repartition(16);
