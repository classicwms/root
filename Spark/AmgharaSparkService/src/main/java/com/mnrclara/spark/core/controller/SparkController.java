...
public class SparkController {
    ...
    @Autowired
    PreInboundHeaderService sparkPreInboundHeaderService;

    @Autowired
    OrderManagementLineService sparkOrderManagementLineService;

    @Autowired
    ContainerReceiptService sparkContainerReceiptService;

    @Autowired
    GrHeaderService sparkGrHeaderService;

    @Autowired
    PutAwayHeaderService sparkPutAwayHeaderService;

    @Autowired
    StagingHeaderService stagingHeaderService;

    @Autowired
    InboundHeaderService sparkInboundHeaderService;

    @Autowired
    PreOutboundHeaderService sparkPreOutboundHeaderService;

    @Autowired
    OutBoundReversalService sparkOutBoundReversalService;

    @Autowired
    OutBoundHeaderService sparkOutBoundHeaderService;

    @Autowired
    PickupHeaderService sparkPickupHeaderService;

    @Autowired
    QualityHeaderService sparkQualityHeaderService;

    @Autowired
    StorageBinService sparkStorageBinService;

    @Autowired
    PickupLineService sparkPickupLineService;

    @Autowired
    InventoryMovementService sparkInventoryMovementService;

    @Autowired
    InhouseTransferLineService sparkInhouseTransferLineService;

    @Autowired
    InventoryService sparkInventoryService;

    @Autowired
    PutAwayLineService sparkPutAwayLineService;

    @Autowired
    PeriodicHeaderService sparkPeriodicHeaderService;

    @Autowired
    PerpetualHeaderService sparkPerpetualHeaderService;

    @Autowired
    InboundLineService sparkInboundLineService;

    @Autowired
    StockReportService sparkStockReportService;

    @Autowired
    InhouseTransferHeaderService sparkInhouseTransferHeaderService;

    @Autowired
    OrderStatusReportService sparkOrderStatusReportService;

    @Autowired
    PerpetualLineService sparkPerpetualLineService;

    @Autowired
    PeriodicLineService sparkPeriodicLineService;

    @Autowired
    PreOutBoundLineService sparkPreOutBoundLineService;

    @Autowired
    StagingLineV2Service sparkStagingLineV2Service;

    @Autowired
    GrLineService sparkGrLineService;

    @Autowired
    QualityLineService sparkQualityLineService;

    @Autowired
    ImBasicData1V3Service sparkImBasicData1V3Service;

    @Autowired
    ImBasicData1V5Service sparkImBasicData1V5Service;

    @Autowired
    BusinessPartnerService sparkBusinessPartnerService;

    @Autowired
    AmgharaIBLineService ibLineService;

    @Autowired
    InventoryServiceV3 sparkInventoryV3Service;

    @Autowired
    PutAwayLineNewServiceV2 sparkPutAwayLineNewServiceV2;
    //=======================================================================================================================
