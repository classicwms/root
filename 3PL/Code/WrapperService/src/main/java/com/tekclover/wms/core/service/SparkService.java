...
//        headers.add("Authorization", "Bearer " + authToken);
            ...
            UriComponentsBuilder builder =
                    UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "tpl/spark/storagebin");
...
//        headers.add("Authorization", "Bearer " + authToken);
            ...
            UriComponentsBuilder builder =
                    UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "tpl/spark/containerReceipt");
...
//        headers.add("Authorization", "Bearer " + authToken);
            ...
            UriComponentsBuilder builder =
                    UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "tpl/spark/preinboundHeader");
...
//        headers.add("Authorization", "Bearer " + authToken);
            ...
            UriComponentsBuilder builder =
                    UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "tpl/spark/stagingheader");
...
//        headers.add("Authorization", "Bearer " + authToken);
            ...
            UriComponentsBuilder builder =
                    UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "tpl/spark/grheader");
...
//        headers.add("Authorization", "Bearer " + authToken);
            ...
            UriComponentsBuilder builder =
                    UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "tpl/spark/putawayheader");
...
//        headers.add("Authorization", "Bearer " + authToken);
            ...
            UriComponentsBuilder builder =
                    UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "tpl/spark/inboundHeader");
            HttpEntity<?> entity = new HttpEntity<>(searchInboundHeaderV2, headers);
...
//        headers.add("Authorization", "Bearer " + authToken);
            ...
            UriComponentsBuilder builder =
                    UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "tpl/spark/preoutboundheader");
...
//        headers.add("Authorization", "Bearer " + authToken);
            ...
            UriComponentsBuilder builder =
                    UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "tpl/spark/ordermanagementline");
...
//        headers.add("Authorization", "Bearer " + authToken);
            ...
            UriComponentsBuilder builder =
                    UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "tpl/spark/pickupheader");
...
//        headers.add("Authorization", "Bearer " + authToken);
            ...
            UriComponentsBuilder builder =
                    UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "tpl/spark/qualityheader");
...
//        headers.add("Authorization", "Bearer " + authToken);
            ...
            UriComponentsBuilder builder =
                    UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "tpl/spark/outboundheader");
...
//        headers.add("Authorization", "Bearer " + authToken);
            ...
            UriComponentsBuilder builder =
                    UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "tpl/spark/outboundreversal");
...
//        headers.add("Authorization", "Bearer " + authToken);
            ...
            UriComponentsBuilder builder =
                    UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "tpl/spark/pickupline");
...
//        headers.add("Authorization", "Bearer " + authToken);
            ...
            UriComponentsBuilder builder =
                    UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "tpl/spark/inventorymovement");
...
//        headers.add("Authorization", "Bearer " + authToken);
            ...
            UriComponentsBuilder builder = UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "tpl/spark/inventory");
...
//        headers.add("Authorization", "Bearer " + authToken);
            ...
            UriComponentsBuilder builder = UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "tpl/spark/putawayline");
            HttpEntity<?> entity = new HttpEntity<>(findInventoryV2, headers);
...
//        headers.add("Authorization", "Bearer " + authToken);
            ...
            UriComponentsBuilder builder = UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "tpl/spark/periodicheader");
...
//        headers.add("Authorization", "Bearer " + authToken);
            ...
            UriComponentsBuilder builder =
                    UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "tpl/spark/inhousetransferline");
...
//        headers.add("Authorization", "Bearer " + authToken);
            ...
            UriComponentsBuilder builder = UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "tpl/spark/perpetualheader");
...
//        headers.add("Authorization", "Bearer " + authToken);
            ...
            UriComponentsBuilder builder = UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "tpl/spark/inboundline");
...
//        headers.add("Authorization", "Bearer " + authToken);
            ...
            UriComponentsBuilder builder = UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "tpl/spark/inhousetransferheader");
...
//        headers.add("Authorization", "Bearer " + authToken);
            ...
            UriComponentsBuilder builder = UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "tpl/spark/stockreport");
...
//        headers.add("Authorization", "Bearer " + authToken);
            ...
            UriComponentsBuilder builder = UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "tpl/spark/periodicline");
...
//        headers.add("Authorization", "Bearer " + authToken);
            ...
            UriComponentsBuilder builder = UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "tpl/spark/perpetualline");
...
//        headers.add("Authorization", "Bearer " + authToken);
            ...
            UriComponentsBuilder builder = UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "tpl/spark/preoutboundline");
...
//        headers.add("Authorization", "Bearer " + authToken);
            ...
            UriComponentsBuilder builder =
                    UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "tpl/spark/stagingLine");
...
//        headers.add("Authorization", "Bearer " + authToken);
            ...
            UriComponentsBuilder builder =
                    UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "tpl/spark/grline");
...
//        headers.add("Authorization", "Bearer " + authToken);
            ...
            UriComponentsBuilder builder = UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "tpl/spark/qualityline");
...
//        headers.add("Authorization", "Bearer " + authToken);
            ...
            UriComponentsBuilder builder = UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "tpl/spark/imbasicdata1v3");
            HttpEntity<?> entity = new HttpEntity<>(searchImBasicData1, headers);
...
//        headers.add("Authorization", "Bearer " + authToken);
            ...
            UriComponentsBuilder builder = UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "tpl/spark/imbasicdata1v5");
            HttpEntity<?> entity = new HttpEntity<>(searchImBasicData1, headers);
            ResponseEntity<ImBasicData1V3[]> result = getRestTemplate().exchange(builder.toUriString(), HttpMethod.POST, entity, ImBasicData1V3[].class);
            log.info("result: " + result.getStatusCode());
            return result.getBody();
...
//        headers.add("Authorization", "Bearer " + authToken);
            ...
            UriComponentsBuilder builder = UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "tpl/spark/businessPartner");
...
//        headers.add("Authorization", "Bearer " + authToken);
            ...
            UriComponentsBuilder builder = UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "tpl/spark/inboundLineV3");
            HttpEntity<?> entity = new HttpEntity<>(findInboundLineV2, headers);
...
//        headers.add("Authorization", "Bearer " + authToken);
            ...
            UriComponentsBuilder builder = UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "tpl/spark/outboundHeaderTest");
...
//        headers.add("Authorization", "Bearer " + authToken);
            ...
            UriComponentsBuilder builder = UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "tpl/spark/inventoryv2/new");
...
//        headers.add("Authorization", "Bearer " + authToken);
            ...
            UriComponentsBuilder builder = UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "tpl/spark/putawayline/new");
    ...
    public InboundLineV4[] findInboundLinev4(FindInboundLineV2 findInboundLineV2) {
        try {
            ...
            headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
            headers.add("User-Agent", " RestTemplate");
            UriComponentsBuilder builder = UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "tpl/spark/inboundLine/new");
            HttpEntity<?> entity = new HttpEntity<>(findInboundLineV2, headers);
    ...
    public PickUpLineV3[] findPickUpLineV3(SearchPickupLineV3 searchPickupLineV3) {
        try {
            ...
            headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
            headers.add("User-Agent", " RestTemplate");
            UriComponentsBuilder builder = UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "tpl/spark/pickuplinev3/new");
    ...
    public OutboundLineV3[] findOutboundLineV3(FindOutboundLineV2 findOutboundLineV2) {
        try {
            ...
            headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
            headers.add("User-Agent", " RestTemplate");
            UriComponentsBuilder builder = UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "tpl/spark/outboundv3/new");
    ...
    public GrLineV3[] findGrLineV3(FindGrLineV2 findGrLineV2) {
        try {
            ...
            headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
            headers.add("User-Agent", " RestTemplate");
            UriComponentsBuilder builder = UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "tpl/spark/grline/v3");
            HttpEntity<?> entity = new HttpEntity<>(findGrLineV2, headers);
    ...
    public OutboundHeaderV3[] findOutboundOrderSummaryReport(FindOutBoundHeaderV2 findOutBoundHeaderV2) {
        try {
            ...
            headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
            headers.add("User-Agent", " RestTemplate");
            UriComponentsBuilder builder = UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "tpl/spark/obHeader/obOrderSummaryReport");
            HttpEntity<?> entity = new HttpEntity<>(findOutBoundHeaderV2, headers);
