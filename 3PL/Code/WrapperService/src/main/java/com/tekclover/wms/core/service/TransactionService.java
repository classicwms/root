...
public List<BinVolume> getBinVolumes(String companyCodeId, String plantId, String languageId, String warehouseId, String authToken) {
    ...
    // POST - ASN V2 upload
    public WarehouseApiResponse[] postSOV2Upload(List<ShipmentOrderV2> shipmentOrderV2List, String loginUserID, String authToken) {
        HttpHeaders headers = new HttpHeaders();
        headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
        headers.add("User-Agent", "RestTemplate");
        headers.add("Authorization", "Bearer " + authToken);
        UriComponentsBuilder builder =
                UriComponentsBuilder.fromHttpUrl(getTransactionServiceApiUrl() + "warehouse/outbound/so/upload/v2")
                        .queryParam("loginUserID", loginUserID);
        HttpEntity<?> entity = new HttpEntity<>(shipmentOrderV2List, headers);
        ResponseEntity<WarehouseApiResponse[]> result =
                getRestTemplate().exchange(builder.toUriString(), HttpMethod.POST, entity, WarehouseApiResponse[].class);
        return result.getBody();
    }
...
//                    .queryParam("storageBin", storageBin)
  ...
  public InboundOrderLinesV2[] findInboundOrderLinesV2(FindInboundOrderLineV2 findInboundOrderLineV2, String authToken) {
    ...
    // POST Packing Line
    public PackingLine[] createPackingLine (@Valid List<AddPackingLine> newPackingLine, String loginUserID, String authToken) {
        try {
            HttpHeaders headers = new HttpHeaders();
            headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
            headers.add("User-Agent", "RestTemplate");
            ...
            UriComponentsBuilder builder = UriComponentsBuilder.fromHttpUrl(getTransactionServiceApiUrl() + "packingline")
                    .queryParam("loginUserID", loginUserID);
            HttpEntity<?> entity = new HttpEntity<>(newPackingLine, headers);
            ResponseEntity<PackingLine[]> result =
                    getRestTemplate().exchange(builder.toUriString(), HttpMethod.POST, entity, PackingLine[].class);
//			log.info("result : " + result.getStatusCode());
            return result.getBody();
        } catch (Exception e) {
            throw e;
    ...
    // Get ALL
    public PackingLine[] getPackingLines(String authToken) {
        try {
            HttpHeaders headers = new HttpHeaders();
            headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
            ...
            HttpEntity<?> entity = new HttpEntity<>(headers);
            UriComponentsBuilder builder = UriComponentsBuilder.fromHttpUrl(getTransactionServiceApiUrl() + "packingline");
            ResponseEntity<PackingLine[]> result = getRestTemplate().exchange(builder.toUriString(), HttpMethod.GET, entity, PackingLine[].class);
            log.info("result : " + result.getStatusCode());
            return result.getBody();
        } catch (Exception e) {
            e.printStackTrace();
    ...
    // GET PackingLine
    public PackingLine getPackingLine(String languageId, String companyCodeId, String plantId, String warehouseId,
        ...
        try {
            ...
            HttpEntity<?> entity = new HttpEntity<>(headers);
            UriComponentsBuilder builder =
                    UriComponentsBuilder.fromHttpUrl(getTransactionServiceApiUrl() + "packingline/" + itemCode)
                            .queryParam("languageId", languageId)
                            .queryParam("companyCodeId", companyCodeId)
                            .queryParam("plantId", plantId)
                            .queryParam("warehouseId", warehouseId)
                            ...
                            .queryParam("refDocNumber", refDocNumber)
                            .queryParam("partnerCode", partnerCode)
                            .queryParam("packingNo", packingNo)
                            .queryParam("lineNumber", lineNumber);
            ResponseEntity<PackingLine> result = getRestTemplate().exchange(builder.toUriString(), HttpMethod.GET, entity, PackingLine.class);
            log.info("result : " + result.getStatusCode());
            return result.getBody();
    ...
    // GET - findPackingLine
    public PackingLine[] findPackingLine(SearchPackingLine searchPackingLine, String authToken) {
        try {
            HttpHeaders headers = new HttpHeaders();
            headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
            headers.add("User-Agent", "RestTemplate");
            headers.add("Authorization", "Bearer " + authToken);
            UriComponentsBuilder builder = UriComponentsBuilder.fromHttpUrl(getTransactionServiceApiUrl() + "packingline/findPackingLine");
            HttpEntity<?> entity = new HttpEntity<>(searchPackingLine, headers);
            ResponseEntity<PackingLine[]> result =
                    getRestTemplate().exchange(builder.toUriString(), HttpMethod.POST, entity, PackingLine[].class);
            log.info("result : " + result.getStatusCode());
            return result.getBody();
    ...
    // Patch PackingLine
    public PackingLine updatePackingLine(String languageId, String companyCodeId, String plantId, String warehouseId, String preOutboundNo, String refDocNumber, String partnerCode, Long lineNumber, String packingNo, String itemCode,
                                     UpdatePackingLine updatePackingLine ,String loginUserID, String authToken) {
        try {
            HttpHeaders headers = new HttpHeaders();
            headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
            headers.add("User-Agent", "Classic WMS's RestTemplate");
            ...
            HttpEntity<?> entity = new HttpEntity<>(updatePackingLine, headers);
            ...
            ResponseEntity<PackingLine> result = restTemplate.exchange(builder.toUriString(), HttpMethod.PATCH, entity, PackingLine.class);
            log.info("result : " + result.getStatusCode());
            return result.getBody();
        } catch (Exception e) {
            e.printStackTrace();
 ...
 // Delete PackingLine
    public boolean deletePackingLine(String languageId, String companyCodeId, String plantId, String warehouseId, String preOutboundNo,
                                     String refDocNumber, String partnerCode, Long lineNumber, String packingNo, String itemCode, String loginUserID, String authToken) {
        try {
            HttpHeaders headers = new HttpHeaders();
            headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
    ...
    //==========================================PackingHeader==========================================
// Get ALL
    public PackingHeader[] getPackingHeaders(String authToken) {
        try {
            HttpHeaders headers = new HttpHeaders();
            headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
            headers.add("User-Agent", "Classic WMS's RestTemplate");
            headers.add("Authorization", "Bearer " + authToken);
            HttpEntity<?> entity = new HttpEntity<>(headers);
            UriComponentsBuilder builder = UriComponentsBuilder.fromHttpUrl(getTransactionServiceApiUrl() + "packingheader");
            ResponseEntity<PackingHeader[]> result = getRestTemplate().exchange(builder.toUriString(), HttpMethod.GET, entity, PackingHeader[].class);
            log.info("result : " + result.getStatusCode());
            return result.getBody();
        } catch (Exception e) {
            e.printStackTrace();
    ...
    // POST Packing Header
    public PackingHeader createPackingHeader (@Valid AddPackingHeader newPackingHeader, String loginUserID, String authToken) {
        try {
            HttpHeaders headers = new HttpHeaders();
            headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
            headers.add("User-Agent", "RestTemplate");
            ...
            UriComponentsBuilder builder = UriComponentsBuilder.fromHttpUrl(getTransactionServiceApiUrl() + "packingheader")
                    .queryParam("loginUserID", loginUserID);
            HttpEntity<?> entity = new HttpEntity<>(newPackingHeader, headers);
            ResponseEntity<PackingHeader> result =
                    getRestTemplate().exchange(builder.toUriString(), HttpMethod.POST, entity, PackingHeader.class);
//			log.info("result : " + result.getStatusCode());
            return result.getBody();
        } catch (Exception e) {
            throw e;
    ...
    public PackingHeader getPackingHeader(String languageId, String companyCodeId, String plantId, String warehouseId,
                                      ...
                                      String packingNo, String authToken) {
        try {
            HttpHeaders headers = new HttpHeaders();
            headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
            headers.add("User-Agent", "Classic WMS's RestTemplate");
            ...
            HttpEntity<?> entity = new HttpEntity<>(headers);
            UriComponentsBuilder builder =
                    UriComponentsBuilder.fromHttpUrl(getTransactionServiceApiUrl() + "packingheader/" + packingNo)
                            .queryParam("preOutboundNo", preOutboundNo)
                            .queryParam("companyCodeId", companyCodeId)
                            .queryParam("plantId", plantId)
                            .queryParam("languageId", languageId)
    ...
    // GET - findPackingHeader
    public PackingHeader[] findPackingHeader(SearchPackingHeader searchPackingHeader, String authToken) {
        try {
            HttpHeaders headers = new HttpHeaders();
            headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
            headers.add("User-Agent", "RestTemplate");
            headers.add("Authorization", "Bearer " + authToken);
            UriComponentsBuilder builder = UriComponentsBuilder.fromHttpUrl(getTransactionServiceApiUrl() + "packingheader/findPackingHeader");
            HttpEntity<?> entity = new HttpEntity<>(searchPackingHeader, headers);
            ResponseEntity<PackingHeader[]> result =
                    getRestTemplate().exchange(builder.toUriString(), HttpMethod.POST, entity, PackingHeader[].class);
            log.info("result : " + result.getStatusCode());
            return result.getBody();
    ...
    public PackingHeader updatePackingHeader(String languageId, String companyCodeId, String plantId, String warehouseId, String preOutboundNo, String refDocNumber, String partnerCode, String qualityInspectionNo, String packingNo,
                                         UpdatePackingHeader updatePackingHeader ,String loginUserID, String authToken) {
        try {
            HttpHeaders headers = new HttpHeaders();
            headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
            headers.add("User-Agent", "Classic WMS's RestTemplate");
            ...
            HttpEntity<?> entity = new HttpEntity<>(updatePackingHeader, headers);
            ...
            ResponseEntity<PackingHeader> result = restTemplate.exchange(builder.toUriString(), HttpMethod.PATCH, entity, PackingHeader.class);
            log.info("result : " + result.getStatusCode());
            return result.getBody();
        } catch (Exception e) {
            e.printStackTrace();
    ...
    // Delete PackingHeader
    public boolean deletePackingHeader(String languageId, String companyCodeId, String plantId, String warehouseId, String preOutboundNo,
                                       String refDocNumber, String partnerCode, String qualityInspectionNo, String packingNo, String loginUserID, String authToken) {
        try {
            HttpHeaders headers = new HttpHeaders();
            headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
            headers.add("User-Agent", "'s RestTemplate");
    ...
    // POST ProformaInvoiceHeader
    public ProformaInvoiceHeader createProformaInvoiceHeader (@Valid AddProformaInvoiceHeader newProformaInvoiceHeader, String loginUserID, String authToken) {
        try {
            HttpHeaders headers = new HttpHeaders();
            headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
            headers.add("User-Agent", "RestTemplate");
...
//			log.info("result : " + result.getStatusCode());
    ...
    // GET ProformaInvoiceHeader
    public ProformaInvoiceHeader getProformaInvoiceHeader(String companyCodeId, String plantId, String languageId, String warehouseId, String proformaBillNo, String partnerCode, String authToken) {
        try {
            HttpHeaders headers = new HttpHeaders();
            headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
            headers.add("User-Agent", "Classic WMS's RestTemplate");
    ...
    // Delete ProformaInvoiceHeader
    public boolean deleteProformaInvoiceHeader(String companyCodeId, String plantId, String languageId, String warehouseId,
                                               String proformaBillNo, String partnerCode, String loginUserID, String authToken) {
        try {
            HttpHeaders headers = new HttpHeaders();
            headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
            headers.add("User-Agent", "'s RestTemplate");
    ...
    // FIND ALL - FindPerformaInvoiceHeader
    public ProformaInvoiceHeader[] findProformaInvoiceHeader(FindProformaInvoiceHeader searchProformaInvoiceHeader, String authToken) throws ParseException {
        try {
            HttpHeaders headers = new HttpHeaders();
            headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
            headers.add("User-Agent", "ClassicWMS RestTemplate");
            headers.add("Authorization", "Bearer " + authToken);
            UriComponentsBuilder builder = UriComponentsBuilder
                    .fromHttpUrl(getTransactionServiceApiUrl() + "proformaInvoiceHeader/findProformaInvoiceHeader");
            HttpEntity<?> entity = new HttpEntity<>(searchProformaInvoiceHeader, headers);
            ResponseEntity<ProformaInvoiceHeader[]> result = getRestTemplate().exchange(builder.toUriString(),
                    HttpMethod.POST, entity, ProformaInvoiceHeader[].class);
            log.info("result : " + result.getStatusCode());
    ...
    /**
     *
     * @param newProformaInvoice
     * @param loginUserID
     * @param authToken
     * @return
     */
    public ProformaInvoice[] createProformaInvoiceHeaderAndLine ( List<ProformaInvoice> newProformaInvoice, String loginUserID, String authToken) {
        try {
            log.info("newProformaInvoice"+newProformaInvoice);
            HttpHeaders headers = new HttpHeaders();
            headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
            headers.add("User-Agent", "RestTemplate");
            headers.add("Authorization", "Bearer " + authToken);

            UriComponentsBuilder builder = UriComponentsBuilder.fromHttpUrl(getTransactionServiceApiUrl() + "proformaInvoiceHeader/headerAndLine")
                    .queryParam("loginUserID", loginUserID);
            HttpEntity<?> entity = new HttpEntity<>(newProformaInvoice,headers);
            ResponseEntity<ProformaInvoice[]> result =
                    getRestTemplate().exchange(builder.toUriString(), HttpMethod.POST, entity, ProformaInvoice[].class);
//			log.info("result : " + result.getStatusCode());
            return result.getBody();
        } catch (Exception e) {
            throw e;
    ...
    // FIND ALL - FindProformaInvoiceLine
    public ProformaInvoiceLine[] findProformaInvoiceLine(FindProformaInvoiceLine searchProformaInvoiceLine, String authToken) throws ParseException {
        try {
            HttpHeaders headers = new HttpHeaders();
            headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
            headers.add("User-Agent", "ClassicWMS RestTemplate");
            headers.add("Authorization", "Bearer " + authToken);
            UriComponentsBuilder builder = UriComponentsBuilder
                    .fromHttpUrl(getTransactionServiceApiUrl() + "proformaInvoiceLine/findProformaInvoiceLine");
            HttpEntity<?> entity = new HttpEntity<>(searchProformaInvoiceLine, headers);
            ResponseEntity<ProformaInvoiceLine[]> result = getRestTemplate().exchange(builder.toUriString(),
                    HttpMethod.POST, entity, ProformaInvoiceLine[].class);
            log.info("result : " + result.getStatusCode());
    ...
    // POST ProformaInvoiceLine
    public ProformaInvoiceLine createProformaInvoiceLine (@Valid AddProformaInvoiceLine newProformaInvoiceLine, String loginUserID, String authToken) {
        try {
            HttpHeaders headers = new HttpHeaders();
            headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
            headers.add("User-Agent", "RestTemplate");
...
//			log.info("result : " + result.getStatusCode());
    ...
    // GET ProformaInvoiceLine
    public ProformaInvoiceLine getProformaInvoiceLine(String companyCodeId, String plantId, String languageId, String warehouseId, String proformaBillNo,
                                                      String partnerCode, Long lineNumber, String authToken) {
        try {
            HttpHeaders headers = new HttpHeaders();
            headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
            headers.add("User-Agent", "Classic WMS's RestTemplate");
    ...
    // Patch ProformaInvoiceLine
    public ProformaInvoiceLine[] updateProformaInvoiceLine(List<AddProformaInvoiceLine> updateProformaInvoiceLine, String loginUserID, String authToken) {
        try {
            HttpHeaders headers = new HttpHeaders();
            headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
            headers.add("User-Agent", "Classic WMS's RestTemplate");
            ...
            UriComponentsBuilder builder =
                    UriComponentsBuilder.fromHttpUrl(getTransactionServiceApiUrl() + "proformaInvoiceLine/update" )
                            .queryParam("loginUserID", loginUserID);
    ...
    // Delete ProformaInvoiceLine
    public boolean deleteProformaInvoiceLine(String companyCodeId, String plantId, String languageId, String warehouseId,
                                             String proformaBillNo, String partnerCode, Long lineNumber, String loginUserID, String authToken) {
        try {
            HttpHeaders headers = new HttpHeaders();
            headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
            headers.add("User-Agent", "'s RestTemplate");
     ...
     * @return
     */
    public ProformaInvoice[] getInvoiceExecute(FindInvoice findInvoice, String authToken) {
        try {
            HttpHeaders headers = new HttpHeaders();
            headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
            headers.add("User-Agent", "ClassicWMS RestTemplate");
            ...
            UriComponentsBuilder builder = UriComponentsBuilder
                    .fromHttpUrl(getTransactionServiceApiUrl() + "proformaInvoiceHeader/execute");

            HttpEntity<?> entity = new HttpEntity<>(findInvoice, headers);
            ResponseEntity<ProformaInvoice[]> result = getRestTemplate().exchange(builder.toUriString(),
                    HttpMethod.POST, entity, ProformaInvoice[].class);
            log.info("result : " + result.getBody());
            return result.getBody();
        } catch (Exception e) {
            e.printStackTrace();
    ...
    // POST StockMovement Line
    public StockMovement[] createStockMovement (@Valid List<StockMovement> newStockMovement, String loginUserID, String authToken) {
        try {
            HttpHeaders headers = new HttpHeaders();
            headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
            headers.add("User-Agent", "RestTemplate");
            ...
            UriComponentsBuilder builder = UriComponentsBuilder.fromHttpUrl(getTransactionServiceApiUrl() + "stockMovement")
                    .queryParam("loginUserID", loginUserID);
            HttpEntity<?> entity = new HttpEntity<>(newStockMovement, headers);
            ResponseEntity<StockMovement[]> result =
                    getRestTemplate().exchange(builder.toUriString(), HttpMethod.POST, entity, StockMovement[].class);
//			log.info("result : " + result.getStatusCode());
            return result.getBody();
        } catch (Exception e) {
            throw e;
    ...
    // Get ALL
    public StockMovement[] getStockMovements(String authToken) {
        try {
            HttpHeaders headers = new HttpHeaders();
            headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
            headers.add("User-Agent", "Classic WMS's RestTemplate");
            ...
            HttpEntity<?> entity = new HttpEntity<>(headers);
            UriComponentsBuilder builder = UriComponentsBuilder.fromHttpUrl(getTransactionServiceApiUrl() + "stockMovement");
            ResponseEntity<StockMovement[]> result = getRestTemplate().exchange(builder.toUriString(), HttpMethod.GET, entity, StockMovement[].class);
            log.info("result : " + result.getStatusCode());
            return result.getBody();
        } catch (Exception e) {
            e.printStackTrace();
    ...
    // GET StockMovement
    public StockMovement getStockMovement(Long movementDocNo, String languageId, String companyCodeId,
                                          String plantId, String warehouseId, String itemCode, String authToken) {
        try {
            HttpHeaders headers = new HttpHeaders();
            headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
            headers.add("User-Agent", "Classic WMS's RestTemplate");
            ...
            HttpEntity<?> entity = new HttpEntity<>(headers);
            UriComponentsBuilder builder =
                    UriComponentsBuilder.fromHttpUrl(getTransactionServiceApiUrl() + "stockMovement/" + movementDocNo)
                            .queryParam("languageId", languageId)
                            .queryParam("companyCodeId", companyCodeId)
                            .queryParam("plantId", plantId)
                            .queryParam("warehouseId", warehouseId)
    ...
    // GET - findStockMovement
    public StockMovement[] findStockMovement(FindStockMovement findStockMovement, String authToken) {
        try {
            HttpHeaders headers = new HttpHeaders();
            headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
            headers.add("User-Agent", "RestTemplate");
            headers.add("Authorization", "Bearer " + authToken);
            UriComponentsBuilder builder = UriComponentsBuilder.fromHttpUrl(getTransactionServiceApiUrl() + "stockMovement/findPackingLine");
            HttpEntity<?> entity = new HttpEntity<>(findStockMovement, headers);
            ResponseEntity<StockMovement[]> result =
                    getRestTemplate().exchange(builder.toUriString(), HttpMethod.POST, entity, StockMovement[].class);
            log.info("result : " + result.getStatusCode());
            return result.getBody();
    ...
    // Patch StockMovement
    public StockMovement[] updateStockMovement(Long movementDocNo, String languageId, String companyCodeId,
                                               String plantId, String warehouseId, String itemCode, List<StockMovement> updateStockMovement,
                                               String loginUserID, String authToken) {
        try {
            HttpHeaders headers = new HttpHeaders();
            headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
            ...
            HttpEntity<?> entity = new HttpEntity<>(updateStockMovement, headers);
            ...
            ResponseEntity<StockMovement[]> result = restTemplate.exchange(builder.toUriString(), HttpMethod.PATCH, entity, StockMovement[].class);
            log.info("result : " + result.getStatusCode());
            return result.getBody();
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public boolean deleteStockMovement(String companyCodeId, String plantId, String languageId, String warehouseId, String itemCode,
                                       Long movementDocNo, String loginUserID, String authToken) {
        try {
            HttpHeaders headers = new HttpHeaders();
            headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
            headers.add("User-Agent", "'s RestTemplate");
    ...
    // POST InvoiceHeader
    public InvoiceHeader createInvoiceHeader (@Valid InvoiceHeader invoiceHeader, String loginUserID, String authToken) {
        try {
            HttpHeaders headers = new HttpHeaders();
            headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
            headers.add("User-Agent", "RestTemplate");
            ...
            UriComponentsBuilder builder = UriComponentsBuilder.fromHttpUrl(getTransactionServiceApiUrl() + "invoiceheader")
                    .queryParam("loginUserID", loginUserID);
            HttpEntity<?> entity = new HttpEntity<>(invoiceHeader, headers);
...
//			log.info("result : " + result.getStatusCode());
    ...
    // POST InvoiceLine
    public InvoiceLine[] createInvoiceLine (@Valid InvoiceLine[] invoiceLine, String loginUserID, String authToken) {
        try {
            HttpHeaders headers = new HttpHeaders();
            headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
            headers.add("User-Agent", "RestTemplate");
            ...
            UriComponentsBuilder builder = UriComponentsBuilder.fromHttpUrl(getTransactionServiceApiUrl() + "invoiceline")
                    .queryParam("loginUserID", loginUserID);
            HttpEntity<?> entity = new HttpEntity<>(invoiceLine, headers);
...
//			log.info("result : " + result.getStatusCode());
    ...
    public InvoiceHeader[] findInvoiceHeader(FindInvoiceHeader findInvoiceHeader, String authToken) {
        try {
            ...
            headers.add("User-Agent", "RestTemplate");
            headers.add("Authorization", "Bearer " + authToken);
            UriComponentsBuilder builder = UriComponentsBuilder.fromHttpUrl(getTransactionServiceApiUrl() + "invoiceheader/findInvoiceHeader");
    ...
    // PATCH
    public InvoiceLine[] updateInvoiceLine(List<InvoiceLine> updateInvoiceLine, String loginUserID, String authToken) {
        try {
            HttpHeaders headers = new HttpHeaders();
            headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
            headers.add("User-Agent", " RestTemplate");
            ...
            UriComponentsBuilder builder = UriComponentsBuilder.fromHttpUrl(getTransactionServiceApiUrl() + "invoiceline/update")
                    .queryParam("loginUserID", loginUserID);
    ...
    public InvoiceLine[] findInvoiceLine(FindInvoiceLine findInvoiceLine, String authToken) {
        try {
            ...
            headers.add("User-Agent", "RestTemplate");
            headers.add("Authorization", "Bearer " + authToken);
            UriComponentsBuilder builder = UriComponentsBuilder.fromHttpUrl(getTransactionServiceApiUrl() + "invoiceline/findInvoiceLine");
    ...
    public DashBoard[] findDashBoard(FindDashBoard findDashBoard, String authToken) {
        try {
            HttpHeaders headers = new HttpHeaders();
            headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
            headers.add("User-Agent", "RestTemplate");
            headers.add("Authorization", "Bearer " + authToken);
            UriComponentsBuilder builder = UriComponentsBuilder.fromHttpUrl(getTransactionServiceApiUrl() + "reports/findDashBoard");
            HttpEntity<?> entity = new HttpEntity<>(findDashBoard, headers);
            ResponseEntity<DashBoard[]> result =
                    getRestTemplate().exchange(builder.toUriString(), HttpMethod.POST, entity, DashBoard[].class);
            log.info("result : " + result.getStatusCode());
            return result.getBody();
        } catch (Exception e) {
            e.printStackTrace();
