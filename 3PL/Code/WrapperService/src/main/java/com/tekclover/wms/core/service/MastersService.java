...
public class MastersService {
    ...
    // POST - findBusinessPartner
    public BusinessPartnerV2[] findBusinessPartnerV2(SearchBusinessPartner searchBusinessPartner, String authToken) {
        try {
            HttpHeaders headers = new HttpHeaders();
            headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
            headers.add("User-Agent", " RestTemplate");
            ...
            UriComponentsBuilder builder =
                    UriComponentsBuilder.fromHttpUrl(getMastersServiceUrl() + "businesspartner/findBusinessPartner/v2");
            HttpEntity<?> entity = new HttpEntity<>(searchBusinessPartner, headers);
            ResponseEntity<BusinessPartnerV2[]> result =
                    getRestTemplate().exchange(builder.toUriString(), HttpMethod.POST, entity, BusinessPartnerV2[].class);
            log.info("result : " + result.getStatusCode());
            return result.getBody();
        } catch (Exception e) {
            e.printStackTrace();
...
//THREEPL
    ...
    // CREATE
    public PriceList[] addPriceList(List<AddPriceList> newPriceListId, String loginUserID, String authToken) {
        try {
            HttpHeaders headers = new HttpHeaders();
            headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
            headers.add("User-Agent", "Threepl RestTemplate");
            ...
            UriComponentsBuilder builder =
                    UriComponentsBuilder.fromHttpUrl(getMastersServiceUrl() + "pricelist/create/list")
                            .queryParam("loginUserID", loginUserID);
    ...
    //UPDATE
    public PriceList[] updatePriceList(List<AddPriceList> modifiedPriceList, String loginUserID,
                                       String authToken) {
        try {
            HttpHeaders headers = new HttpHeaders();
            headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
            ...
            restTemplate.setRequestFactory(new HttpComponentsClientHttpRequestFactory(client));
            UriComponentsBuilder builder =
                    UriComponentsBuilder.fromHttpUrl(getMastersServiceUrl() + "pricelist/update/list")
                            .queryParam("loginUserID", loginUserID);
    ...
    // DELETE
    public boolean deletePriceList(List<PriceList> deletePriceList, String loginUserID, String authToken) {
        try {
            HttpHeaders headers = new HttpHeaders();
            headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
            headers.add("User-Agent", "Threepl RestTemplate");
            headers.add("Authorization", "Bearer " + authToken);
            HttpEntity<?> entity = new HttpEntity<>(deletePriceList, headers);
            UriComponentsBuilder builder =
                    UriComponentsBuilder.fromHttpUrl(getMastersServiceUrl() + "pricelist/delete/list")
                            .queryParam("loginUserID", loginUserID);
            ResponseEntity<String> result = getRestTemplate().exchange(builder.toUriString(), HttpMethod.DELETE, entity, String.class);
            return true;
        } catch (Exception e) {
