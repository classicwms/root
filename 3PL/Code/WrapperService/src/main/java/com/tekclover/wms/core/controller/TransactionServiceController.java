...
import com.tekclover.wms.core.model.threepl.dashboard.DashBoard;
import com.tekclover.wms.core.model.threepl.dashboard.FindDashBoard;
...
//    }
    ...
    @PostMapping("/warehouse/outbound/salesOrder/upload/v2")
...
//		batchJobScheduler.runJobPeriodic();
    ...
    //===============================================Packing Header=================================================
    @ApiOperation(response = PackingHeader.class, value = "Create new PackingHeader") // label for swagger
    @RequestMapping(value = "/packingheader", method = RequestMethod.POST)
    public ResponseEntity<?> createPackingHeader(@RequestParam String authToken, @RequestParam String loginUserID,
                                                 @RequestBody AddPackingHeader newPackingHeader) {
        PackingHeader PackingHeader = transactionService.createPackingHeader(newPackingHeader, loginUserID, authToken);

        return new ResponseEntity<>(PackingHeader, HttpStatus.OK);
    }

    @ApiOperation(response = PackingHeader.class, value = "Get all PackingHeader") // label for swagger
    @RequestMapping(value = "/packingheader", method = RequestMethod.GET)
    public ResponseEntity<?> getPackingHeaders(@RequestParam String authToken) {
        PackingHeader[] packingHeader = transactionService.getPackingHeaders(authToken);
    ...
    @RequestMapping(value = "/packingheader/{packingNo}", method = RequestMethod.GET)
    public ResponseEntity<?> getPackingHeader(@PathVariable String packingNo, @RequestParam String languageId, @RequestParam String companyCodeId,
                                              @RequestParam String plantId, @RequestParam String warehouseId, @RequestParam String preOutboundNo, @RequestParam String refDocNumber, @RequestParam String partnerCode, @RequestParam String qualityInspectionNo, @RequestParam String authToken) {
        PackingHeader packingHeader = transactionService.getPackingHeader(languageId, companyCodeId, plantId, warehouseId, preOutboundNo, refDocNumber, partnerCode, qualityInspectionNo, packingNo, authToken);
        log.info("PackingHeader : " + packingHeader);
        return new ResponseEntity<>(packingHeader, HttpStatus.OK);
    }

    @ApiOperation(response = PackingHeader.class, value = "Search PackingHeader") // label for swagger
    @PostMapping("/packingheader/findPackingHeader")
    public PackingHeader[] finPackingHeader(@RequestBody SearchPackingHeader searchPackingHeader, @RequestParam String authToken)
            throws Exception {
        return transactionService.findPackingHeader(searchPackingHeader, authToken);
    }

    @ApiOperation(response = Optional.class, value = "Update PackingHeader") // label for swagger
    @RequestMapping(value = "/packingheader/{packingNo}", method = RequestMethod.PATCH)
    public ResponseEntity<?> updatePackingHeader(@PathVariable String packingNo, @RequestParam String languageId, @RequestParam String companyCodeId, @RequestParam String plantId, @RequestParam String warehouseId, @RequestParam String preOutboundNo, @RequestParam String refDocNumber, @RequestParam String partnerCode, @RequestParam String qualityInspectionNo,
                                                 @Valid @RequestBody UpdatePackingHeader updatePackingHeader, @RequestParam String loginUserID, @RequestParam String authToken) {
        PackingHeader packingHeader = transactionService.updatePackingHeader(languageId, companyCodeId, plantId, warehouseId, preOutboundNo,
                refDocNumber, partnerCode, qualityInspectionNo, packingNo, updatePackingHeader, loginUserID, authToken);
        return new ResponseEntity<>(packingHeader, HttpStatus.OK);
    }

    @ApiOperation(response = PackingHeader.class, value = "Delete PackingHeader") // label for swagger
    @DeleteMapping("/packingheader/{packingNo}")
    public ResponseEntity<?> deletePackingHeader(@PathVariable String packingNo, @RequestParam String languageId, @RequestParam String companyCodeId,
                                                 @RequestParam String plantId, @RequestParam String warehouseId, @RequestParam String preOutboundNo, @RequestParam String refDocNumber, @RequestParam String partnerCode, @RequestParam String qualityInspectionNo, @RequestParam String loginUserID, @RequestParam String authToken) {

        transactionService.deletePackingHeader(languageId, companyCodeId, plantId, warehouseId, preOutboundNo,
                refDocNumber, partnerCode, qualityInspectionNo, packingNo, loginUserID, authToken);
        return new ResponseEntity<>(HttpStatus.NO_CONTENT);
    }

    //===============================================Packing Line=================================================
    @ApiOperation(response = PackingLine.class, value = "Create new PackingLine") // label for swagger
    @RequestMapping(value = "/packingline", method = RequestMethod.POST)
    public ResponseEntity<?> createPackingLine(@RequestParam String authToken, @RequestParam String loginUserID,
                                               @RequestBody List<AddPackingLine> newPackingLine) {
        PackingLine[] PackingLine = transactionService.createPackingLine(newPackingLine, loginUserID, authToken);

        return new ResponseEntity<>(PackingLine, HttpStatus.OK);
    }

    @ApiOperation(response = PackingLine.class, value = "Get all PackingLine") // label for swagger
    @RequestMapping(value = "/packingline", method = RequestMethod.GET)
    public ResponseEntity<?> getPackingLines(@RequestParam String authToken) {
        PackingLine[] packingLine = transactionService.getPackingLines(authToken);
        log.info("PackingLine : " + packingLine);
        return new ResponseEntity<>(packingLine, HttpStatus.OK);
    }

    @ApiOperation(response = PackingLine.class, value = "Get a PackingLine") // label for swagger
    @RequestMapping(value = "/packingline/{itemCode}", method = RequestMethod.GET)
    public ResponseEntity<?> getPackingLine(@PathVariable String itemCode, @RequestParam String languageId, @RequestParam String companyCodeId,
                                            @RequestParam String plantId, @RequestParam String warehouseId, @RequestParam String preOutboundNo, @RequestParam String refDocNumber, @RequestParam String partnerCode, @RequestParam Long lineNumber, @RequestParam String packingNo, @RequestParam String authToken) {
        PackingLine packingLine = transactionService.getPackingLine(languageId, companyCodeId, plantId, warehouseId, preOutboundNo, refDocNumber, partnerCode, lineNumber, packingNo, itemCode, authToken);
        log.info("PackingLine : " + packingLine);
        return new ResponseEntity<>(packingLine, HttpStatus.OK);
    }

    @ApiOperation(response = PackingLine.class, value = "Search PackingLine") // label for swagger
    @PostMapping("/packingline/findPackingLine")
    public PackingLine[] findPackingLine(@RequestBody SearchPackingLine searchPackingLine, @RequestParam String authToken)
            throws Exception {
        return transactionService.findPackingLine(searchPackingLine, authToken);
    }

    @ApiOperation(response = Optional.class, value = "Update PackingLine") // label for swagger
    @RequestMapping(value = "/packingline/{itemCode}", method = RequestMethod.PATCH)
    public ResponseEntity<?> updatePackingLine(@PathVariable String itemCode, @RequestParam String languageId, @RequestParam String companyCodeId, @RequestParam String plantId, @RequestParam String warehouseId, @RequestParam String preOutboundNo, @RequestParam String refDocNumber, @RequestParam String partnerCode, @RequestParam Long lineNumber, @RequestParam String packingNo,
                                               @Valid @RequestBody UpdatePackingLine updatePackingLine, @RequestParam String loginUserID, @RequestParam String authToken) {
        PackingLine packingLine = transactionService.updatePackingLine(languageId, companyCodeId, plantId, warehouseId, preOutboundNo, refDocNumber, partnerCode, lineNumber, packingNo, itemCode, updatePackingLine, loginUserID, authToken);
        return new ResponseEntity<>(packingLine, HttpStatus.OK);
    }

    @ApiOperation(response = PackingLine.class, value = "Delete PackingLine") // label for swagger
    @DeleteMapping("/packingline/{itemCode}")
    public ResponseEntity<?> deletePackingLine(@PathVariable String itemCode, @RequestParam String languageId, @RequestParam String companyCodeId,
                                               @RequestParam String plantId, @RequestParam String warehouseId, @RequestParam String preOutboundNo,
                                               @RequestParam String refDocNumber, @RequestParam String partnerCode, @RequestParam Long lineNumber,
                                               @RequestParam String packingNo, @RequestParam String loginUserID, @RequestParam String authToken) {

        transactionService.deletePackingLine(languageId, companyCodeId, plantId, warehouseId, preOutboundNo, refDocNumber,
                partnerCode, lineNumber, packingNo, itemCode, loginUserID, authToken);
        return new ResponseEntity<>(HttpStatus.NO_CONTENT);
    }
    ...
    @ApiOperation(response = ProformaInvoiceHeader.class, value = "Create new ProformaInvoiceHeader")
    // label for swagger
    @RequestMapping(value = "/proformaInvoiceHeader", method = RequestMethod.POST)
    public ResponseEntity<?> createProformaInvoiceHeader(@RequestParam String authToken, @RequestParam String loginUserID,
                                                         @RequestBody AddProformaInvoiceHeader newProformaInvoiceHeader) {
        ProformaInvoiceHeader proformaInvoiceHeader = transactionService.createProformaInvoiceHeader(newProformaInvoiceHeader, loginUserID, authToken);

        return new ResponseEntity<>(proformaInvoiceHeader, HttpStatus.OK);
    }

    @ApiOperation(response = ProformaInvoiceHeader.class, value = "Get all ProformaInvoiceHeader") // label for swagger
    @RequestMapping(value = "/proformaInvoiceHeader", method = RequestMethod.GET)
    public ResponseEntity<?> getProformaInvoiceHeaders(@RequestParam String authToken) {
        ProformaInvoiceHeader[] proformaInvoiceHeader = transactionService.getProformaInvoiceHeaders(authToken);
    ...
    @RequestMapping(value = "/proformaInvoiceHeader/{proformaBillNo}", method = RequestMethod.GET)
    public ResponseEntity<?> getProformaInvoiceHeader(@Valid @PathVariable String proformaBillNo, @RequestParam String partnerCode,
                                                      @RequestParam String companyCodeId, @RequestParam String plantId,
                                                      @RequestParam String languageId, @RequestParam String warehouseId, @RequestParam String authToken) {
        ProformaInvoiceHeader proformaInvoiceHeader = transactionService.getProformaInvoiceHeader(companyCodeId, plantId, languageId, warehouseId, proformaBillNo, partnerCode, authToken);
        log.info("ProformaInvoiceHeader : " + proformaInvoiceHeader);
        return new ResponseEntity<>(proformaInvoiceHeader, HttpStatus.OK);
    }

    @ApiOperation(response = Optional.class, value = "Update ProformaInvoiceHeader") // label for swagger
    @RequestMapping(value = "/proformaInvoiceHeader/{proformaBillNo}", method = RequestMethod.PATCH)
    public ResponseEntity<?> updateProformaInvoiceHeader(@RequestParam String companyCodeId, @RequestParam String plantId, @RequestParam String languageId,
                                                         @RequestParam String warehouseId, @PathVariable String proformaBillNo, @RequestParam String partnerCode,
                                                         @Valid @RequestBody UpdateProformaInvoiceHeader updateProformaInvoiceHeader, @RequestParam String loginUserID, @RequestParam String authToken) {
        ProformaInvoiceHeader proformaInvoiceHeader = transactionService.updateProformaInvoiceHeader(companyCodeId, plantId, languageId, warehouseId, proformaBillNo, partnerCode, loginUserID, updateProformaInvoiceHeader, authToken);
        return new ResponseEntity<>(proformaInvoiceHeader, HttpStatus.OK);
    }
    ...
    public ResponseEntity<?> deleteProformaInvoiceHeader(@PathVariable String proformaBillNo, @RequestParam String companyCodeId, @RequestParam String plantId,
                                                         @RequestParam String languageId, @RequestParam String warehouseId, @RequestParam String partnerCode, @RequestParam String loginUserID, @RequestParam String authToken) {

        transactionService.deleteProformaInvoiceHeader(companyCodeId, plantId, languageId, warehouseId, proformaBillNo, partnerCode, loginUserID, authToken);
        return new ResponseEntity<>(HttpStatus.NO_CONTENT);
    }
    ...
    @PostMapping("/proformaInvoiceHeader/findProformaInvoiceHeader")
    public ProformaInvoiceHeader[] findProformaInvoiceHeader(@RequestBody FindProformaInvoiceHeader searchProformaInvoiceHeader,
                                                             @RequestParam String authToken) throws Exception {

        return transactionService.findProformaInvoiceHeader(searchProformaInvoiceHeader, authToken);
    }

    @ApiOperation(response = ProformaInvoice.class, value = "Create new Invoice")
    // label for swagger
    @RequestMapping(value = "/proformaInvoice/create", method = RequestMethod.POST)
    public ResponseEntity<?> createProformaInvoiceHeaderAndLine(@RequestBody List<ProformaInvoice> newProformaInvoice,
                                                                @RequestParam String authToken, @RequestParam String loginUserID) {
        ProformaInvoice[] proformaInvoiceHeader = transactionService.createProformaInvoiceHeaderAndLine(newProformaInvoice, loginUserID, authToken);

        return new ResponseEntity<>(proformaInvoiceHeader, HttpStatus.OK);
    }

    //===============================================ProformaInvoiceLine=================================================
    @ApiOperation(response = ProformaInvoiceLine.class, value = "Create new ProformaInvoiceLine") // label for swagger
    @RequestMapping(value = "/proformaInvoiceLine", method = RequestMethod.POST)
    public ResponseEntity<?> createProformaInvoiceLine(@RequestParam String authToken, @RequestParam String loginUserID,
                                                       @RequestBody AddProformaInvoiceLine newProformaInvoiceLine) {
        ProformaInvoiceLine proformaInvoiceLine = transactionService.createProformaInvoiceLine(newProformaInvoiceLine, loginUserID, authToken);

        return new ResponseEntity<>(proformaInvoiceLine, HttpStatus.OK);
    }

    @ApiOperation(response = ProformaInvoiceLine.class, value = "Get all ProformaInvoiceLine") // label for swagger
    @RequestMapping(value = "/proformaInvoiceLine", method = RequestMethod.GET)
    public ResponseEntity<?> getProformaInvoiceLines(@RequestParam String authToken) {
        ProformaInvoiceLine[] proformaInvoiceLine = transactionService.getProformaInvoiceLines(authToken);
    ...
    @RequestMapping(value = "/proformaInvoiceLine/{lineNumber}", method = RequestMethod.GET)
    public ResponseEntity<?> getProformaInvoiceLine(@Valid @PathVariable Long lineNumber, @RequestParam String proformaBillNo, @RequestParam String partnerCode,
        ...
        ProformaInvoiceLine proformaInvoiceLine = transactionService.getProformaInvoiceLine(companyCodeId, plantId, languageId, warehouseId, proformaBillNo, partnerCode, lineNumber, authToken);
        log.info("ProformaInvoiceLine : " + proformaInvoiceLine);
        return new ResponseEntity<>(proformaInvoiceLine, HttpStatus.OK);
    }

    @ApiOperation(response = Optional.class, value = "Update ProformaInvoiceLine") // label for swagger
    @RequestMapping(value = "/proformaInvoiceLine/update", method = RequestMethod.PATCH)
    public ResponseEntity<?> updateProformaInvoiceLine(@Valid @RequestBody List<AddProformaInvoiceLine> updateProformaInvoiceLine, @RequestParam String loginUserID, @RequestParam String authToken) {
        ProformaInvoiceLine[] proformaInvoiceLine = transactionService.updateProformaInvoiceLine(updateProformaInvoiceLine, loginUserID, authToken);
        return new ResponseEntity<>(proformaInvoiceLine, HttpStatus.OK);
    }

    @ApiOperation(response = ProformaInvoiceLine.class, value = "Delete ProformaInvoiceLine") // label for swagger
    @DeleteMapping("/proformaInvoiceLine/{lineNumber}")
    public ResponseEntity<?> deleteProformaInvoiceLine(@PathVariable Long lineNumber, @RequestParam String languageId, @RequestParam String companyCodeId, @RequestParam String plantId,
                                                       @RequestParam String warehouseId, @RequestParam String proformaBillNo, @RequestParam String partnerCode,
                                                       @RequestParam String loginUserID, @RequestParam String authToken) {

        transactionService.deleteProformaInvoiceLine(companyCodeId, plantId, languageId, warehouseId, proformaBillNo, partnerCode, lineNumber, loginUserID, authToken);
        return new ResponseEntity<>(HttpStatus.NO_CONTENT);
    }

    //FIND ProformaInvoiceLine
    @ApiOperation(response = ProformaInvoiceLine[].class, value = "Find ProformaInvoiceLine")//label for swagger
    @PostMapping("/proformaInvoiceLine/findProformaInvoiceLine")
    public ProformaInvoiceLine[] findProformaInvoiceLine(@RequestBody FindProformaInvoiceLine searchProformaInvoiceLine,
                                                         @RequestParam String authToken) throws Exception {

        return transactionService.findProformaInvoiceLine(searchProformaInvoiceLine, authToken);
    }

    //BillingTransactionReport
    @ApiOperation(response = BillingTransactionReport.class, value = "BillingTransactionReport Report")
    // label for swagger
    @PostMapping("/reports/billingTransactionReport")
    public BillingTransactionReport[] getBillingTransactionReport(@RequestBody FindBillingTransactionReport findBillingTransactionReport,
                                                                  @RequestParam String authToken) throws Exception {
        return transactionService.getBillingTransactionReport(findBillingTransactionReport, authToken);
    }

    //BillingTransactionReport
    @ApiOperation(response = BillingTransactionReport.class, value = "Invoice Execute") // label for swagger
    @PostMapping("/invoice/execute")
    public ProformaInvoice[] getInvoiceExecute(@Valid @RequestBody FindInvoice findInvoice,
                                       @RequestParam String authToken) throws Exception {
        return transactionService.getInvoiceExecute(findInvoice, authToken);
    }


    //===============================================StockMovement=================================================
    @ApiOperation(response = StockMovement.class, value = "Create new StockMovement") // label for swagger
    @RequestMapping(value = "/stockMovement", method = RequestMethod.POST)
    public ResponseEntity<?> createStockMovement(@RequestParam String authToken, @RequestParam String loginUserID,
                                               @RequestBody List<StockMovement> newStockMovement) {
        StockMovement[] stockMovement = transactionService.createStockMovement(newStockMovement, loginUserID, authToken);

        return new ResponseEntity<>(stockMovement, HttpStatus.OK);
    }

    @ApiOperation(response = StockMovement.class, value = "Get all StockMovement") // label for swagger
    @RequestMapping(value = "/stockMovement", method = RequestMethod.GET)
    public ResponseEntity<?> getStockMovements(@RequestParam String authToken) {
        StockMovement[] stockMovement = transactionService.getStockMovements(authToken);
        log.info("StockMovement : " + stockMovement);
        return new ResponseEntity<>(stockMovement, HttpStatus.OK);
    }

    @ApiOperation(response = StockMovement.class, value = "Get a StockMovement") // label for swagger
    @RequestMapping(value = "/stockMovement/{movementDocNo}", method = RequestMethod.GET)
    public ResponseEntity<?> getStockMovement(@PathVariable Long movementDocNo, @RequestParam String companyCodeId,
                                              @RequestParam String languageId, @RequestParam String plantId,
                                              @RequestParam String itemCode, @RequestParam String warehouseId, @RequestParam String authToken) {
        StockMovement stockMovement = transactionService.getStockMovement(movementDocNo, languageId, companyCodeId, plantId, warehouseId, itemCode, authToken);
        log.info("StockMovement : " + stockMovement);
        return new ResponseEntity<>(stockMovement, HttpStatus.OK);
    }

    @ApiOperation(response = StockMovement.class, value = "Search StockMovement") // label for swagger
    @PostMapping("/stockMovement/findStockMovement")
    public StockMovement[] findStockMovement(@RequestBody FindStockMovement findStockMovement, @RequestParam String authToken)
            throws Exception {
        return transactionService.findStockMovement(findStockMovement, authToken);
    }

    @ApiOperation(response = Optional.class, value = "Update StockMovement") // label for swagger
    @RequestMapping(value = "/stockMovement/{movementDocNo}", method = RequestMethod.PATCH)
    public ResponseEntity<?> updateStockMovement(@PathVariable Long movementDocNo, @RequestParam String companyCodeId, @RequestParam String plantId,
                                                 ...
                                                 @RequestParam String loginUserID, @RequestParam String authToken) {
        StockMovement[] stockMovement = transactionService.updateStockMovement(movementDocNo, languageId,
                companyCodeId, plantId, warehouseId, itemCode, updateStockMovement, loginUserID, authToken);
        return new ResponseEntity<>(stockMovement, HttpStatus.OK);
    }

    @ApiOperation(response = StockMovement.class, value = "Delete StockMovement") // label for swagger
    @DeleteMapping("/stockMovement/{movementDocNo}")
    public ResponseEntity<?> deleteStockMovement(@PathVariable Long movementDocNo, @RequestParam String companyCodeId,
                                                 @RequestParam String plantId, @RequestParam String warehouseId,
                                                 @RequestParam String itemCode, @RequestParam String languageId, @RequestParam String loginUserID, @RequestParam String authToken) {

        transactionService.deleteStockMovement(companyCodeId, plantId, languageId, warehouseId, itemCode, movementDocNo, loginUserID, authToken);
        return new ResponseEntity<>(HttpStatus.NO_CONTENT);
    }


    @ApiOperation(response = InvoiceHeader.class, value = "Create new InvoiceHeader")
    // label for swagger
    @RequestMapping(value = "/invoiceHeader", method = RequestMethod.POST)
    public ResponseEntity<?> createInvoiceHeader(@RequestParam String authToken, @RequestParam String loginUserID,
                                                         @RequestBody InvoiceHeader header) {
        InvoiceHeader invoiceHeader = transactionService.createInvoiceHeader(header, loginUserID, authToken);

        return new ResponseEntity<>(invoiceHeader, HttpStatus.OK);
    }

    @ApiOperation(response = InvoiceLine.class, value = "Create new InvoiceLine")
    // label for swagger
    @RequestMapping(value = "/invoiceLine", method = RequestMethod.POST)
    public ResponseEntity<?> createInvoiceInvoiceLine(@RequestParam String authToken, @RequestParam String loginUserID,
                                                 @Valid @RequestBody InvoiceLine[] header) {
        InvoiceLine[] invoiceHeader = transactionService.createInvoiceLine(header, loginUserID, authToken);
        return new ResponseEntity<>(invoiceHeader, HttpStatus.OK);
    }
    ...
    public ResponseEntity<?> patchInvoiceLine(@PathVariable String invoiceNumber, @RequestParam String languageId, @RequestParam String companyCodeId,
                                              @RequestParam String plantId, @RequestBody UpdateInvoiceHeader updateInvoiceHeader,
    ...
    @RequestMapping(value = "/invoiceLine/update", method = RequestMethod.PATCH)
    public ResponseEntity<?> patchInvoiceLine(@Valid @RequestBody List<InvoiceLine> updateInvoiceLine, @RequestParam String loginUserID,
                                              @RequestParam String authToken)
            throws IllegalAccessException, InvocationTargetException {

        InvoiceLine[] dbInvoiceLine = transactionService.updateInvoiceLine(updateInvoiceLine, loginUserID, authToken);
        return new ResponseEntity<>(dbInvoiceLine, HttpStatus.OK);
    }
    ...
    @ApiOperation(response = DashBoard[].class, value = "Find Dash Board")//label for swagger
    @PostMapping("/reports/findDashBoard")
    public DashBoard[] findInvoiceLine(@RequestBody FindDashBoard findDashBoard,
                                       @RequestParam String authToken) throws Exception {
