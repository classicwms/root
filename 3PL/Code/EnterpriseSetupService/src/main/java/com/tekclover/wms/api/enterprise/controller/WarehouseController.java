...
public class WarehouseController {
	...
	@PostMapping("")
	public ResponseEntity<?> postWarehouse(@Valid @RequestBody List<Warehouse> newWarehouse, @RequestParam String loginUserID)
			throws IllegalAccessException, InvocationTargetException, ParseException {
		List<Warehouse> createdWarehouse = warehouseService.createWarehouse(newWarehouse, loginUserID);
