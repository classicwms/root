...
//                    if(outbound.getPartnerCode().equalsIgnoreCase("7")) {
//                        Status status = new Status();
//                        status.setStatus("cancelled");
//                        idmasterService.getStatus(status, outbound.getRefDocumentNo());
//                    }
    ...
    public WarehouseApiResponse processOutboundFailedOrder() throws InterruptedException {
        WarehouseApiResponse warehouseApiResponse = new WarehouseApiResponse();
