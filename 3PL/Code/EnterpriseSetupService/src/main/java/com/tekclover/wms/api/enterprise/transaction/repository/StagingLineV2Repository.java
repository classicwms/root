...
//                                       String preInboundNo, String refDocNumber, String manufacturerCode);
    ...
    @Query(value = "\n" +
            "select top 1 usr_id from tblhhtuser where c_id = :companyId and plant_id = :plantId and wh_id = :warehouseId order by ctd_on", nativeQuery = true)
    String getAssignPicker(@Param("companyId") String companyId,
                           @Param("plantId") String plantId,
                           @Param("warehouseId") String warehouseId);
}