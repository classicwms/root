...
//            @Param(value = "binClassId") Long binClassId,
    ...
    @Query(value = "select max(inv_id) inventoryId into #inv from tblinventory \n"
            ...
            "iv.STCK_TYP_TEXT stockTypeDescription,\n" +
            "iv.STATUS_TEXT statusDescription,\n" +
            "iv.TPL_CBM threePLCbm,\n" +
            "iv.TPL_UOM threePLUom,\n" +
            "iv.TPL_CBM_PER_QTY threePLCbmPerQty,\n" +
            "iv.TPL_RATE_PER_QTY threePLRatePerQty,\n" +
            "iv.RATE rate,\n" +
...
//    @Query (value = "select top 1 * from tblinventory  WHERE WH_ID = :warehouseId and ITM_CODE = :itemCode AND BIN_CL_ID = :binClassId AND STCK_TYP_ID = :stockTypeId \n" +
//            "AND C_ID = :companyCodeId and PLANT_ID = :plantId AND LANG_ID = :languageId \n" +
//            "AND MFR_NAME = :manufacturerName AND IS_DELETED = 0 AND INV_QTY > 0 order by inv_id desc", nativeQuery = true)
//    public List<InventoryV2> findInventoryGroupByLevelId (
//            @Param(value = "companyCodeId") String companyCodeId,
//            @Param(value = "plantId") String plantId,
//            @Param(value = "languageId") String languageId,
//            @Param(value = "warehouseId") String warehouseId,
