...
//		String input = "2017-01-18 20:10:00";
	 ...
	 * @throws ParseException
	 */
	public static Date[] addTimeToDate(Date startDate, Date endDate) {
		// Convert Date to LocalDate
		LocalDate sLocalDate = startDate.toInstant().atZone(ZoneId.systemDefault()).toLocalDate();
		LocalDate eLocalDate = endDate.toInstant().atZone(ZoneId.systemDefault()).toLocalDate();

		// Set time (00:00:00 for start, 23:59:59 for end)
		LocalDateTime sLocalDateTime = sLocalDate.atStartOfDay(); // 00:00:00
		LocalDateTime eLocalDateTime = eLocalDate.atTime(23, 59, 59); // 23:59:59
