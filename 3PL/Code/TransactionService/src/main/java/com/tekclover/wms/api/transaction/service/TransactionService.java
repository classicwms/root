...
//        if (outboundList == null || outboundList.isEmpty()) {
            ...
            sqlOutboundList.stream().forEach(outboundOrderV2 -> {
                try {
                    orderService.updateProcessedOrderV2(outboundOrderV2.getRefDocumentNo(), outboundOrderV2.getOutboundOrderTypeID(), 1L);
