...
public class InvoiceHeaderController {
    ...
    //Find
    @ApiOperation(response = InvoiceHeader.class, value = "Find InvoiceHeader")
    @PostMapping("/findInvoiceHeader")
    public List<InvoiceHeader> findInvoiceHeader(@RequestBody FindInvoiceHeader findInvoiceHeader)
            throws Exception {
        return invoiceHeaderService.findInvoiceHeader(findInvoiceHeader);
    }
}
