...
//                }
                ...
                if (findPutawayHeader != null) {
                    ...
                    dbPutAwayLine.setRate(findPutawayHeader.getRate());
                    dbPutAwayLine.setCurrency(findPutawayHeader.getCurrency());
                    dbPutAwayLine.setThreePLCbm(findPutawayHeader.getThreePLCbm());
                    dbPutAwayLine.setThreePLUom(findPutawayHeader.getThreePLUom());
                    dbPutAwayLine.setThreePLWidth(findPutawayHeader.getThreePLWidth());
                    dbPutAwayLine.setThreePLLength(findPutawayHeader.getThreePLLength());
                    dbPutAwayLine.setThreePLHeight(findPutawayHeader.getThreePLHeight());
                    dbPutAwayLine.setBusinessPartnerCode(findPutawayHeader.getBusinessPartnerCode());
                    dbPutAwayLine.setTotalRate(findPutawayHeader.getTotalRate());
                    dbPutAwayLine.setTotalThreePLCbm(findPutawayHeader.getTotalThreePLCbm());
                } else {
                    dbPutAwayLine.setCreatedOn(new Date());
                }
                dbPutAwayLine.setUpdatedOn(new Date());
                ...
                if (existingPutAwayLine.isEmpty()) {
                    ...
                    log.info("---------->createdPutAwayLine created: " + createdPutAwayLine);
                    log.info("Inventory Create Started ------------------------> ");
                    InventoryV2 createdInventory = inboundHeaderService.createInventoryNonCBMV2(createdPutAwayLine);
                    log.info("Inventory Create Completed -----------> " + createdInventory);
