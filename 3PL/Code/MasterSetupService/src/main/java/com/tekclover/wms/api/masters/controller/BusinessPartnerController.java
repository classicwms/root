...
public class BusinessPartnerController {
	...
	@PostMapping("/findBusinessPartner/v2")
	public List<BusinessPartnerV2> findBusinessPartnerV2(@RequestBody SearchBusinessPartner searchBusinessPartner)
			throws Exception {
		return businesspartnerService.findBusinessPartnerV2(searchBusinessPartner);
	}
