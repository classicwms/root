...
public interface InboundLineRepository extends JpaRepository<InboundLine,Long>, JpaSpecificationExecutor<InboundLine> {
	...
	@Query(value="Select top 1 PA_CTD_ON from tblputawayline where ref_doc_no = :refDocNo and itm_code = :itemCode order by PA_CTD_ON", 
			nativeQuery=true)
	...
	int updateInboundLineStatus(@Param ("warehouseId") String warehouseId,
