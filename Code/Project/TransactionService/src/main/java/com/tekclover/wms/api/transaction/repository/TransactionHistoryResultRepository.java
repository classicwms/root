...
public interface TransactionHistoryResultRepository extends JpaRepository<TransactionHistoryResults,Long>,
	...
	@Query(value = "truncate table tbltransactionhistoryresults insert into tbltransactionhistoryresults(item_code,description,warehouse_id) \n"
			...
			+ "update tbltransactionhistoryresults \n"
			+ "set is_os_qty=0,iv_os_qty=0,iv_cs_qty=0,pa_cs_qty=0,pa_cs_re_qty=0,pa_os_qty=0,pa_os_re_qty=0,pi_cs_qty=0,pi_os_qty=0 \n"
