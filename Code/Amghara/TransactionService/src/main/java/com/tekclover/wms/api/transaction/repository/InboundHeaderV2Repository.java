...
public interface InboundHeaderV2Repository extends JpaRepository<InboundHeaderV2, Long>,
    ...
    int updateInboundHeader(@Param("statusId") Long statusId, @Param("statusDescription") String statusDescription,
    ...
    @Modifying
    @Query(value = "update ib set ib.status_id = :statusId, ib.STATUS_TEXT = :statusText, ib.UTD_ON = GETDATE(), ib.IB_CNF_ON = GETDATE() from tblinboundheader ib\n" +
