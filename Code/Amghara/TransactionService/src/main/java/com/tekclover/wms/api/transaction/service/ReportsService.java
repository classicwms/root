...
//		log.info("FastSlowMovingDashboard itemData : " + itemData);
     ...
     * @return
     */
    public List<TransactionHistoryReport> getTransactionHistoryReportV2(FindImBasicData1 searchImBasicData1) {
        try {
            if (searchImBasicData1.getFromCreatedOn() != null && searchImBasicData1.getToCreatedOn() != null) {
                Date[] dates = DateUtils.addTimeToDatesForSearch(searchImBasicData1.getFromCreatedOn(),
                        searchImBasicData1.getToCreatedOn());
...
//            }
    ...
    public MobileDashboard findOutboundCountMobileDashBoard(FindMobileDashBoard findMobileDashBoard)throws Exception {
        ...
        // -----------Quality-----------------------------------------------------------------------------
        Long qualityHeaderCount = qualityHeaderRepository.getQualityCountNew(companyCode, plantId, languageId, warehouseId,54L);
        outboundCount.setQuality(qualityHeaderCount);
