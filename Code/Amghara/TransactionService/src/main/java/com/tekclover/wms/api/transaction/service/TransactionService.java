...
public class TransactionService extends BaseService {
    ...
    public WarehouseApiResponse processInboundOrder() throws IllegalAccessException, InvocationTargetException, ParseException {
        ...
        List<InboundIntegrationHeader> inboundAmgharaLabList = new ArrayList<>();
            ...
            inboundAmgharaLabList.add(inboundIntegrationHeader);
        }

        log.info("Latest InboundOrder found: " + inboundAmgharaLabList);
        for (InboundIntegrationHeader inbound : inboundAmgharaLabList) {
                try {
                    ...
                    inboundAmgharaLabList.remove(inbound);
