...
//            return putAwayLineList.toArray(new PutAwayLineV2[putAwayLineList.size()]);
    ...
    // POST - ASN V2 upload
    public WarehouseApiResponse[] postASNV2UploadList(List<ASNV2> asnv2List, String loginUserID, String authToken) {
        HttpHeaders headers = new HttpHeaders();
        headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
        headers.add("User-Agent", "RestTemplate");
        headers.add("Authorization", "Bearer " + authToken);
        UriComponentsBuilder builder =
                UriComponentsBuilder.fromHttpUrl(getInboundOrderServiceApiUrl() + "inboundorder/inbound/asn/v4")
                        .queryParam("loginUserID", loginUserID);
        HttpEntity<?> entity = new HttpEntity<>(asnv2List, headers);
        ResponseEntity<WarehouseApiResponse[]> result =
                getRestTemplate().exchange(builder.toUriString(), HttpMethod.POST, entity, WarehouseApiResponse[].class);
...
//Purchase Order
        ...
        public WarehouseApiResponse[] inboundOrderUpload(List<ASNV2> asnv2List, String authToken) {
            HttpHeaders headers = new HttpHeaders();
            headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
            headers.add("User-Agent", "RestTemplate");
            headers.add("Authorization", "Bearer " + authToken);
...
//                    UriComponentsBuilder.fromHttpUrl(getInboundTransactionServiceApiUrl() + "/warehouse/inbound/asn/upload/v2");
            UriComponentsBuilder builder =
                    UriComponentsBuilder.fromHttpUrl(getInboundOrderServiceApiUrl() + "inboundorder/inbound/asn/upload/v4");
            HttpEntity<?> entity = new HttpEntity<>(asnv2List,headers);
            ResponseEntity<WarehouseApiResponse[]> result =
                    getRestTemplate().exchange(builder.toUriString(), HttpMethod.POST, entity, WarehouseApiResponse[].class);
            return result.getBody();
    ...
    //-------------------------------------------------------------------------
    public InboundOrderMobileApp postInboundOrderMobileApp(InboundOrderMobileApp inboundOrderMobileApp, String authToken){
        HttpHeaders headers = new HttpHeaders();
        headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
        headers.add("User-Agent", "RestTemplate");
        headers.add("Authorization", "Bearer " + authToken);
    ...
    public WarehouseApiResponse[] inventoryUpdateUpload(List<Inventory> inventoryList, String companyCodeId, String plantId, String languageId, String warehouseId,String loginUserID, String authToken) {
        HttpHeaders headers = new HttpHeaders();
        headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
        headers.add("User-Agent", "RestTemplate");
        headers.add("Authorization", "Bearer " + authToken);
        UriComponentsBuilder builder =
                UriComponentsBuilder.fromHttpUrl(getInboundTransactionServiceApiUrl() + "/inventory/update/upload")
                        .queryParam("companyCodeId", companyCodeId)
                        .queryParam("plantId", plantId)
                        .queryParam("languageId", languageId)
                        .queryParam("warehouseId", warehouseId)
                        .queryParam("loginUserID", loginUserID);
        HttpEntity<?> entity = new HttpEntity<>(inventoryList, headers);
        ResponseEntity<WarehouseApiResponse[]> result =
                getRestTemplate().exchange(builder.toUriString(), HttpMethod.POST, entity, WarehouseApiResponse[].class);
        return result.getBody();
    }
    //======================================BarcodeGeneration=================================
    public BarcodeGeneration[] postBarcodeGeneration(List<AddBarcodeGeneration> barcodeGeneration, String authToken){
        HttpHeaders headers = new HttpHeaders();
        headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
        headers.add("User-Agent", "RestTemplate");
        headers.add("Authorization", "Bearer " + authToken);
        UriComponentsBuilder builder =
                UriComponentsBuilder.fromHttpUrl(getInboundTransactionServiceApiUrl() + "/reports/barcodeGeneartion/V6");
        HttpEntity<?> entity = new HttpEntity<>(barcodeGeneration,headers);
        ResponseEntity<BarcodeGeneration[]> result =
                getRestTemplate().exchange(builder.toUriString(), HttpMethod.POST, entity, BarcodeGeneration[].class);
        return result.getBody();
    }
    ...
    public WarehouseApiResponse processInbound(String preInboundNo, String refDocNumber){
        ...
        headers.add("Authorization", "Bearer " + authToken.getAccess_token());
        UriComponentsBuilder builder =
                UriComponentsBuilder.fromHttpUrl(getInboundOrderServiceApiUrl() + "inboundorder/create/inbound")
                        .queryParam("preInboundNo", preInboundNo)
                        .queryParam("refDocNumber", refDocNumber);
        HttpEntity<?> entity = new HttpEntity<>(headers);
        ResponseEntity<WarehouseApiResponse> result =
    ...
    //*-------------------------------------------------------------------------------Knowell Notification-----------------------------------------------------------------------------------------*//

    public StorageBinDashBoardImpl[] getStorageBinDashBoardV7(StorageBinDashBoardInput storageBinDashBoardInput, String authToken) throws Exception {
        try {
            HttpHeaders headers = new HttpHeaders();
            headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
            headers.add("User-Agent", "RestTemplate");
            headers.add("Authorization", "Bearer " + authToken);
            UriComponentsBuilder builder = UriComponentsBuilder.fromHttpUrl(getInboundTransactionServiceApiUrl() + "reports/storageBinDashboard/v7");
            HttpEntity<?> entity = new HttpEntity<>(storageBinDashBoardInput, headers);
            ResponseEntity<StorageBinDashBoardImpl[]> result =
                    getRestTemplate().exchange(builder.toUriString(), HttpMethod.POST, entity, StorageBinDashBoardImpl[].class);
            log.info("result : " + result.getStatusCode());
