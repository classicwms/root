...
import com.tekclover.wms.api.inbound.orders.model.warehouse.outbound.v2.SOHeaderV2;
import com.tekclover.wms.api.inbound.orders.model.warehouse.outbound.v2.SOLineV2;
import com.tekclover.wms.api.inbound.orders.model.warehouse.outbound.v2.ShipmentOrderV2;
...
//                        preOutboundNo, outboundHeader.getRefDocNumber(), outboundHeader.getPartnerCode());
        ...
        log.info("Outbound Process Completed for {} Shipment order", shipmentOrderV2List.size());
        return shipmentOrderV2List;
    }
...
//        imBasicData.setManufacturerName(salesOrderLineV2.getManufacturerName());
    ...
    private void createPickUpHeaderAssignPickerModified(String companyCodeId, String plantId, String languageId, String warehouseId, SOHeaderV2 headerV2, String preOutboundNo, String refDocNumber, String partnerCode) throws Exception {
        try {
...
//            }
                    ...
                    newPickupHeader.setReferenceDocumentType("Shipment Order");
...
//                    newPickupHeader.setMUpdatedOn(headerV2.getMUpdatedOn());
                    ...
                    newPickupHeader.setTransferRequestType("Shipment Order");
     ...
     * @return
     */
    private OutboundHeaderV2 createOutboundHeaderV2(PreOutboundHeaderV2 createdPreOutboundHeader, Long statusId, SOHeaderV2 header) {
