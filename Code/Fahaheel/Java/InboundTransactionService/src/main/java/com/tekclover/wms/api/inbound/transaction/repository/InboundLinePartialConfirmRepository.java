...
public interface InboundLinePartialConfirmRepository extends JpaRepository<InboundLinePartialConfirm, Long>,
	...
	public InboundLinePartialConfirm findByCompanyCodeAndPlantIdAndWarehouseIdAndRefDocNumberAndPreInboundNoAndLineNoAndItemCode (
			String companyCode, String plantId, String warehouseId, String refDocNumber, String preInboundNo, Long lineNo, String itemCode);
}
