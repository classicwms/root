...
import com.tekclover.wms.api.inbound.transaction.repository.specification.GrHeaderSpecification;
import com.tekclover.wms.api.inbound.transaction.repository.specification.GrHeaderV2Specification;
...
public class GrHeaderService extends BaseService {
     ...
     * @return
     */
    public List<GrHeaderV2> getGrHeader(String companyCode,String plantId,String warehouseId, String goodsReceiptNo, String caseCode, String refDocNumber) {
...
//    }
    ...
    public GrHeaderV2 getGrHeaderV2(String companyCode, String languageId, String plantId,
        ...
        if (grHeader.isEmpty()) {
            // Exception Log
            errorLogService.createGrHeaderLog(languageId, companyCode, plantId, warehouseId, refDocNumber, preInboundNo, stagingNo, goodsReceiptNo,
    ...
    public GrHeaderV2 getGrHeaderV2(String warehouseId, String goodsReceiptNo, String caseCode, String companyCode,
        ...
        if (grHeader == null) {
            // Exception Log
            errorLogService.createGrHeaderLog1(languageId, companyCode, plantId, warehouseId, refDocNumber, goodsReceiptNo,
    ...
    public List<GrHeaderV2> getGrHeaderV2(String companyCode, String languageId, String plantId,
        ...
        if (grHeader.isEmpty()) {
            // Exception Log
            errorLogService.createGrHeaderLog2(languageId, companyCode, plantId, warehouseId, preInboundNo, refDocNumber,
    ...
    public List<GrHeaderV2> getGrHeaderForReverseV2(String companyCode, String languageId, String plantId,
        ...
        if (grHeader.isEmpty()) {
            // Exception Log
            errorLogService.createGrHeaderLog1(languageId, companyCode, plantId, warehouseId, refDocNumber, preInboundNo,
    ...
    public GrHeaderV2 createGrHeaderV2(GrHeaderV2 newGrHeader, String loginUserID)
        ...
        if (!grheader.isEmpty()) {
            // Exception Log
            errorLogService.createGrHeaderLog4(newGrHeader, "Record is getting duplicated with the given values.");
...
//    }
    ...
    public GrHeaderV2 deleteGrHeaderV2(String companyCode, String languageId, String plantId,
        ...
        if (grHeader != null) {
            ...
            grHeader.setUpdatedBy(loginUserID);
            grHeader.setUpdatedOn(new Date());
            grHeaderV2Repository.delete(grHeader);
            grHeaderV2Repository.save(grHeader);
        }
        return grHeader;
    }
