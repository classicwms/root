...
import com.tekclover.wms.api.outbound.transaction.model.cyclecount.perpetual.v2.*;
...
import com.tekclover.wms.api.outbound.transaction.repository.specification.PerpetualHeaderV2Specification;
import com.tekclover.wms.api.outbound.transaction.repository.specification.PerpetualLineV2Specification;
...
import com.tekclover.wms.api.outbound.transaction.repository.specification.PerpetualHeaderSpecification;
...
//    }
    ...
    public Set<PerpetualLineEntityImpl> runPerpetualHeaderStreamV2(@Valid RunPerpetualHeader runPerpetualHeader) throws java.text.ParseException {
        ...
        List<PerpetualLineEntityImpl> runResponseList = inventoryMovementRepository.getRecordsForRunPerpetualCountV8(
                runPerpetualHeader.getMovementTypeId(), runPerpetualHeader.getSubMovementTypeId(),
                runPerpetualHeader.getDateFrom(), runPerpetualHeader.getDateTo());
    ...
    public PerpetualHeaderEntityV2 createPerpetualHeaderV2(PerpetualHeaderEntityV2 newPerpetualHeader, String loginUserID)
        ...
        // STATUS_ID - HardCoded Value "70"
        dbPerpetualHeader.setStatusId(70L);
        statusDescription = pickupLineRepository.getStatusDescription(70L, newPerpetualHeader.getLanguageId());
        dbPerpetualHeader.setStatusDescription(statusDescription);

        IKeyValuePair description = pickupLineRepository.getDescription(newPerpetualHeader.getCompanyCodeId(),
                newPerpetualHeader.getLanguageId(),
                newPerpetualHeader.getPlantId(),
                newPerpetualHeader.getWarehouseId());
...
//                statusDescription = pickupLineRepository.getStatusDescription(47L, newPerpetualHeader.getLanguageId());
//                dbPerpetualLine.setStatusDescription(statusDescription);
//
//                dbPerpetualLine.setCompanyDescription(description.getCompanyDesc());
//                dbPerpetualLine.setPlantDescription(description.getPlantDesc());
