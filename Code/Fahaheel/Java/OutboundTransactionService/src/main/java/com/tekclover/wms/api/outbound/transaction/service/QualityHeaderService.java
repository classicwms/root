...
import com.tekclover.wms.api.outbound.transaction.model.outbound.ordermangement.v2.OrderManagementHeaderV2;
...
import com.tekclover.wms.api.outbound.transaction.model.outbound.quality.SearchQualityHeader;
import com.tekclover.wms.api.outbound.transaction.repository.PickupLineRepository;
import com.tekclover.wms.api.outbound.transaction.repository.QualityHeaderRepository;
import com.tekclover.wms.api.outbound.transaction.repository.QualityHeaderV2Repository;
...
import com.tekclover.wms.api.outbound.transaction.model.outbound.quality.v2.SearchQualityHeaderV2;
import com.tekclover.wms.api.outbound.transaction.repository.StagingLineV2Repository;
import com.tekclover.wms.api.outbound.transaction.repository.specification.QualityHeaderV2Specification;
...
import com.tekclover.wms.api.outbound.transaction.model.outbound.quality.UpdateQualityHeader;
import com.tekclover.wms.api.outbound.transaction.repository.specification.QualityHeaderSpecification;
...
//    }
    ...
    //Stream Fahaheel
    public List<QualityHeaderV2> findQualityHeaderNewFahaheelV2(SearchQualityHeaderV2 searchQualityHeader) throws ParseException {
        QualityHeaderV2Specification spec = new QualityHeaderV2Specification(searchQualityHeader);
        List<QualityHeaderV2> results = qualityHeaderV2Repository.findAll(spec);
        log.info("QualityHeader find results ----> {}", results);
        return results;
    }
...
//     * @throws InvocationTargetException
//     */
//    public QualityHeaderV2 createQualityHeaderV5(QualityHeaderV2 newQualityHeader, String loginUserID)
...
//
//        OrderManagementHeaderV2 orderManagementHeaderV2 = orderManagementHeaderService.getOrderManagementHeaderV5(newQualityHeader.getCompanyCodeId(),
...
//    }
    ...
    public QualityHeaderV2 createQualityHeaderV2(QualityHeaderV2 newQualityHeader, String loginUserID)
        ...
        IKeyValuePair description = pickupLineRepository.getDescription(dbQualityHeader.getCompanyCodeId(),
                dbQualityHeader.getLanguageId(),
                dbQualityHeader.getPlantId(),
                dbQualityHeader.getWarehouseId());
        ...
        if (dbQualityHeader.getStatusId() != null) {
            statusDescription = pickupLineRepository.getStatusDescription(dbQualityHeader.getStatusId(), dbQualityHeader.getLanguageId());
            dbQualityHeader.setStatusDescription(statusDescription);
        }
    ...
    public List<QualityHeaderV2> deleteQualityHeaderV2(String companyCodeId, String plantId, String languageId, String warehouseId,
        ...
        if (qualityHeaderList != null && !qualityHeaderList.isEmpty()) {
            for (QualityHeaderV2 qualityHeaderV2 : qualityHeaderList) {
                ...
                qualityHeaderV2Repository.delete(qualityHeaderV2);
...
//    }
     ...
     * @param loginUserID
     */
//    public void createQualityHeaderV6 (String companyCodeId, String plantId, String languageId,
//                                       String warehouseId, PickupLineV2 dbPickupLine,
//                                       PickupHeaderV2 pickupHeader, String loginUserID) throws Exception {
//        try {
//            QualityHeaderV2 newQualityHeader = new QualityHeaderV2();
...
//            QualityHeaderV2 createdQualityHeader = qualityHeaderV2Repository.save(newQualityHeader);
//            log.info("createdQualityHeader : " + createdQualityHeader);
//            qualityLineService.createQualityLineV6(companyCodeId, plantId, languageId, warehouseId, dbPickupLine, createdQualityHeader, idMasterAuthToken, loginUserID);
//        } catch (Exception e) {
//            log.error("createdQualityHeader Error :" + e.toString());
//            throw e;
//        }
