...
//        StatusId idStatus = idmasterService.getStatus(47L, pickupHeader.getWarehouseId(), idmasterAuthToken.getAccess_token());
        statusDescription = getStatusDescription(47L, pickupHeader.getLanguageId());
...
//                data.setReferenceField7(idStatus.getStatus());    // ref_field_7
                data.setReferenceField7(statusDescription);      // Ref_field_7 statusDescription setting
    ...
    public List<OutboundLineV2> deleteOutBoundLine(String companyCodeId, String plantId, String languageId,
        ...
        if (dbOutBoundLine != null && !dbOutBoundLine.isEmpty()) {
            for (OutboundLineV2 outboundLineV2 : dbOutBoundLine) {
                ...
                outboundLineV2Repository.delete(outboundLineV2);
    ...
    public List<OutboundLineInterim> deleteOutboundLineInterimForPickListCancellationV2(String companyCodeId, String plantId, String languageId,
        ...
        if (listOutboundLineInterim != null && !listOutboundLineInterim.isEmpty()) {
            listOutboundLineInterim.forEach(data -> {
                ...
                outboundLineInterimRepository.delete(data);
            });
...
//                OutboundLineV2 outboundLineV2 = getOutboundLine5(companyCodeId, plantId, languageId, warehouseId, refDocNumber, partnerCode, outboundLineV2List.getItemCode(), outboundLineV2List.getLineNumber());
...
//                outboundLineV2Repository.updateOutboundLineStatusV5(companyCodeId, plantId, languageId, warehouseId, refDocNumber, preOutboundNo, STATUS_ID_59, statusDescription, lineNumbers, deliveredPercentage, deliveryConfirmedOn, outboundLineV2.getItemCode());
//                log.info("OutboundLine updated ");
...
//            createInventory(pickupLineV2List, loginUserID);
//            return outboundLineByStatus57List;
//        } catch (Exception e) {
//            e.printStackTrace();
//        }
