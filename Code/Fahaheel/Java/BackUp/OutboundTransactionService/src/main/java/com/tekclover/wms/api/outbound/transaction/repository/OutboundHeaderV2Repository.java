...
//            @Param(value = "endOrderDate") Date endOrderDate);
    ...
    @Query(value =
            "SELECT C_ID,PLANT_ID,LANG_ID,WH_ID,REF_DOC_NO,PRE_OB_NO,DLV_QTY,ORD_QTY,STATUS_ID into #obl FROM tbloutboundline WHERE is_deleted = 0 and \n" +
                    ...
                    "COALESCE((select sum(PICK_CNF_QTY) totQty from #pil where REF_DOC_NO = oh.REF_DOC_NO AND PRE_OB_NO = oh.pre_ob_no AND STATUS_ID = 57\n" +
                    "AND c_id = oh.c_id AND plant_id = oh.plant_id AND lang_id = oh.lang_id AND wh_id = oh.wh_id),0) \n" +
                    "as sumOfPickedQty, \n" +

                    "(select COUNT(PRE_OB_NO) from #pil \n" +
                    "where REF_DOC_NO = oh.REF_DOC_NO AND PRE_OB_NO = oh.pre_ob_no AND STATUS_ID = 57\n" +
                    "AND c_id = oh.c_id AND plant_id = oh.plant_id AND lang_id = oh.lang_id AND wh_id = oh.wh_id) \n" +
    ...
    @QueryHints(@javax.persistence.QueryHint(name = "org.hibernate.fetchSize", value = "1000"))
    @Query(value =
            "SELECT C_ID,PLANT_ID,LANG_ID,WH_ID,REF_DOC_NO,PRE_OB_NO,DLV_QTY,ORD_QTY,STATUS_ID,no_bags into #obl FROM tbloutboundline WHERE is_deleted = 0 and \n" +
                    "(COALESCE(:refDocNo, null) IS NULL OR (ref_doc_no IN (:refDocNo))) AND\n" +
                    "(COALESCE(:companyCodeId, null) IS NULL OR (c_id IN (:companyCodeId))) and \n" +
                    "(COALESCE(:plantId, null) IS NULL OR (plant_id IN (:plantId))) and \n" +
                    "(COALESCE(:languageId, null) IS NULL OR (lang_id IN (:languageId))) and \n" +
    ...
    @Query(value =
            "SELECT C_ID,PLANT_ID,LANG_ID,WH_ID,REF_DOC_NO,PRE_OB_NO,DLV_QTY,ORD_QTY,STATUS_ID into #obl FROM tbloutboundline WHERE is_deleted = 0 and \n" +
                    ...
                    "(COALESCE(CONVERT(VARCHAR(255), :startDeliveryConfirmedOn), null) IS NULL OR (oh.DLV_CNF_ON between COALESCE(CONVERT(VARCHAR(255), :startDeliveryConfirmedOn), null) and COALESCE(CONVERT(VARCHAR(255), :endDeliveryConfirmedOn), null))) and\n" +
                    "(COALESCE(CONVERT(VARCHAR(255), :startOrderDate), null) IS NULL OR (oh.DLV_CTD_ON between COALESCE(CONVERT(VARCHAR(255), :startOrderDate), null) and COALESCE(CONVERT(VARCHAR(255), :endOrderDate), null))) \n ", nativeQuery = true)
    List<OutboundHeaderV2Stream> findAllOutBoundHeaderFahaheel(
            @Param(value = "companyCodeId") List<String> companyCodeId,
            @Param(value = "plantId") List<String> plantId,
            @Param(value = "languageId") List<String> languageId,
            @Param(value = "warehouseId") List<String> warehouseId,
    ...
    @Modifying
    @Query(value = "update tbloutboundline set status_id = :statusId, status_text = :statusText, DLV_QTY =:orderQty, REF_FIELD_9 =:orderQty \n" +
            "where ref_doc_no = :refDocNo and " +
            "PRE_OB_NO = :preOutboundNo and c_id = :companyId and plant_id = :plantId and wh_id = :warehouseId and is_deleted = 0 " +
            "and OB_LINE_NO = :lineNo and ITM_CODE = :itemCode", nativeQuery = true)
    void updateOutboundLineStatusV5(@Param("statusId") Long statusId,
    ...
    void updateOutboundHeaderStatusV5(@Param("statusId") Long statusId,
                                    @Param("statusText") String statusText,
                                    @Param("refDocNo") String refDocNo,
                                    @Param("preOutboundNo") String preOutboundNo,
                                    @Param("companyId") String companyId,
    ...
    public void updateOutboundHeaderStatusV5(@Param("companyCodeId") String companyCodeId,
                                             ...
                                             @Param("languageId") String languageId,
                                             @Param("warehouseId") String warehouseId,
                                             @Param("refDocNumbers") String refDocNumbers,
                                             @Param("statusId") Long statusId,
                                             @Param("statusDescription") String statusDescription);
    ...
    @Query("Update PickupHeaderV2 ob SET ob.statusId = :statusId, ob.statusDescription = :statusDescription \r\n "
            + " WHERE ob.companyCodeId = :companyCodeId AND ob.plantId = :plantId AND ob.languageId = :languageId AND \n"
            + "ob.warehouseId = :warehouseId AND ob.refDocNumber in :refDocNumbers")
    public void updatePickupHeaderStatusV5(@Param("companyCodeId") String companyCodeId,
                                           @Param("plantId") String plantId,
                                           @Param("languageId") String languageId,
                                           @Param("warehouseId") String warehouseId,
                                           @Param("refDocNumbers") String refDocNumbers,
    ...
    @Modifying
    @Transactional
    @Query(value = "Update tbloutboundheader SET \n" +
            "STATUS_ID      = :statusId, \n" +
            "STATUS_TEXT    = :statusText WHERE \n" +
    ...
    void updateOutboundHeaderV5(@Param("statusId") Long statusId,
                                @Param("statusText") String statusText,
                                @Param("companyCodeId") String companyCodeId,
                                @Param("plantId") String plantId,
                                @Param("languageId") String languageId,
    ...
    @Query(value = "Update tbloutboundheader SET \n" +
            ...
            "PARTNER_CODE   = :partnerCode AND \n" +
            "IS_DELETED     = 0 ", nativeQuery = true)
    void updateOutboundHeaderV7(@Param("statusId") Long statusId,
                                @Param("statusText") String statusText,
                                @Param("companyCodeId") String companyCodeId,
                                @Param("plantId") String plantId,
                                @Param("languageId") String languageId,
    ...
    public void updateOutboundHeaderStatusV7(@Param("companyCodeId") String companyCodeId,
                                             @Param("plantId") String plantId,
                                             @Param("languageId") String languageId,
                                             @Param("warehouseId") String warehouseId,
                                             @Param("preOutboundNo") String preOutboundNo,
