package com.tekclover.wms.api.outbound.transaction.util;
...
//			return Date.from(fromDeliveryDate_d.atStartOfDay(ZoneId.systemDefault()).toInstant());
	 ...
	 * @return
	 */
	public static Date plusDate (Date inputDate) {
		try {

			LocalDate eLocalDate =  LocalDate.ofInstant(inputDate.toInstant(), ZoneId.systemDefault()).plusDays(1);
			log.info("LocalDate2------->  " + eLocalDate.atTime(23, 59, 0));
