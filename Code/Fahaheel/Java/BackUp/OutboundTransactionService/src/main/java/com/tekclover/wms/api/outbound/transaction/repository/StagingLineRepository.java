...
import com.tekclover.wms.api.outbound.transaction.model.inbound.staging.StagingLineEntity;
...
public interface StagingLineRepository extends JpaRepository<StagingLineEntity, Long>,
    ...
    public List<StagingLineEntityV2> findByLanguageIdAndCompanyCodeAndPlantIdAndWarehouseIdAndRefDocNumberAndPreInboundNoAndLineNoAndItemCodeAndCaseCodeAndDeletionIndicator(
