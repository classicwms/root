...
import com.tekclover.wms.api.outbound.transaction.model.outbound.ordermangement.UpdateOrderManagementHeader;
...
import com.tekclover.wms.api.outbound.transaction.repository.OrderManagementHeaderV2Repository;
import org.springframework.beans.BeanUtils;
import org.springframework.beans.factory.annotation.Autowired;
import org.springframework.stereotype.Service;

import com.tekclover.wms.api.outbound.transaction.controller.exception.BadRequestException;
import com.tekclover.wms.api.outbound.transaction.model.outbound.ordermangement.AddOrderManagementHeader;
import com.tekclover.wms.api.outbound.transaction.model.outbound.ordermangement.OrderManagementHeader;
import com.tekclover.wms.api.outbound.transaction.repository.OrderManagementHeaderRepository;
...
public class OrderManagementHeaderService {
     ...
     * @return
     */
//    public OrderManagementHeaderV2 getOrderManagementHeaderV5(String companyCodeId, String plantId, String languageId,
//                                                              String warehouseId, String preOutboundNo,
//                                                              String refDocNumber, String partnerCode) {
//        OrderManagementHeaderV2 orderManagementHeader =
//                orderManagementHeaderV2Repository.findByCompanyCodeIdAndPlantIdAndLanguageIdAndWarehouseIdAndPreOutboundNoAndRefDocNumberAndPartnerCodeAndDeletionIndicator(
...
//     * @return
//     */
//    public OrderManagementHeaderV2 getOrderManagementHeaderV7(String companyCodeId, String plantId, String languageId,
//                                                              String warehouseId, String preOutboundNo,
//                                                              String refDocNumber, String partnerCode) {
//        OrderManagementHeaderV2 orderManagementHeader =
//                orderManagementHeaderV2Repository.findByCompanyCodeIdAndPlantIdAndLanguageIdAndWarehouseIdAndPreOutboundNoAndRefDocNumberAndPartnerCodeAndDeletionIndicator(
...
//    }
    ...
    public OrderManagementHeaderV2 createOrderManagementHeaderV2(OrderManagementHeaderV2 newOrderManagementHeader, String loginUserID)
        ...
        IKeyValuePair description = pickupLineRepository.getDescription(newOrderManagementHeader.getCompanyCodeId(),
                newOrderManagementHeader.getLanguageId(),
                newOrderManagementHeader.getPlantId(),
                newOrderManagementHeader.getWarehouseId());
        ...
        if (newOrderManagementHeader.getStatusId() != null) {
            statusDescription = pickupLineRepository.getStatusDescription(newOrderManagementHeader.getStatusId(), newOrderManagementHeader.getLanguageId());
    ...
    public OrderManagementHeaderV2 updateOrderManagementHeaderV2(String companyCodeId, String plantId, String languageId, String warehouseId,
        ...
        if (dbOrderManagementHeader != null) {
            ...
            if (dbOrderManagementHeader.getStatusId() != null) {
                statusDescription = pickupLineRepository.getStatusDescription(dbOrderManagementHeader.getStatusId(), dbOrderManagementHeader.getLanguageId());
                dbOrderManagementHeader.setStatusDescription(statusDescription);
            }
...
//            orderManagementHeaderV2.setPickupupdatedOn(new Date());
            orderManagementHeaderV2Repository.delete(orderManagementHeaderV2);
