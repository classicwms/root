...
public class MastersService {
    ...
    public String getNextNumberRange(Long numberRangeCode, String warehouseId,
        ...
        try {
            ...
            headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
            headers.add("User-Agent", "Classic WMS's RestTemplate");
            headers.add("Authorization", "Bearer " + authTokenForIDMasterService.getAccess_token());
            UriComponentsBuilder builder =
...
//
//            HttpEntity<?> entity = new HttpEntity<>(headers);
//            UriComponentsBuilder builder = UriComponentsBuilder.fromHttpUrl(getMastersServiceApiUrl() + "businesspartner/v2/" + partnerCode)
//                    .queryParam("companyCodeId", companyCodeId)
//                    .queryParam("plantId", plantId)
//                    .queryParam("warehouseId", warehouseId)
//                    .queryParam("languageId", languageId)
