...
////     * @return
////     */
////    public synchronized InventoryV2 getInventoryBinClassId1V6(String companyCode, String plantId, String languageId, String warehouseId,
////                                                              String itemCode, String manufacturerName, String barcodeId, String alternateUom, String storageBin) {
////        InventoryV2 dbInventoryV2 = new InventoryV2();
////        IInventoryImpl inventory = inventoryV2Repository.getInboundInventoryV6(companyCode, plantId, languageId, warehouseId, barcodeId, null,
////                itemCode, manufacturerName, PACK_BARCODE, storageBin, 1L, alternateUom);
////        if (inventory != null) {
////            BeanUtils.copyProperties(inventory, dbInventoryV2, CommonUtils.getNullPropertyNames(inventory));
////            return dbInventoryV2;
...
//
    ...
    public GrLineV2 getGrLineV2(String companyCode, String languageId, String plantId,
        ...
        if (grLine.isEmpty()) {
            //Exception Log
            errorLogService.createGrLineLog(languageId, companyCode, plantId, warehouseId, refDocNumber, preInboundNo, goodsReceiptNo, palletCode,
    ...
    public List<GrLineV2> getGrLineV2(String companyCode, String languageId, String plantId,
        ...
        if (grLine.isEmpty()) {
            //Exception Log
            errorLogService.createGrLineLog1(languageId, companyCode, plantId, refDocNumber, preInboundNo, packBarcodes, lineNo,
...
////        if (grLine.isEmpty()) {
////            //Exception Log
////            errorLogService.createGrLineLog2(languageId, companyCode, plantId, warehouseId, refDocNumber, preInboundNo, packBarcodes, caseCode,
...
//////    }
    ...
    public List<GrLineV2> getGrLineV2(String companyCode, String languageId, String plantId,
        ...
        if (grLine.isEmpty()) {
            //Exception Log
            errorLogService.createGrLineLog5(languageId, companyCode, plantId, warehouseId, refDocNumber, packBarcodes,
                    "The given values of GrLineV2 with refDocNumber - " + refDocNumber + " doesn't exists.");
...
////        if (grLine.isEmpty()) {
////            //Exception Log
////            errorLogService.createGrLineLog6(languageId, companyCode, plantId, refDocNumber, preInboundNo, lineNo, itemCode,
...
//
    ...
    public void deleteGrLineV2(String companyCodeId, String plantId, String languageId,
        ...
        if (grLine != null) {
            ...
            // Exception Log
            errorLogService.createGrLineLog(languageId, companyCodeId, plantId, warehouseId, refDocNumber, preInboundNo, goodsReceiptNo, palletCode,
    ...
    public List<GrLineV2> deleteGrLineV2(String companyCode, String plantId, String languageId,
        ...
        if (dbGrLineList != null && !dbGrLineList.isEmpty()) {
            for (GrLineV2 grLine : dbGrLineList) {
                ...
                grLine.setUpdatedBy(loginUserID);
                grLine.setUpdatedOn(new Date());
                grLineV2Repository.delete(grLine);
...
////
////    //@Scheduled(fixedDelay = 15000)
////    private void schedulePostGRLineProcessV7() throws Exception {
////        DataBaseContextHolder.clear();
////        DataBaseContextHolder.setCurrentDb("KNOWELL");
////        log.info("Create PutawayHeader Schedule Initiated from KNOWELL : " + new Date());
////        createGrLineScheduleV7();
////    }
////
    /**
...
////    /**
////     * Create GrLine in Schedule
////     * Modified for Knowell_Dev - 30/06/2025
////     * Aakash Vinayak
////     */
////    public void createGrLineScheduleV7() throws Exception {
////        List<GrLineV2> createdGRLines = getGrLineV7(); // returns lines with isPutAwayHeaderCreated = 9L
////
////        log.info("Total GR Lines to process: {}", createdGRLines.size());
////
////        // Step 1: Group by refDocNumber
////        Map<String, List<GrLineV2>> groupedByRefDoc = createdGRLines.stream()
////                .collect(Collectors.groupingBy(GrLineV2::getRefDocNumber));
////
////        for (Map.Entry<String, List<GrLineV2>> entry : groupedByRefDoc.entrySet()) {
////            String refDocNumber = entry.getKey();
////            List<GrLineV2> grLines = entry.getValue();
////
////            if (grLines.isEmpty()) continue;
////
////            GrLineV2 sample = grLines.get(0); // all lines share same metadata
////
////            try {
////                log.info("Processing RefDocNumber: {}, TotalLines: {}", refDocNumber, grLines.size());
////
////                createPutAwayHeaderNonCBMV7(grLines);
////
////                // Success → Update all these lines to 10
////                for (GrLineV2 line : grLines) {
////                    grLineV2Repository.updateGrLineStatusV2(
////                            line.getCompanyCode(), line.getPlantId(), line.getLanguageId(), line.getWarehouseId(),
////                            line.getPreInboundNo(), line.getCreatedOn(), line.getLineNo(), line.getItemCode(), 10L
////                    );
////                }
////
////                log.info("PutAwayHeader Created Successfully for RefDocNumber: {}", refDocNumber);
////            } catch (Exception e) {
////                log.error("Failed to create PutAwayHeader for RefDocNumber: {}, error: {}", refDocNumber, e.toString());
////
////                // Failure → Mark all these lines as failed
////                for (GrLineV2 line : grLines) {
////                    grLineV2Repository.updateGrLineStatusV2(
////                            line.getCompanyCode(), line.getPlantId(), line.getLanguageId(), line.getWarehouseId(),
////                            line.getPreInboundNo(), line.getCreatedOn(), line.getLineNo(), line.getItemCode(), 100L
////                    );
////                }
////
////                // Optional: send notification
////                sendMail(
////                        sample.getCompanyCode(), sample.getPlantId(), sample.getLanguageId(), sample.getWarehouseId(),
////                        refDocNumber, getInboundOrderTypeTable(sample.getInboundOrderTypeId()), e.toString()
////                );
////            }
////        }
////    }
...
////     * @return
////     */
////    public List<GrLineV2> getGrLineV7() {
////        List<GrLineV2> grLine = grLineV2Repository.findByIsPutAwayHeaderCreatedAndDeletionIndicatorOrderByCreatedOn(9L, 0L);
////        log.info("GRLine for putaway header : " + grLine);
////        if (grLine != null) {
////            for (GrLineV2 line : grLine) {
////                grLineV2Repository.updateGrLineStatusV2(line.getCompanyCode(), line.getPlantId(), line.getLanguageId(), line.getWarehouseId(), line.getPreInboundNo(),
////                        line.getCreatedOn(), line.getLineNo(), line.getItemCode(), 1L);
////            }
////            return grLine;
////        }
////        return null;
...
////
////    /**
////     * @param newGrLines  List of input grLine V5
////     * @param loginUserID userID
////     * @throws Exception
////     */
////    @Transactional(propagation = Propagation.REQUIRES_NEW, rollbackFor = Exception.class)
...
////                grLineV2Repository.saveAll(createdGRLines);
////                // Record Insertion in PUTAWAYHEADER table
////                putAwayHeaderAsyncProcessService.createPutAwayHeaderNonCBMV5(createdGRLines, loginUserID);
////            }
////
////            //GrHeader Status 17 Updating Using Stored Procedure when condition met - multiple procedure combined to single procedure
////            statusDescription = stagingLineV2Repository.getStatusDescription(17L, languageId);
...
////            log.info("Status Update Using Stored Procedure ---> GrHeader, StagingLine, InboundLine");
////
////            grHeaderV2Repository.updateGrHeaderStatus(warehouseId, companyCode, plantId, languageId, refDocNumber, 17L, statusDescription);
//////            //Update GrHeader using stored Procedure
...
////                inventory.setQtyInCreate(dbInventory.getQtyInCreate() + createdGRLine.getQtyInCreate());
////                inventory.setQtyInPiece(dbInventory.getQtyInPiece() + createdGRLine.getQtyInPiece());
////                inventory.setQtyInCase(dbInventory.getQtyInCase() + createdGRLine.getQtyInCase());
...
////                inventory.setStorageBin(dbInventory.getStorageBin());
...
////
////    @Transactional(propagation = Propagation.REQUIRES_NEW, rollbackFor = Exception.class)
////    public List<GrLineV2> createGrLineNonCBMV6(@Valid List<AddGrLineV2> newGrLines, String loginUserID) throws Exception {
////
////        List<GrLineV2> createdGRLines = new ArrayList<>();
////        String companyCode = null;
////        String plantId = null;
...
////        String itemCode = null;
////        String packBarcodes = "99999";
////        Long lineNo = newGrLines.get(0).getLineNo();
//////        Long lineNo = 1L;
////
////        try {
////            // Inserting multiple records
...
////            log.info("Records were inserted successfully...");
////            if (!createdGRLines.isEmpty()) {
////                putAwayHeaderAsyncProcessService.createGrLineAsyncProcessV6(companyCode, plantId, languageId, warehouseId, createdGRLines, loginUserID);
////            }
////
////            //GrHeader Status 17 Updating Using Stored Procedure when condition met - multiple procedure combined to single procedure
////            statusDescription = stagingLineV2Repository.getStatusDescription(17L, languageId);
...
////     */
//////    @Async("asyncExecutor")
////    private void createPutAwayHeader(String company, String plant, String language,
...
////
////            log.info("PA number ----------------> {}", nextPANumber);
////            fireBaseNotification(createdGRLine, nextPANumber, loginUserID);
////
////            // Setting params
////            String languageId = createdGRLine.getLanguageId();
////            String companyCode = createdGRLine.getCompanyCode();
