...
public interface PutAwayHeaderV2Repository extends JpaRepository<PutAwayHeaderV2, Long>,
    ...
    @Query(value = "update tblputawayheader SET status_Id = :statusId, status_text = :statusDescription " +
            "WHERE wh_id = :warehouseId AND ref_doc_no = :refDocNumber and c_id = :companyCodeId and plant_id = :plantId and lang_id = :languageId " +
            " and PRE_IB_NO = :preInboundNo and GR_NO = :goodsReceiptNo and PAL_CODE =:palletCode and CASE_CODE = :caseCode and PACK_BARCODE = :packBarcodes and" +
            " PA_NO = :putAwayNumber and PROP_ST_BIN = :proposedStorageBin ", nativeQuery = true)
