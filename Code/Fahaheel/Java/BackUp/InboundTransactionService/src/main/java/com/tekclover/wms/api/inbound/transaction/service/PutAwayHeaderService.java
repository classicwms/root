...
public class PutAwayHeaderService extends BaseService {
     ...
     * @return
     */
    public PutAwayHeaderV2 getPutAwayHeaderV5(String companyCodeId, String plantId, String warehouseId, String languageId,
...
//        }
        ...
        log.info("putAwayHeaderList size for reversal ------> {}", putAwayHeaderList.size());
...
//                createInventoryMovement = inventoryService.getInventoryForInvMmt(companyCode, plantId, languageId, warehouseId, itemCode, manufactureName, 1L);
                ...
                log.info("---#---deleteInventory deleted.." + isDeleted);
                            ...
                            if (dbStagingLineEntity != null) {
                                Double rec_accept_qty = 0D;
                                Double rec_damage_qty = 0D;
                                log.info("dbStagingLineEntity.getRec_accept_qty()  ----> {}", dbStagingLineEntity.getRec_accept_qty() != null ? dbStagingLineEntity.getRec_accept_qty() : 0);
                                log.info("dbPutAwayHeader.getPutAwayQuantity() ------> {}", dbPutAwayHeader.getPutAwayQuantity() != null ? dbPutAwayHeader.getPutAwayQuantity() : 0);
                                ...
                                log.info("rec_accept_qty -----> {}", rec_accept_qty);
                                log.info("rec_damage_qty -----> {}", rec_damage_qty);
    ...
    public List<PutAwayHeaderV2> deletePutAwayHeaderV2(String companyCodeId, String plantId, String languageId,
        ...
        if (putAwayHeaderList != null && !putAwayHeaderList.isEmpty()) {
            for (PutAwayHeaderV2 putAwayHeaderV2 : putAwayHeaderList) {
                ...
                putAwayHeaderV2Repository.delete(putAwayHeaderV2);
...
//     * @return
//     */
//    public List<String> getPutawayHeaderExistingBinCheckV7(String companyCodeId, String plantId, String languageId, String warehouseId) {
//        return putAwayHeaderV2Repository.getPutAwayHeaderProposedBinsV7(companyCodeId, plantId, languageId, warehouseId, 19L);
//    }
...
//     * @return
//     */
//    public PutAwayHeaderV2 getPutawayHeaderExistingBinItemCheckV7(String companyCodeId, String plantId, String languageId, String warehouseId,
//                                                                  String itemCode, String manufacturerName, String alternateUom, Double bagSize, String barcodeId) {
////        PutAwayHeaderV2 dbPutAwayHeader = putAwayHeaderV2Repository.findTopByCompanyCodeIdAndPlantIdAndWarehouseIdAndLanguageIdAndReferenceField5AndManufacturerNameAndStatusIdAndAlternateUomAndBagSizeAndDeletionIndicatorOrderByCreatedOn(companyCodeId, plantId, warehouseId, languageId, itemCode, manufacturerName, 19L, alternateUom, bagSize, 0L);
//        PutAwayHeaderV2 dbPutAwayHeader = putAwayHeaderV2Repository.findLatestPutawayHeader(
//                companyCodeId, plantId, warehouseId, languageId, itemCode, manufacturerName, 19L, barcodeId);
//        return dbPutAwayHeader;
//    }
     ...
     * @param lineReferenceNo
     * @param languageId
     * @param putAwayNumber
     * @return
     */
    public PutAwayHeaderV2 fetchPutawayHeaderByItemV2(String companyId, String plantId, String warehouseId, String itemCode, String manufactureName, String lineReferenceNo , String languageId, String putAwayNumber) {
