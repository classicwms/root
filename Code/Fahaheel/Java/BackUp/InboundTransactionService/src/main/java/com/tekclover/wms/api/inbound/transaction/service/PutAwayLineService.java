...
//        log.info("newPutAwayLines to confirm : " + newPutAwayLines);
//        log.info("Inputs------->" +newPutAwayLines.size());
//
...
//                }
//
//                log.info("PutAwayHeader Record is Queried V5 --------------> Unique No is PackBarcodeId is -------> {}", newPutAwayLine.getPackBarcodes());
...
//                    //notiifcation code
//                    String cnfStBin = dbPutAwayLine.getConfirmedStorageBin();
...
//                        fetch.setRefDocNumber(dbPutAwayLine.getRefDocNumber());
//                        fetch.setPreInboundNo(dbPutAwayLine.getPreInboundNo());
//                        fetch.setCreatedOn(dbPutAwayLine.getCreatedOn());
//                        fbNotificationList.add(fetch);
//                    }
//
//                    if (dbPutAwayLine != null && dbPutAwayLine.getPutawayConfirmedQty() > 0L) {
//
//                        // Updating StorageBin StatusId as '1'
//                        dbStorageBin.setStatusId(1L);
...
//                            putAwayHeader.setStatusId(20L);
//                            putAwayHeaderV2Repository.softUpdateStatusByRefDocNo(putAwayHeader.getWarehouseId(), putAwayHeader.getCompanyCodeId(),
//                                    putAwayHeader.getPlantId(), putAwayHeader.getLanguageId(), putAwayHeader.getRefDocNumber(), putAwayHeader.getPreInboundNo(), putAwayHeader.getGoodsReceiptNo(),
//                                    putAwayHeader.getPalletCode(), putAwayHeader.getCaseCode(), putAwayHeader.getPackBarcodes(), putAwayHeader.getPutAwayNumber(), putAwayHeader.getProposedStorageBin(), 20L, statusDescription);
////                            putAwayHeader.setStatusId(statusUpdate);
...
//                                dbPutAwayLine.getLanguageId(), dbPutAwayLine.getWarehouseId(),
//                                dbPutAwayLine.getRefDocNumber(), dbPutAwayLine.getPreInboundNo(),
...
//                                        + dbPutAwayLine.getPutawayConfirmedQty();
//                            } else {
...
//                        }
//                        inboundLine.setBatchSerialNumber(dbPutAwayLine.getBatchSerialNumber());
//                        inboundLine.setManufacturerDate(dbPutAwayLine.getManufacturerDate());
//                        inboundLine.setExpiryDate(dbPutAwayLine.getExpiryDate());
//                        inboundLine.setReferenceField2("TRUE");
//                        inboundLine.setStatusId(20L);
//                        inboundLine.setQtyInCase(dbPutAwayLine.getQtyInCase());
//                        inboundLine.setQtyInPiece(dbPutAwayLine.getQtyInPiece());
//                        inboundLine.setQtyInCreate(dbPutAwayLine.getQtyInCreate());
//                        inboundLine.setReceivingVariance(dbPutAwayLine.getReceivingVariance());
...
//                        //Create Inventory
////                        inventoryService.createInventoryNonCBMV5(dbPutAwayLine, loginUserID);
//                    }
//                }
//            }
//
//            putAwayLineV2Repository.saveAll(createdPutAwayLines);
//            inventoryAsyncProcessService.createInventoryAsyncProcessV5(createdPutAwayLines, loginUserID);
...
//                }
//            }
//            log.info("PutawayLine Created-------->" + createdPutAwayLines.size());
//            log.info("PutawayLine Created-------->" + createdPutAwayLines);
//            return createdPutAwayLines;
//        } catch (Exception e) {
//            e.printStackTrace();
//            throw e;
...
//                                    Double PUTAWAY_QTY = (putAwayHeader.getPutAwayQuantity() != null ? putAwayHeader.getPutAwayQuantity() : 0) - (createdPutAwayLine.getPutawayConfirmedQty() != null ? createdPutAwayLine.getPutawayConfirmedQty() : 0);
                                        Double PUTAWAY_QTY = dbAssignedPutawayQty - dbPutawayQty;
                                        log.info("-----b4----PUTAWAY_QTY---------2---------> : " + PUTAWAY_QTY);
                        ...
                        /*--------------------- INBOUNDTABLE Updates ------------------------------------------*/
                        // Pass WH_ID/PRE_IB_NO/REF_DOC_NO/IB_LINE_NO/ITM_CODE values in PUTAWAYLINE
                        // table and fetch PA_CNF_QTY values and QTY_TYPE values and updated STATUS_ID
                        // as 20
                        double addedAcceptQty = 0.0;
                        double addedDamageQty = 0.0;
            ...
            putAwayLineV2Repository.updateInboundHeaderReceivedLines(companyCode, plantId, languageId, warehouseId, refDocNumber, preInboundNo);
            log.info("InboundHeader received lines count updated: " + refDocNumber);
...
//
//        try {
//            fireBaseNotification(createdPutAwayLines.get(0), loginUserID);
//        } catch (Exception e) {
//            e.printStackTrace();
...
//     * @return
//     */
//    public List<PutAwayLineV2> putAwayLineConfirmNonCBMV5(@Valid List<PutAwayLineV2> newPutAwayLines, String loginUserID) {
//        ExecutorService asyncExecutor = Executors.newFixedThreadPool(Runtime.getRuntime().availableProcessors());
//
//        List<CompletableFuture<PutAwayLineV2>> futures = newPutAwayLines.stream().map(putAwayLineV2 -> CompletableFuture.supplyAsync(() -> {
//            try {
//                return createPutAwayLineProcessV5(putAwayLineV2, loginUserID);
//            } catch (Exception e) {
//                log.error("Error processing GRLine: {}", putAwayLineV2.getLineNo(), e);
//                return null; // or throw RuntimeException
//            }
...
//        log.info("InboundHeader received lines count updated: " + putAwayLine.getRefDocNumber());
//
//        log.info("Inventory Async Process Started V5-------------------> ");
//        inventoryAsyncProcessService.createInventoryAsyncProcessV5(createdPutAwayLines, loginUserID);
//
//        inboundConfirmValidation(putAwayLine.getCompanyCode(), putAwayLine.getPlantId(), putAwayLine.getLanguageId(), putAwayLine.getWarehouseId(),
//                putAwayLine.getRefDocNumber(), putAwayLine.getPreInboundNo(), loginUserID);
...
//
//                            Long CASE_QTY = newPutAwayLine.getNoBags().longValue();
    ...
    public List<PutAwayLineV2> deletePutAwayLineV2(String languageId, String companyCodeId, String plantId, String warehouseId,
        ...
        if (putAwayLineList != null && !putAwayLineList.isEmpty()) {
            for (PutAwayLineV2 putAwayLineV2 : putAwayLineList) {
                ...
                putAwayLineV2Repository.delete(putAwayLineV2);
...
//     * @param loginUserID
//     */
//    private void inboundConfirmValidationV6(String companyCode, String plantId, String languageId, String warehouseId,
//                                            String refDocNumber, String preInboundNo, String loginUserID) {
//        IKeyValuePair confirmedLines = inboundHeaderV2Repository.findSumOfConfirmedInboundLines(companyCode, plantId, languageId, warehouseId, preInboundNo);
//        if (confirmedLines != null) {
//            log.info("InboundHeader orderQty: " + confirmedLines.getOrdQty() + ", RxdQty: " + confirmedLines.getRxdQty());
...
//     * @throws Exception
//     */
//    public PutAwayLineV2 createPutAwayLineProcessV5(@Valid PutAwayLineV2 newPutAwayLine, String loginUserID) throws Exception {
//        log.info("newPutAwayLines to confirm V5 -----------> : " + newPutAwayLine);
//
//        DataBaseContextHolder.clear();
//        DataBaseContextHolder.setCurrentDb("REEFERON");
//
...
//     * @return
//     */
//    public List<PutAwayLineV2> putAwayLineConfirmNonCBMV6(@Valid List<PutAwayLineV2> newPutAwayLines, String loginUserID) {
//        ExecutorService asyncExecutor = Executors.newFixedThreadPool(Runtime.getRuntime().availableProcessors());
//
//        List<CompletableFuture<PutAwayLineV2>> futures = newPutAwayLines.stream().map(putAwayLineV2 -> CompletableFuture.supplyAsync(() -> {
//            try {
//                return createPutAwayLineProcessV6(putAwayLineV2, loginUserID);
//            } catch (Exception e) {
//                log.error("Error processing GRLine: {}", putAwayLineV2.getLineNo(), e);
//                return null; // or throw RuntimeException
//            }
...
//
//        log.info("Inventory Async Process Started -------------------> ");
//        inventoryAsyncProcessService.createInventoryAsyncProcessV6(createdPutAwayLines, loginUserID);
//
//        inboundConfirmValidationV6(putAwayLine.getCompanyCode(), putAwayLine.getPlantId(), putAwayLine.getLanguageId(), putAwayLine.getWarehouseId(),
//                putAwayLine.getRefDocNumber(), putAwayLine.getPreInboundNo(), loginUserID);
//        return createdPutAwayLines;
//
//    }
     ...
     */
//    @Transactional(propagation = Propagation.REQUIRES_NEW, rollbackFor = Exception.class)
//    public PutAwayLineV2 createPutAwayLineProcessV6(@Valid PutAwayLineV2 newPutAwayLine, String loginUserID) {
////        List<PutAwayLineV2> createdPutAwayLines = new ArrayList<>();
//        log.info("newPutAwayLines to confirm : " + newPutAwayLine);
//
//        DataBaseContextHolder.clear();
...
//                        }
//                        log.info("putawayConfirmQty, putawayQty: " + dbPutAwayLine.getPutawayConfirmedQty() + ", " + putAwayHeader.getPutAwayQuantity());
//                        putAwayHeaderV2Repository.updatePutAwayHeaderV6(putAwayHeader.getWarehouseId(), putAwayHeader.getCompanyCodeId(),
//                                putAwayHeader.getPlantId(), putAwayHeader.getLanguageId(), putAwayHeader.getRefDocNumber(), 20L, statusDescription, putAwayHeader.getPackBarcodes());
//                        log.info("putAwayHeader updated----> StatusId : " + putAwayHeader + " ---->----> " + putAwayHeader.getStatusId());
//                    }
//
