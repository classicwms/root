...
//            return obList.toArray(new StockMovementReport[obList.size()]);
    ...
    // GET
    public OutboundReversal[] doReversal(String refDocNumber, String itemCode, String loginUserID, String companyCodeId,
...
public WarehouseApiResponse productionOrderUploadRM( List<SalesOrderV2> salesOrderV2, String authToken) {
    HttpHeaders headers = new HttpHeaders();
    headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
    headers.add("User-Agent", "RestTemplate");
    headers.add("Authorization", "Bearer " + authToken);
    UriComponentsBuilder builder =
            UriComponentsBuilder.fromHttpUrl(getOutboundOrderServiceApiUrl() + "outboundorder/outbound/rm/upload/salesorderv6");
    HttpEntity<?> entity = new HttpEntity<>(salesOrderV2,headers);
    ResponseEntity<WarehouseApiResponse> result =
            getRestTemplate().exchange(builder.toUriString(), HttpMethod.POST, entity, WarehouseApiResponse.class);
    return result.getBody();
...
//Production Order FG
    ...
    public WarehouseApiResponse productionOrderUploadFG( List<SalesOrderV2> salesOrderV2, String authToken) {
        HttpHeaders headers = new HttpHeaders();
        headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
        headers.add("User-Agent", "RestTemplate");
        headers.add("Authorization", "Bearer " + authToken);
        UriComponentsBuilder builder =
                UriComponentsBuilder.fromHttpUrl(getOutboundOrderServiceApiUrl() + "outboundorder/outbound/fg/upload/salesorderv6");
        HttpEntity<?> entity = new HttpEntity<>(salesOrderV2,headers);
        ResponseEntity<WarehouseApiResponse> result =
                getRestTemplate().exchange(builder.toUriString(), HttpMethod.POST, entity, WarehouseApiResponse.class);
        return result.getBody();
...
//Production Order FG
    public OrderManagementLineV2[] processOutboundFG(String companyCodeId, String plantId, String languageId,
        ...
        try {
            ...
            headers.add("Authorization", "Bearer " + authToken.getAccess_token());
            UriComponentsBuilder builder =
                    UriComponentsBuilder.fromHttpUrl(getOutboundOrderServiceApiUrl() + "outboundorder/fg/order/process")
                            .queryParam("companyCodeId", companyCodeId).queryParam("plantId", plantId)
                            .queryParam("languageId", languageId).queryParam("warehouseId", warehouseId)
                            .queryParam("preOutboundNo", preOutboundNo).queryParam("refDocNumber", refDocNumber)
                            .queryParam("loginUserID", loginUserID);
            HttpEntity<?> entity = new HttpEntity<>(headers);
