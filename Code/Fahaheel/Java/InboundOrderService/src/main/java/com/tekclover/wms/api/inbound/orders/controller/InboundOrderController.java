...
//    //-----------------------------------------------New Mobile App----------------------------------------------------------
//    @ApiOperation(response = InboundOrderMobileApp.class, value = "For MobileApp")
//    @PostMapping("inbound/mobileApp")
//    public ResponseEntity<?> postInboundMobileApp(@RequestBody InboundOrderMobileApp inboundOrderMobileApp) {
//        try {
//            DataBaseContextHolder.setCurrentDb("MT");
//            String profile = dbConfigRepository.getDbName(inboundOrderMobileApp.getCompanyCode(), inboundOrderMobileApp.getPlantId(), inboundOrderMobileApp.getWarehouseId());
//            log.info("ROUTING DB FETCH FROM DB CONFIG TABLE --> {}", profile);
//            DataBaseContextHolder.clear();
//            DataBaseContextHolder.setCurrentDb(profile);
//            InboundOrderMobileApp mobileApp = transactionService.postInboundMobileApp(inboundOrderMobileApp);
//            return new ResponseEntity<>(mobileApp, HttpStatus.OK);
//        } finally {
//            DataBaseContextHolder.clear();
//        }
//    }
...
//    //--------------------------------------------------FG Inbound----------------------------------------------------------
//
//    @ApiOperation(response = InboundHeaderEntityV2.class, value = "create inbound")
...
//            supplierInvoiceServiceV6.processInbound(preInboundNo, refDocNumber);
//            WarehouseApiResponse response = new WarehouseApiResponse();
//            response.setStatusCode("200");
//            response.setMessage("Success");
//            return new ResponseEntity<>(response, HttpStatus.OK);
...
//            WarehouseApiResponse response = new WarehouseApiResponse();
//            response.setStatusCode("400");
//            response.setMessage("Error processing inbound");
//            return new ResponseEntity<>(response, HttpStatus.EXPECTATION_FAILED);
//        }
//    }
}
