...
public interface PreInboundHeaderV2Repository extends JpaRepository<PreInboundHeaderEntityV2, Long>,
    ...
    @Query(value = "select * from tblpreinboundheader where " +
            " PRE_IB_NO = :preInboundNo and REF_DOC_NO = :refDocNumber ",nativeQuery = true)
    public PreInboundHeaderEntityV2 getPreInboundHeader(@Param("preInboundNo") String preInboundNo,
                                                        @Param("refDocNumber") String refDocNumber);
}