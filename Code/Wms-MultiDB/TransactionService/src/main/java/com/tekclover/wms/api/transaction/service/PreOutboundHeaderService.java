...
//        String routingDb = dbConfigRepository.getDbName(createdPreOutboundHeader.getCompanyCodeId(),createdPreOutboundHeader.getPlantId(),createdPreOutboundHeader.getWarehouseId());
//        log.info("ROUTING DB FETCH FROM DB CONFIG TABLE --> {}",routingDb);
//        DataBaseContextHolder.clear();
//        DataBaseContextHolder.setCurrentDb(routingDb);
