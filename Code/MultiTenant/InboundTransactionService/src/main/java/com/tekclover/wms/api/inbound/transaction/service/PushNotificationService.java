...
import com.tekclover.wms.api.inbound.transaction.repository.NotificationMessageRepository;
    ...
    public String sendPushNotification(List<String> tokens, NotificationSave notification) {
        ...
        while (iterator.hasNext()) {
            ...
            try {
                ...
                log.info(" | " + notification.getLanguageId() + " | " + notification.getCompanyCodeId() + " | " + notification.getPlantId() + " | " + notification.getWarehouseId() + " | "
