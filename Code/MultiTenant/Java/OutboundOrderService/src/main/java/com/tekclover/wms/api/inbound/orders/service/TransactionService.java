...
//    public WarehouseApiResponse processOutboundOrder(String profile) throws IllegalAccessException, InvocationTargetException, ParseException {
                ...
                if (profile != null) {
                    switch (profile) {
                        ...
                        case "REEFERON":
                            ...
                            break;
                        case "BP":
                            outboundHeader = orderProcessingService.processOutboundReceivedV6(outbound);
                            break;
                        case "KNOWELL":
                            outboundHeader = orderProcessingService.processOutboundReceivedV7(outbound);
                            break;
...
//                            break;
                ...
                if (outboundHeader != null) {
                    // Updating the Processed Status
                    outboundOrderV2Repository.updateObOrderStatus(outbound.getCompanyCode(), outbound.getBranchCode(), outbound.getWarehouseID(),
                            outbound.getRefDocumentNo(), 10L);
//                    orderService.updateProcessedOrderV2(outbound.getRefDocumentNo(), outbound.getOutboundOrderTypeID(), 10L);
                    outboundList.remove(outbound);
                    warehouseApiResponse.setStatusCode("200");
                    warehouseApiResponse.setMessage("Success");
                ...
                if ((e.toString().contains("SQLState: 40001") && e.toString().contains("SQL Error: 1205")) ||
                    ...
                    // Updating the Processed Status
                    outboundOrderV2Repository.updateObOrderStatus(outbound.getCompanyCode(), outbound.getBranchCode(), outbound.getWarehouseID(),
                            outbound.getRefDocumentNo(), 900L);
...
//                        preOutboundHeaderService.createOutboundIntegrationLogV2(outbound, e.toString());
                    ...
                    // Updating the Processed Status
                    outboundOrderV2Repository.updateObOrderStatus(outbound.getCompanyCode(), outbound.getBranchCode(), outbound.getWarehouseID(),
                            outbound.getRefDocumentNo(), 100L);
