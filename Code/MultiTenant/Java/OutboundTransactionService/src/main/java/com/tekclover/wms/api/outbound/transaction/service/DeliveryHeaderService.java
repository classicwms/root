...
import com.tekclover.wms.api.outbound.transaction.repository.specification.DeliveryHeaderSpecification;
...
public class DeliveryHeaderService {
    ...
    public DeliveryHeader createDeliveryHeader(AddDeliveryHeader newDeliveryHeader, String loginUserID)
        ...
        IKeyValuePair description = deliveryHeaderRepository.getDescription(dbDeliveryHeader.getCompanyCodeId(),
        ...
        if (dbDeliveryHeader.getStatusId() != null) {
            statusDescription = deliveryHeaderRepository.getStatusDescription(dbDeliveryHeader.getStatusId(), dbDeliveryHeader.getLanguageId());
