...
//                searchStockReport.getStockTypeText());
    ...
    public List<StockReportOutput> stockReportUsingStoredProcedure(SearchStockReportInput searchStockReport) {
...
//        AuthToken authTokenForMastersService = authTokenService.getMastersServiceAuthToken();
        ...
        try {
            ...
            for (OutboundLineV2 outboundLine : outboundLineSearchResults) {
                ...
                //Get Pickupline count for calculating noOfBags
                Long NO_OF_BAGS = pickupLineRepository.getPickupLineCountForBags(outboundLine.getCompanyCodeId(), outboundLine.getPlantId(),
...
//	}
     ...
     * @return
     */
    public List<TransactionHistoryReport> getTransactionHistoryReport(FindImBasicData1 searchImBasicData1) {
        try {
            ...
            List<TransactionHistoryReport> inventoryStockList = transactionHistoryReportRepository.findAll(specification);
...
//        Long quality = qualityHeaderCount.stream().count();
    ...
    /**
     * Modified for Namratha 17-06-2025
     * Aakash Vinayak
     *
     * @param findMobileDashBoard
     * @return
     * @throws Exception
     */
    public MobileDashboard findMobileDashBoardV6(FindMobileDashBoard findMobileDashBoard) throws Exception {
