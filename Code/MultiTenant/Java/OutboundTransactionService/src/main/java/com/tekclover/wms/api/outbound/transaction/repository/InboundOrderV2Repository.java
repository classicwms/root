...
public interface InboundOrderV2Repository extends JpaRepository<InboundOrderV2, Long>,
 ...
 //   public InboundOrderV2 findByRefDocumentNo(String orderId);
   ...
   @Modifying
    @Transactional
    @Query(value = "update tbliborder2 set ref_document_no = :targetRefDocNo where ref_document_no = :sourceRefDocNo", nativeQuery = true)
    int updateInboundOrder(@Param("targetRefDocNo") String targetRefDocNo,
                           @Param("sourceRefDocNo") String sourceRefDocNo);
    ...
    public InboundOrderV2 findByRefDocumentNoAndPurchaseOrderNumberAndInboundOrderTypeId(String orderId, String purchaseOrderNumber, Long inboundOrderTypeId);
}