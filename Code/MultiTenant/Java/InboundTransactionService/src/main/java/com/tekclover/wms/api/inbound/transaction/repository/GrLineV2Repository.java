...
public interface GrLineV2Repository extends JpaRepository<GrLineV2, Long>, JpaSpecificationExecutor<GrLineV2>,
    ...
    List<GrLineV2> findTopBy50ReferenceField4AndDeletionIndicatorOrderByCreatedOn(String referenceField4, Long deletionIndicator);
    ...
    String getGrNumber(@Param("companyCodeId") String companyCodeId,
                       @Param("plantId") String plantId,
                       @Param("languageId") String languageId,
                       @Param("warehouseId") String warehouseId,
                       @Param("refDocNumber") String refDocNumber,
    ...
    @Query(value = "update tblgrline set is_deleted = 1 where REF_DOC_NO = :refDocNumber AND PRE_IB_NO = :preInboundNo and barcode_id = :barcodeId ",nativeQuery = true)
    ...
    @Modifying
    @Query(value = "delete tblgrline where ref_doc_no = :refDocNo and pre_ib_no = :preInboundNo and barcode_id = :barcodeId ", nativeQuery = true)
    void rollPackGrLine(@Param("refDocNo") String refDocNo,
                        @Param("preInboundNo") String preInboundNo,
                        @Param("barcodeId") String barcodeId);
