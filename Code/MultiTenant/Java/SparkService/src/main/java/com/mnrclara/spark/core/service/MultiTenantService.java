    ...
    public List<InventoryV4> findInventoryV2(FindInventoryV2 findInventory) throws ExecutionException, InterruptedException {
        try {
            ...
            String sqlQuery = "SELECT INV_ID, LANG_ID, C_ID, PLANT_ID, WH_ID, " +
                    ...
                    "SELF_LIFE, REMAINING_DAYS, REMAINING_SELF_LIFE_PERCENTAGE, RECEIVINGVARIANCE, PALLET_ID, LOOSE_PACK, MRP, TPL_PARTNER_ID, " +
                    "PRICE_SEGMENT, MATERIAL_NO, ARTICLE_NO, GENDER, ITM_GRP " +
                    "FROM tblinventory";
