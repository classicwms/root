...
//                                          @RequestParam String assignedPickerId, @RequestParam String loginUserID,  @RequestHeader(value = "AuthToken") String authToken)
//            throws IllegalAccessException, InvocationTargetException {
//        OrderManagementLine[] updatedOrderManagementLine =
...
//    }
    ...
    public ResponseEntity<?> updateRefFields(@RequestHeader(value = "AuthToken") String authToken) throws Exception {
...
//                                                                 @RequestParam("loginUserID") String loginUserID,  @RequestHeader(value = "AuthToken") String authToken)
//            throws IllegalAccessException, InvocationTargetException {
...
//    }
    ...
    public ResponseEntity<?> deletePickupHeader(@PathVariable String pickupNumber,
                                                ...
                                                @RequestParam String proposedPackCode, @RequestParam String loginUserID, @RequestHeader(value = "AuthToken") String authToken)
            throws IllegalAccessException, InvocationTargetException {
...
//    }
    ...
    public ResponseEntity<?> postPeriodicHeaderV2(@Valid @RequestBody AddPeriodicHeader newPeriodicHeader,
                                                  @RequestParam String loginUserID, @RequestHeader(value = "AuthToken") String authToken) throws Exception {
...
//		batchJobScheduler.runJobPeriodic();
    ...
    public ResponseEntity<?> deletePeriodicHeaderV2(@PathVariable String cycleCountNo, @RequestParam String warehouseId, @RequestParam String companyCode,
                                                    ...
                                                    @RequestParam Long cycleCountTypeId, @RequestParam String loginUserID, @RequestHeader(value = "AuthToken") String authToken) {
...
//    }
    ...
    public ResponseEntity<?> patchStockAdjustment(@PathVariable Long stockAdjustmentKey, @RequestParam String languageId, @RequestParam String companyCode,
                                                  ...
                                                  @RequestBody List<StockAdjustment> updateStockAdjustment, @RequestHeader(value = "AuthToken") String authToken) throws IllegalAccessException, InvocationTargetException {
    ...
    public ResponseEntity<?> rollBackOutbound(@RequestParam String companyCodeId, @RequestParam String plantId, @RequestParam String languageId,
                                              ...
                                              @RequestParam Long outboundOrderTypeId, @RequestHeader(value = "AuthToken") String authToken) throws Exception {
    ...
    public ResponseEntity<?> getPeriodicHeadersV2(@RequestHeader(value = "AuthToken") String authToken) throws Exception {
...
//    }
    ...
    public ResponseEntity<?> postShipmenOrderV2(@Valid @RequestBody ShipmentOrderV2 shipmenOrder, @RequestHeader(value = "AuthToken") String authToken)
            throws IllegalAccessException, InvocationTargetException {
    ...
    public ResponseEntity<?> createSalesOrderV2(@Valid @RequestBody SalesOrderV2 salesOrderV2, @RequestHeader(value = "AuthToken") String authToken)
            throws IllegalAccessException, InvocationTargetException {
        try {
    ...
    public ResponseEntity<?> createSalesOrderV4(@Valid @RequestBody SalesOrderV2 salesOrderV2, @RequestHeader(value = "AuthToken") String authToken)
            throws IllegalAccessException, InvocationTargetException {
        try {
    ...
    public ResponseEntity<?> createReturnPoV2(@Valid @RequestBody ReturnPOV2 returnPOV2, @RequestHeader(value = "AuthToken") String authToken)
            throws IllegalAccessException, InvocationTargetException {
    ...
    public ResponseEntity<?> createSalesInvoice(@Valid @RequestBody SalesInvoice salesInvoice, @RequestHeader(value = "AuthToken") String authToken)
            throws IllegalAccessException, InvocationTargetException {
...
//    }
    ...
    public StockMovementReport[] findOutboundLineForStockMovement(@RequestBody SearchOutboundLine searchOutboundLine, @RequestHeader(value = "AuthToken") String authToken)
            throws Exception {
    ...
    public StockMovementReport[] findOutboundLineForStockMovementV2(@RequestBody SearchOutboundLineV2 searchOutboundLine, @RequestHeader(value = "AuthToken") String authToken)
            throws Exception {
    ...
    public ResponseEntity<?> getStockMovementReports(@RequestHeader(value = "AuthToken") String authToken) throws Exception {
...
//    }
    ...
    public ResponseEntity<?> getAllStockReport(@RequestParam List<String> languageId,
                                               ...
                                               @RequestParam(required = false) String itemText,
                                               @RequestParam(required = true) String stockTypeText, @RequestHeader(value = "AuthToken") String authToken) {
    ...
    public ResponseEntity<?> getAllStockReportV2(@Valid @RequestBody SearchStockReport searchStockReport, @RequestHeader(value = "AuthToken") String authToken) {
    ...
    public ResponseEntity<?> getAllStockReportV2SP(@Valid @RequestBody SearchStockReportInput searchStockReport, @RequestHeader(value = "AuthToken") String authToken) {
    ...
    public ResponseEntity<?> getStockMovementReport(@RequestParam String warehouseId,
                                                    ...
                                                    @RequestParam String toCreatedOn, @RequestHeader(value = "AuthToken") String authToken) throws Exception {
    ...
    public ResponseEntity<?> getOrderStatusReport(@RequestBody @Valid SearchOrderStatusReport request,
                                                  @RequestHeader(value = "AuthToken") String authToken) throws ParseException, Exception {
    ...
    public ResponseEntity<?> getShipmentDeliveryReport1(@RequestParam String fromDeliveryDate,
                                                        ...
                                                        @RequestHeader(value = "AuthToken") String authToken, @RequestParam(required = true) String warehouseId,
    ...
    public ResponseEntity<?> getShipmentDispatchSummaryReport(@RequestParam String fromDeliveryDate,
                                                              @RequestParam String toDeliveryDate, @RequestParam(required = false) List<String> customerCode,
                                                              @RequestHeader(value = "AuthToken") String authToken, @RequestParam(required = true) String warehouseId) throws ParseException, Exception {
...
//    @GetMapping("/perpetualheader")
//    public ResponseEntity<?> getPerpetualHeaders( @RequestHeader(value = "AuthToken") String authToken) throws Exception {
...
//    }
    ...
    public ResponseEntity<?> getPeriodicHeaders(@RequestHeader(value = "AuthToken") String authToken) throws Exception {
...
//    }
    ...
    //Namratha
    @ApiOperation(response = PeriodicHeaderEntityV2.class, value = "Namratha Post PeriodicHeader and Line V2")
    // label for swagger
...
//    }
    ...
    public ResponseEntity<?> scheduleInventoryReport(@RequestHeader(value = "AuthToken") String authToken)
            throws IllegalAccessException, InvocationTargetException {
    ...
    public ResponseEntity<?> postSalesOrderUploadV3(@RequestParam(required = false) String companyCodeId, @RequestParam(required = false) String plantId,
        ...
        if (profile != null) {
            ...
            } else if (companyCodeId.equals("2100") || companyCodeId.equals("2200")) {
                response = fileStorageService.processOutboundOrdersV9(companyCodeId, plantId, languageId, warehouseId, outboundOrderTypeId, loginUserID, file);
            } else if (companyCodeId.equals("5100")) {
                response = fileStorageService.processOutboundOrdersV10(companyCodeId, plantId, languageId, warehouseId, outboundOrderTypeId, loginUserID, file);
            }
        }
...
//        return new ResponseEntity<>(response, HttpStatus.OK);
    ...
    public ResponseEntity<?> getOBAllOrders(@RequestHeader(value = "AuthToken") String authToken) {
    ...
    public ResponseEntity<?> getOBOrdersByDate(@RequestParam String orderStartDate,
                                               @RequestParam String orderEndDate, @RequestHeader(value = "AuthToken") String authToken) throws Exception {
    ...
    public ResponseEntity<?> getOutboundOrdersById(@PathVariable String orderId, @RequestHeader(value = "AuthToken") String authToken) {
    ...
    public ResponseEntity<?> getFailedOutboundOrders(@RequestHeader(value = "AuthToken") String authToken) throws Exception {
    ...
    public ResponseEntity<?> postPerpetual(@Valid @RequestBody Perpetual perpetual, @RequestHeader(value = "AuthToken") String authToken)
            throws IllegalAccessException, InvocationTargetException {
    ...
    public ResponseEntity<?> postPeriodic(@Valid @RequestBody Periodic periodic, @RequestHeader(value = "AuthToken") String authToken)
            throws IllegalAccessException, InvocationTargetException {
    ...
    public ResponseEntity<?> patchAllocateV2(@Valid @RequestBody List<OrderManagementLineV2> orderManagementLineV2, @RequestParam String loginUserID, @RequestHeader(value = "AuthToken") String authToken)
            throws IllegalAccessException, InvocationTargetException {
        OrderManagementLineV2[] updatedOrderManagementLine =
    ...
    public ResponseEntity<?> updateRefFieldsV2(@RequestHeader(value = "AuthToken") String authToken) throws Exception {
...
//                                                                   @RequestParam String languageId, @RequestParam String warehouseId, @RequestParam("loginUserID") String loginUserID,  @RequestHeader(value = "AuthToken") String authToken)
//            throws IllegalAccessException, InvocationTargetException {
...
//    }
    ...
    // label for swagger // label for swagger
    @PatchMapping("/pickupheader/update-assigned-picker")
    public ResponseEntity<?> patchAssignedPickerIdInPickupHeaderV2(@Valid @RequestBody List<PickupHeaderV2> updatePickupHeaderList, @RequestHeader(value = "AuthToken") String authToken)
            throws IllegalAccessException, InvocationTargetException {
        PickupHeaderV2[] updatedPickupHeader =
    ...
    public ResponseEntity<?> deleteOutboundHeader(@PathVariable String preOutboundNo, @RequestParam String companyCodeId, @RequestParam String plantId,
                                                  @RequestParam String languageId, @RequestParam String warehouseId, @RequestParam String refDocNumber,
                                                  @RequestParam String partnerCode, @RequestParam String loginUserID, @RequestHeader(value = "AuthToken") String authToken) {
    ...
    public ResponseEntity<?> postDriverRemark(@Valid @RequestBody DriverRemark newDriverRemark,
                                              @RequestParam String loginUserID, @RequestHeader(value = "AuthToken") String authToken) throws IllegalAccessException, InvocationTargetException, java.text.ParseException {
    ...
    public ResponseEntity<?> findDriverRemark(@Valid @RequestBody SearchDriverRemark searchDriverRemark, @RequestHeader(value = "AuthToken") String authToken) throws IllegalAccessException, InvocationTargetException, java.text.ParseException {
    ...
    public ResponseEntity<?> updateOutboundOrder(@RequestParam String orderId, @RequestBody UpdateOutboundOrder updateOutboundOrder, @RequestHeader(value = "AuthToken") String authToken) throws Exception {
    ...
    public ResponseEntity<?> deleteOutboundOrder(@RequestParam String orderId, @RequestHeader(value = "AuthToken") String authToken) throws Exception {
    ...
    public ResponseEntity<?> outboundReversal(@RequestBody OutboundReversalInput outboundReversalInput, @RequestHeader(value = "AuthToken") String authToken) {
    ...
    //============SPAREX==============================================
    // Pdf Upload - Sales Orders - V10
    @ApiOperation(response = SalesOrderV2.class, value = "Sales Order V10 Pdf Upload") // label for swagger
    @PostMapping("/outbound/pdf/upload/v10")
    public ResponseEntity<?> postSalesOrderUploadPdfV10(@RequestParam(required = false) String companyCodeId, @RequestParam(required = false) String plantId,
                                                        @RequestParam(required = false) String languageId, @RequestParam(required = false) String warehouseId,
                                                        @RequestParam(required = false) String loginUserID, @RequestParam(required = false) Long outboundOrderTypeId, @RequestParam("file") MultipartFile file) throws Exception {
        Map<String, String> response = null;
        String profile = companyCodeId;
        log.info("Outbound Upload In {}", profile);
        if (profile != null) {
            if (companyCodeId.equals("5100")) {
                response = fileStorageService.processPdfFileV10(companyCodeId, plantId, languageId, warehouseId, outboundOrderTypeId, loginUserID, file);
            }
        }
        if (response.containsKey("errors")) {
            String res = response.getOrDefault("errors", response.get("errors"));
    ...
    // Find PackingLine V10
    @ApiOperation(response = PackingLineRes[].class, value = "Find PackingLine") // label for swagger
    @PostMapping("/find/packingline")
    public ResponseEntity<?> postPackingLineFind(@Valid @RequestBody FindPackingLine findPackingLine, @RequestHeader(value = "AuthToken") String authToken)
            throws Exception {
        PackingLineRes[] packingLine = outboundTransactionService.findPackingLineV10(findPackingLine, authToken);
    ...
    public ResponseEntity<?> updateOutboundV10(@Valid @RequestBody List<PickupLineV2> updateOutboundLine, @RequestParam String loginUserID,
                                               @RequestHeader(value = "AuthToken") String authToken) throws IllegalAccessException, InvocationTargetException {
        PickupLineV2[] updatedOutboundLine =
                outboundTransactionService.updateOutboundV10(updateOutboundLine, loginUserID, authToken);
        return new ResponseEntity<>(updatedOutboundLine, HttpStatus.OK);
    }

    // Delivery Confirmation V10
    @ApiOperation(response = OutboundLineV2.class, value = "Delivery Confirmation OutboundLines ") // label for swagger
    @PostMapping("outbound/delivery/confirmation/v10")
    public ResponseEntity<?> deliveryConfirmationV10(@RequestBody List<OutboundLineV2> outboundLine,
                                                     @RequestParam String loginUserID, @RequestHeader(value = "AuthToken") String authToken) {
        OutboundLineV2[] createdOutboundLine =
                outboundTransactionService.deliveryConfirmationV10(outboundLine, loginUserID, authToken);
        return new ResponseEntity<>(createdOutboundLine, HttpStatus.OK);
    }

    //----------SPAREX-----Outbound Cancellation---------------------------
    @ApiOperation(response = OutboundOrder.class, value = "Outbound Cancellation") // label for swagger
    @PostMapping("/order/outboundCancellation/V10")
    public ResponseEntity<?> outboundCancellationV10(@RequestBody List<OutboundCancellation> outboundCancellation, @RequestHeader(value = "AuthToken") String authToken) {
        WarehouseApiResponse response = outboundTransactionService.outboundCancellationV10(outboundCancellation, authToken);
        return new ResponseEntity<>(response, HttpStatus.OK);
    }

    //----------SPAREX-----Outbound Reversal---------------------------
    @ApiOperation(response = OutboundOrder.class, value = "Outbound Reversal") // label for swagger
    @PostMapping("/order/outboundreversal/V10")
    public ResponseEntity<?> outboundReversalV10(@RequestBody List<OutboundCancellation> outboundCancellation, @RequestHeader(value = "AuthToken") String authToken) {
        WarehouseApiResponse response = outboundTransactionService.outboundReversalV10(outboundCancellation, authToken);
        return new ResponseEntity<>(response, HttpStatus.OK);
    }

    //==========SPAREX Pdf Extraction=====================================//
    @ApiOperation(response = String.class, value = "Pdf Extraction")
    @PostMapping(value = "/pdf/extract", consumes = "multipart/form-data")
    public ResponseEntity<?> pdfExtraction(@RequestParam(required = false) String companyCodeId, @RequestParam(required = false) String plantId,
                                           @RequestParam(required = false) String languageId, @RequestParam(required = false) String warehouseId,
                                           @RequestParam(required = false) String loginUserID, @RequestParam("file") MultipartFile file, @RequestHeader(value = "AuthToken") String authToken) {
        try {
            ...
            dbWarehouseApiResponse = Arrays.asList(outboundTransactionService.postSalesOrderUploadV10(salesOrders, authToken));
            return new ResponseEntity<>(dbWarehouseApiResponse, HttpStatus.OK);

        } catch (Exception e) {
            e.printStackTrace();
            return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR)
                    .body("Failed to extract PDF: " + e.getMessage());
        }
    }

    //----------SPAREX-----Pickup Reversal---------------------------
    @ApiOperation(response = PickupHeaderV2.class, value = "Pickup Update Reversal") // label for swagger
    @PostMapping("/pickup/update/reversal/V10")
    public ResponseEntity<?> pickupReversalV10(@RequestBody List<PickupNewUpdate> pickupNewUpdate, @RequestHeader(value = "AuthToken") String authToken) {
        WarehouseApiResponse response = outboundTransactionService.pickupReversalV10(pickupNewUpdate, authToken);
        return new ResponseEntity<>(response, HttpStatus.OK);
    }

    //=========SPAREX Pickup Find V10=============
    @ApiOperation(response = PickupLineV2.class, value = "Search PickupLine V2") // label for swagger
    @PostMapping("/pickupline/v10/findPickupLine")
    public PickupLineV2[] findPickupLineV10(@RequestBody SearchPickupLineV2 searchPickupLine,
                                            @RequestHeader(value = "AuthToken") String authToken) throws Exception {
        return outboundTransactionService.findPickupLineV10(searchPickupLine, authToken);
    }

    //===========SPAREX====================
    @ApiOperation(response = PickupHeaderV2.class, value = "Update PickupHeader V10") // label for swagger
    @PatchMapping("/pickupheader/v10")
    public ResponseEntity<?> patchPickupHeaderV10(@Valid @RequestBody PickupHeaderV2 updatePickupHeader,
                                                  @RequestParam String loginUserID, @RequestHeader(value = "AuthToken") String authToken)
            throws IllegalAccessException, InvocationTargetException {
        PickupHeaderV2 createdPickupHeader =
                outboundTransactionService.updatePickupHeaderV10(loginUserID, updatePickupHeader, authToken);
        return new ResponseEntity<>(createdPickupHeader, HttpStatus.OK);
    }

    //Packing Create V10
    @ApiOperation(response = PackingLine.class, value = "Create PackingLine ") // label for swagger
    @PostMapping("/packingLine/v10")
    public ResponseEntity<?> postPackingNew(@Valid @RequestBody List<AddPickupLine> addPackingLine,
                                            @RequestParam String loginUserID, @RequestHeader(value = "AuthToken") String authToken)
            throws IllegalAccessException, InvocationTargetException, Exception {
        PackingLine[] createdPickupLine = outboundTransactionService.createPackingLineV10(addPackingLine, loginUserID, authToken);
        return new ResponseEntity<>(createdPickupLine, HttpStatus.OK);
    }
    ...
    public ResponseEntity<?> orderAllocationManualV10(@RequestBody List<OrderManagementLineV2> orderManagementLineV2List, @RequestParam String loginUserID, @RequestHeader(value = "AuthToken") String authToken) {

        OrderManagementLineV2[] orderManagementLineV2s = outboundTransactionService.orderAllocationManualV10(orderManagementLineV2List, loginUserID, authToken);
    ...
    @ApiOperation(response = InhouseTransferHeader.class, value = "Create InHouseTransferHeader V2")
    // label for swagger
    @PostMapping("/inhousetransferheader/barcode")
    public ResponseEntity<?> postInHouseTransferHeaderV9(@RequestBody InhouseTransferHeader newInHouseTransferHeader, @RequestParam String loginUserID,
                                                         @RequestHeader(value = "AuthToken") String authToken) throws IllegalAccessException, InvocationTargetException {
        InhouseTransferHeader createdInHouseTransferHeader = outboundTransactionService.createInhouseTransferHeaderV9(newInHouseTransferHeader, loginUserID, authToken);
        return new ResponseEntity<>(createdInHouseTransferHeader, HttpStatus.OK);
    }

    @ApiOperation(response = OutboundOrder.class, value = "Outbound Reversal By PalletCode") // label for swagger
    @PostMapping("/order/outboundreversal/pallet")
    public ResponseEntity<?> outboundReversalByPallet(@RequestBody OutboundReversalInputNew outboundReversalInput, @RequestHeader(value = "AuthToken") String authToken) {
        WarehouseApiResponse response = outboundTransactionService.outboundReversalByPallet(outboundReversalInput, authToken);
        return new ResponseEntity<>(response, HttpStatus.OK);
    }
    ...
    public ResponseEntity<?> outboundCancellation(@RequestBody OutboundReversalInput outboundReversalInput, @RequestHeader(value = "AuthToken") String authToken) {
    ...
    //SalesOrder V2
    @ApiOperation(response = SalesOrderV2[].class, value = "Create SalesOrderV2") // label for swagger
    @PostMapping("/warehouse/outbound/salesorder/v9")
    public ResponseEntity<?> createSalesOrderV9(@Valid @RequestBody List<SalesOrderV2> salesOrderV2, @RequestHeader(value = "AuthToken") String authToken)
            throws IllegalAccessException, InvocationTargetException {
        try {
            WarehouseApiResponse[] createdSoV2 = outboundTransactionService.postSalesOrderV9(salesOrderV2, authToken);
            return new ResponseEntity<>(createdSoV2, HttpStatus.OK);
        } catch (Exception e) {
            log.error("Exception while SalesOrder Create : " + e.toString());
            CustomErrorResponse customErrorResponse = new CustomErrorResponse();
    ...
    @ApiOperation(response = PreOutboundLineV2.class, value = "Create inbound") // label for swagger
    @PostMapping("/bf/order/process/v9")
    public ResponseEntity<?> processOutboundOrderV9(@RequestBody List<PreOutboundLineV2> preOutboundLineV2List,
                                                    @RequestHeader(value = "AuthToken") String authToken) {
        WarehouseApiResponse[] response = outboundTransactionService.processOutboundOrderV9(preOutboundLineV2List);
        return new ResponseEntity<>(response, HttpStatus.OK);
    }

    @ApiOperation(response = AssignPickerId.class, value = "Assign Picker") // label for swagger
    @PatchMapping("/assignPicker/new")
    public ResponseEntity<?> assignPickerV9(@RequestBody List<AssignPickerId> assignPicker,
                                            @RequestParam String assignedPickerId, @RequestParam String loginUserID, @RequestHeader(value = "AuthToken") String authToken)
            throws IllegalAccessException, InvocationTargetException {
        AssignPickerId[] result = outboundTransactionService.assignPickerV9(assignPicker, assignedPickerId, loginUserID, authToken);
        return new ResponseEntity<>(result, HttpStatus.OK);
    }

    //=============================================BF File InterWarehouseTransferOut Upload ==============================================
    @ApiOperation(response = InterWarehouseTransferOutV2.class, value = "Inter Warehouse Transfer Out V9")
    // label for swagger
    @PostMapping("/warehouse/outbound/interWarehouseTransferout/upload/v9")
    public ResponseEntity<?> postinterWarehouseTransferOutUpload(@RequestParam("file") MultipartFile file, @RequestHeader(value = "AuthToken") String authToken) throws Exception {
        Map<String, String> response = fileStorageService.processInterWarehouseTransferOutOrdersV9(file);
        return new ResponseEntity<>(response, HttpStatus.OK);
    }

    //=========================================BF InterWarehouseTransferOut==============================
    @ApiOperation(response = InterWarehouseTransferOutV2.class, value = "Create InterWarehouseTransferOut V9")
    @PostMapping("/warehouse/outbound/interwarehousetransferout/v9")
    public ResponseEntity<?> createIWhTransferOutV9(@Valid @RequestBody InterWarehouseTransferOutV2 iWhTransferOutV2,
                                                    @RequestHeader(value = "AuthToken") String authToken)
            throws IllegalAccessException, InvocationTargetException {
        WarehouseApiResponse createdIWhTransferOutV2 = outboundTransactionService.postInterWhTransferOutV9(iWhTransferOutV2, authToken);
        return new ResponseEntity<>(createdIWhTransferOutV2, HttpStatus.OK);
    }

    //=========================================BF PreOutboundLine Update==============================
    @ApiOperation(response = PreOutboundLineV2.class, value = "Update PreOutboundLine V2") // label for swagger
    @PatchMapping("/preoutboundline/v9")
    public ResponseEntity<?> patchPreOutboundLineV2(@Valid @RequestBody UpdatePreOutboundLine updatePreOutboundLine, @RequestParam String loginUserID,
                                                    @RequestHeader(value = "AuthToken") String authToken) throws IllegalAccessException, InvocationTargetException {
        PreOutboundLineV2 updatedPreOutboundLine =
                outboundTransactionService.updatePreOutboundLineV2(loginUserID, updatePreOutboundLine, authToken);
        return new ResponseEntity<>(updatedPreOutboundLine, HttpStatus.OK);
    }

    @ApiOperation(response = ContainerReceiptOutboundLine.class, value = "Get ContainerReceiptOutboundLine Report")
    @PostMapping("/reports/containerReceiptOutboundLine")
    public ResponseEntity<?> getContainerReceiptOutboundLine(@RequestBody FindContainerReceiptInboundLine findContainerReceiptInboundLine,
                                                             @RequestHeader(value = "AuthToken") String authToken) throws Exception {
        ContainerReceiptOutboundLine[] containerReceiptOutboundLine = outboundTransactionService.getContainerReceiptOutboundLine(findContainerReceiptInboundLine, authToken);
        return new ResponseEntity<>(containerReceiptOutboundLine, HttpStatus.OK);
    }

    @ApiOperation(response = ContainerReceiptOutboundLine.class, value = "Get ContainerReceiptOutboundLine Report")
    @PostMapping("/reports/containerReceiptOutboundLine/report")
    public ResponseEntity<?> getContainerReceiptOutboundLineReport(@RequestBody FindContainerReceiptInboundLine findContainerReceiptInboundLine,
                                                                   @RequestHeader(value = "AuthToken") String authToken) throws Exception {
        ContainerReceiptOutboundLine[] containerReceiptOutboundLine = outboundTransactionService.getContainerReceiptOutboundLineReport(findContainerReceiptInboundLine, authToken);
        return new ResponseEntity<>(containerReceiptOutboundLine, HttpStatus.OK);
    }

    @ApiOperation(response = PickerDenial.class, value = "PickerDenial") // label for swagger
    @PostMapping("/pickerdenial")
    public ResponseEntity<?> pickerDenial(@RequestBody List<PickerDenial> assignPicker, @RequestHeader(value = "AuthToken") String authToken) throws Exception {
        PickerDenial[] result = outboundTransactionService.updatePickerDenialV9(assignPicker, authToken);
        return new ResponseEntity<>(result, HttpStatus.OK);
    }

    @ApiOperation(response = OutboundLineV2.class, value = "Order ReAllocation") // label for swagger
    @PostMapping("/order/reAllocation/v9")
    public ResponseEntity<?> orderReAllocation(@RequestBody List<OutboundLineV2> assignPicker,
                                               @RequestParam String loginUserID, @RequestHeader(value = "AuthToken") String authToken) throws Exception {
        OutboundLineV2[] result = outboundTransactionService.orderReAllocation(assignPicker, loginUserID, authToken);
        return new ResponseEntity<>(result, HttpStatus.OK);
    }

    @ApiOperation(response = InventoryStockReport.class, value = "Closing Stock Report")
    @PostMapping("/reports/closingstock")
    public ResponseEntity<?> closingStockReportV9(@RequestBody FindImBasicData1 findImBasicData1,
                                                  @RequestHeader(value = "AuthToken") String authToken) throws java.text.ParseException {
        InventoryStockReport[] inventoryReportList = outboundTransactionService.closingStockReportV9(findImBasicData1, authToken);
        return new ResponseEntity<>(inventoryReportList, HttpStatus.OK);
    }

    @ApiOperation(response = OutwardReportResponse.class, value = "Outward Report")
    @PostMapping("/reports/outward")
    public ResponseEntity<?> outwardReportV9(@RequestBody OutwardReportInput inputs,
                                             @RequestHeader(value = "AuthToken") String authToken) throws java.text.ParseException {
        OutwardReportResponse[] responses = outboundTransactionService.outwardReportV9(inputs, authToken);
        return new ResponseEntity<>(responses, HttpStatus.OK);
    }

    @ApiOperation(response = StockMovementLedgerReport.class, value = "Stock Movement Ledger Report")
    @PostMapping("/reports/stock/movement/ledger")
    public ResponseEntity<?> stockMovementLedgerReportV9(@RequestBody LedgerReportInput inputs,
                                                         @RequestHeader(value = "AuthToken") String authToken) throws java.text.ParseException {
        StockMovementLedgerReport[] responses = outboundTransactionService.stockMovementLedgerReportV9(inputs, authToken);
        return new ResponseEntity<>(responses, HttpStatus.OK);
    }

    @ApiOperation(response = UpdateOutboundOrder.class, value = "Outbound Orders Update")
    @PostMapping("/outbound/orders/update/v9")
    public ResponseEntity<?> stockMovementLedgerReportV9(@RequestBody List<UpdateOutboundOrder> inputs,
                                                         @RequestHeader(value = "AuthToken") String authToken) throws java.text.ParseException {
        UpdateOutboundOrder[] responses = outboundTransactionService.updateOutboundOrdersV9(inputs, authToken);
        return new ResponseEntity<>(responses, HttpStatus.OK);
    }

    // ====== NEW Transaction for BF==================================
    @ApiOperation(response = Optional.class, value = "Get transaction History Report V9")
    @PostMapping("/reports/transactionHistoryReport/v9")
    public ResponseEntity<?> getTransactionHistoryReportV9(@RequestBody FindImBasicData1 findImBasicData1,
                                                           @RequestHeader(value = "AuthToken") String authToken) throws java.text.ParseException {
        InventoryStockReport[] inventoryReportList = outboundTransactionService.getTransactionHistoryReportV9(findImBasicData1, authToken);
        return new ResponseEntity<>(inventoryReportList, HttpStatus.OK);
    }

    @ApiOperation(response = OrderManagementLineV2.class, value = "Order ReAllocation") // label for swagger
    @PostMapping("/reallocation/orderlines/v9")
    public ResponseEntity<?> reAllocationOrderV9(@RequestBody List<OrderManagementLineV2> reAllocationLines,
                                                 @RequestParam String loginUserID, @RequestHeader(value = "AuthToken") String authToken) throws Exception {
        OrderManagementLineV2[] result = outboundTransactionService.reAllocationOrderV9(reAllocationLines, loginUserID, authToken);
        return new ResponseEntity<>(result, HttpStatus.OK);
    }
