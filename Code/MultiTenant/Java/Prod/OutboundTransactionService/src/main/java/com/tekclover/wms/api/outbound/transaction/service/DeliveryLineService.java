...
import com.tekclover.wms.api.outbound.transaction.repository.OutboundHeaderV2Repository;
import com.tekclover.wms.api.outbound.transaction.repository.OutboundLineV2Repository;
import com.tekclover.wms.api.outbound.transaction.repository.specification.DeliveryLineSpecification;
    ...
    public List<DeliveryLine> createDeliveryLine(List<AddDeliveryLine> newDeliveryLineList, String loginUserID)
        ...
        for (AddDeliveryLine addDeliveryLine : newDeliveryLineList) {
            ...
            if (!duplicateDeliveryLine.isEmpty()) {
                ...
                //V2 Code
                IKeyValuePair description = deliveryHeaderRepository.getDescription(dbDeliveryLine.getCompanyCodeId(),
                ...
                if (dbDeliveryLine.getStatusId() != null) {
                    statusDescription = deliveryHeaderRepository.getStatusDescription(dbDeliveryLine.getStatusId(), dbDeliveryLine.getLanguageId());
    ...
    public List<DeliveryLine> updateDeliveryLine(List<UpdateDeliveryLine> updateDeliveryLine, String loginUserId)
        ...
        if(deliveryLineCount.equals(deliveryLineCountStatus90)) {
            if(deliveryHeaderList != null && !deliveryHeaderList.isEmpty()){
                statusDescription = deliveryHeaderRepository.getStatusDescription(90L, updateDeliveryLine.get(0).getLanguageId());
        ...
        if(deliveryLineCount.equals(deliveryLineCountStatus91)) {
            if(deliveryHeaderList != null && !deliveryHeaderList.isEmpty()){
                statusDescription = deliveryHeaderRepository.getStatusDescription(91L, updateDeliveryLine.get(0).getLanguageId());
                for(DeliveryHeader deliveryHeader : deliveryHeaderList) {
        ...
        if(deliveryLineCount.equals(deliveryLineCountStatus92)) {
            if(deliveryHeaderList != null && !deliveryHeaderList.isEmpty()){
                statusDescription = deliveryHeaderRepository.getStatusDescription(92L, updateDeliveryLine.get(0).getLanguageId());
                for(DeliveryHeader deliveryHeader : deliveryHeaderList) {
