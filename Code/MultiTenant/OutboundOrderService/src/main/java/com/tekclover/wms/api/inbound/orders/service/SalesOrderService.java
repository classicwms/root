...
import com.tekclover.wms.api.inbound.orders.model.warehouse.cyclecount.CycleCountLine;
        ...
        for (PickupLineV2 dbPickupLine : createdPickupLineList) {
            ...
            if (dbPickupLine.getStatusId() == 50L) {
                ...
                try {
                    ...
                    QC_NO = mastersService.getNextNumberRange(NUM_RAN_CODE, dbPickupLine.getCompanyCodeId(), dbPickupLine.getPlantId(),
