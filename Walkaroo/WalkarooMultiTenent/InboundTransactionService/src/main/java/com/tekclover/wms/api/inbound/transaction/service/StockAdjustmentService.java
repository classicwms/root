...
import com.tekclover.wms.api.inbound.transaction.repository.StockAdjustmentRepository;
import com.tekclover.wms.api.inbound.transaction.repository.specification.StockAdjustmentSpecification;
...
public class StockAdjustmentService extends BaseService {
     ...
     */
    @Transactional
    public WarehouseApiResponse processStockAdjustment(com.tekclover.wms.api.inbound.transaction.model.warehouse.stockAdjustment.StockAdjustment stockAdjustment) throws java.text.ParseException {
...
//                    log.info("Inventory Updated: " + updateInventory);
     ...
     */
    public StockAdjustment autoUpdateStockAdjustmentNew(com.tekclover.wms.api.inbound.transaction.model.warehouse.stockAdjustment.StockAdjustment stockAdjustment) {
...
//    }
    ...
    public StockAdjustment createStockAdjustment(InventoryV2 newInventory,Double inventoryQty, String itemDesc,
                                                 com.tekclover.wms.api.inbound.transaction.model.warehouse.stockAdjustment.StockAdjustment stockAdjustment){
        //StockAdjustment Record Insert
        StockAdjustment dbStockAdjustment = new StockAdjustment();
        BeanUtils.copyProperties(newInventory, dbStockAdjustment, CommonUtils.getNullPropertyNames(newInventory));
    ...
    public StockAdjustment autoUpdateStockAdjustment(com.tekclover.wms.api.inbound.transaction.model.warehouse.stockAdjustment.StockAdjustment stockAdjustment) throws java.text.ParseException {
