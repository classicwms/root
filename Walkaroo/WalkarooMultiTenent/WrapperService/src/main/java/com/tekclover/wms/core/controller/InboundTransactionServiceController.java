...
//            inboundTransactionService.deleteGrLine(warehouseId, preInboundNo, refDocNumber, goodsReceiptNo, palletCode, caseCode, packBarcodes, lineNo, itemCode, loginUserID, authToken);
...
//                    inboundTransactionService.generatePackBarcode(acceptQty, damageQty, warehouseId, loginUserID, authToken);
...
//            PutAwayHeader[] putAwayNumberList = inboundTransactionService.getPutAwayHeaders(authToken);
...
//            PutAwayHeader dbPutAwayHeader = inboundTransactionService.getPutAwayHeader(warehouseId, preInboundNo, refDocNumber, goodsReceiptNo, palletCode, caseCode, packBarcodes, putAwayNumber, proposedStorageBin, authToken);
...
//            PutAwayHeader[] putawayheader = inboundTransactionService.getPutAwayHeader(refDocNumber, authToken);
...
//                throws Exception {
//            return inboundTransactionService.findPutAwayHeader(searchPutAwayHeader, authToken);
//        }
//
//        //Stream
...
//                throws Exception {
//            return inboundTransactionService.findPutAwayHeaderNew(searchPutAwayHeader, authToken);
//        }
//
...
//            PutAwayHeader createdPutAwayHeader = inboundTransactionService.createPutAwayHeader(newPutAwayHeader, loginUserID, authToken);
...
//                    inboundTransactionService.updatePutAwayHeader(warehouseId, preInboundNo,
...
//                throws IllegalAccessException, InvocationTargetException {
//            PutAwayHeader[] updatedPutAwayHeader =
//                    inboundTransactionService.updatePutAwayHeaderV2(updatePutAwayHeader, loginUserID, authToken);
//            return new ResponseEntity<>(updatedPutAwayHeader, HttpStatus.OK);
//        }
//
//        @ApiOperation(response = PutAwayHeader.class, value = "Update PutAwayHeader Bulk Mobile App") // label for swagger
//        @RequestMapping(value = "/putawayheader/bulkupdate/mobApp", method = RequestMethod.PATCH)
//        public ResponseEntity<?> patchPutAwayHeaderMobApp(@Valid @RequestBody List<PutAwayHeaderV2> updatePutAwayHeader, @RequestParam String loginUserID,
//                                                          @RequestParam String authToken)
//                throws IllegalAccessException, InvocationTargetException {
//            PutAwayHeader[] updatedPutAwayHeader =
//                    inboundTransactionService.updatePutAwayHeaderMobApp(updatePutAwayHeader, loginUserID, authToken);
//            return new ResponseEntity<>(updatedPutAwayHeader, HttpStatus.OK);
//        }
//
//        @ApiOperation(response = PutAwayHeader.class, value = "Update PutAwayHeader") // label for swagger
...
//            inboundTransactionService.updatePutAwayHeader(refDocNumber, packBarcodes, loginUserID, authToken);
...
//            inboundTransactionService.deletePutAwayHeader(warehouseId, preInboundNo, refDocNumber, goodsReceiptNo, palletCode, caseCode, packBarcodes, putAwayNumber,
...
//            PutAwayLine[] confirmedStorageBinList = inboundTransactionService.getPutAwayLines(authToken);
...
//            PutAwayLine dbPutAwayLine = inboundTransactionService.getPutAwayLine(warehouseId, goodsReceiptNo, preInboundNo, refDocNumber, putAwayNumber, lineNo, itemCode,
...
//            PutAwayLine[] putawayline = inboundTransactionService.getPutAwayLine(refDocNumber, authToken);
...
//                                             @RequestParam String authToken) throws Exception {
//            return inboundTransactionService.findPutAwayLine(searchPutAwayLine, authToken);
//        }
//
...
//                                                 @RequestParam String authToken) throws IllegalAccessException, InvocationTargetException {
//            PutAwayLine[] createdPutAwayLine = inboundTransactionService.createPutAwayLine(newPutAwayLine, loginUserID, authToken);
...
//                    inboundTransactionService.updatePutAwayLine(warehouseId, goodsReceiptNo, preInboundNo, refDocNumber, putAwayNumber, lineNo, itemCode,
...
//            inboundTransactionService.deletePutAwayLine(languageId, companyCodeId, plantId, warehouseId, goodsReceiptNo, preInboundNo, refDocNumber, putAwayNumber, lineNo, itemCode, proposedStorageBin,
...
//            InventoryMovement[] movementTypeList = inboundTransactionService.getInventoryMovements(authToken);
...
//                                                      @RequestParam String authToken) throws Exception {
//            InventoryMovement dbInventoryMovement = inboundTransactionService.getInventoryMovement(warehouseId, movementType, submovementType,
...
//                                                         @RequestParam String authToken) throws Exception {
//            return inboundTransactionService.findInventoryMovement(searchInventoryMovement, authToken);
//        }
//
...
//                                                       @RequestParam String authToken) throws IllegalAccessException, InvocationTargetException {
//            InventoryMovement createdInventoryMovement = inboundTransactionService.createInventoryMovement(newInventoryMovement, loginUserID, authToken);
...
//                    inboundTransactionService.updateInventoryMovement(warehouseId, movementType, submovementType, packBarcodes, itemCode, batchSerialNumber, movementDocumentNo, updateInventoryMovement,
...
//                                                         @RequestParam String packBarcodes, @RequestParam String itemCode, @RequestParam String batchSerialNumber, @RequestParam String movementDocumentNo,
//                                                         @RequestParam String loginUserID, @RequestParam String authToken) {
//            inboundTransactionService.deleteInventoryMovement(warehouseId, movementType, submovementType, packBarcodes, itemCode, batchSerialNumber, movementDocumentNo, loginUserID, authToken);
//            return new ResponseEntity<>(HttpStatus.NO_CONTENT);
//        }
//
//        /*
...
//            Inventory[] stockTypeIdList = inboundTransactionService.getInventorys(authToken);
...
//                    inboundTransactionService.getInventory(warehouseId, packBarcodes, itemCode, storageBin, stockTypeId, specialStockIndicatorId, authToken);
...
//            Inventory inventory =
//                    inboundTransactionService.getInventory(warehouseId, packBarcodes, itemCode, storageBin, authToken);
...
//                                         @RequestParam String authToken) throws Exception {
//            return inboundTransactionService.findInventory(searchInventory, authToken);
//        }
//
//        //SQL Query - New
...
//                                            @RequestParam String authToken) throws Exception {
//            return inboundTransactionService.findInventoryNew(searchInventory, authToken);
//        }
//
...
//                                                         @RequestParam String authToken) throws Exception {
//            return inboundTransactionService.getQuantityValidatedInventory(searchInventory, authToken);
//        }
//
//
//        @ApiOperation(response = Inventory.class, value = "Search Inventory") // label for swagger
...
//                                             @RequestParam String authToken) throws Exception {
//            return inboundTransactionService.findInventory(searchInventory, pageNo, pageSize, sortBy, authToken);
//        }
//
...
//                                               @RequestParam String authToken) throws IllegalAccessException, InvocationTargetException {
//            Inventory createdInventory = inboundTransactionService.createInventory(newInventory, loginUserID, authToken);
...
//                    inboundTransactionService.updateInventory(warehouseId, packBarcodes, itemCode, storageBin, stockTypeId, specialStockIndicatorId, updateInventory,
//                            loginUserID, authToken);
...
//                                                 @RequestParam String itemCode, @RequestParam String storageBin, @RequestParam Long specialStockIndicatorId,
//                                                 @RequestParam String loginUserID, @RequestParam String authToken) {
//            inboundTransactionService.deleteInventory(warehouseId, packBarcodes, itemCode, storageBin, stockTypeId, specialStockIndicatorId, loginUserID, authToken);
//            return new ResponseEntity<>(HttpStatus.NO_CONTENT);
//        }
//
//        /*
...
//            InhouseTransferHeader[] transferNumberList = inboundTransactionService.getInhouseTransferHeaders(authToken);
...
//                    inboundTransactionService.getInhouseTransferHeader(warehouseId, transferNumber, transferTypeId, authToken);
...
//                                                                 @RequestParam String authToken) throws Exception {
//            return inboundTransactionService.findInHouseTransferHeader(searchInHouseTransferHeader, authToken);
//        }
//
//        //Stream
...
//                                                                    @RequestParam String authToken) throws Exception {
//            return inboundTransactionService.findInHouseTransferHeaderNew(searchInHouseTransferHeader, authToken);
//        }
//
...
//                                                           @RequestParam String authToken) throws IllegalAccessException, InvocationTargetException {
//            InhouseTransferHeader createdInHouseTransferHeader = inboundTransactionService.createInhouseTransferHeader(newInHouseTransferHeader, loginUserID, authToken);
...
//            InhouseTransferLine[] transferNumberList = inboundTransactionService.getInhouseTransferLines(authToken);
//            return new ResponseEntity<>(transferNumberList, HttpStatus.OK);
//        }
//
...
//                    inboundTransactionService.getInhouseTransferLine(warehouseId, transferNumber, sourceItemCode, authToken);
...
//                                                             @RequestParam String authToken) throws Exception {
//            return inboundTransactionService.findInhouseTransferLine(searchInhouseTransferLine, authToken);
//        }
//
...
//                                                         @RequestParam String authToken) throws IllegalAccessException, InvocationTargetException {
//            InhouseTransferLine createdInHouseTransferLine = inboundTransactionService.createInhouseTransferLine(newInHouseTransferLine, loginUserID, authToken);
...
//            InventoryStockReport[] inventoryReportList = inboundTransactionService.getTransactionHistoryReport(findImBasicData1, authToken);
...
//                    inboundTransactionService.getStockReports(warehouseId, itemCode, itemText, stockTypeText,
...
//            StockReport[] stockReportList = inboundTransactionService.getAllStockReports(languageId, companyCodeId, plantId,
...
//            StockReport[] stockReportList = inboundTransactionService.getAllStockReportsV2(searchStockReport, authToken);
//            return new ResponseEntity<>(stockReportList, HttpStatus.OK);
//        }
//
...
//            StockReportOutput[] stockReportList = inboundTransactionService.getAllStockReportsV2SP(searchStockReport, authToken);
//            return new ResponseEntity<>(stockReportList, HttpStatus.OK);
//        }
//
//
...
//                    inboundTransactionService.getInventoryReport(warehouseId, itemCode, storageBin, stockTypeText, stSectionIds,
//                            pageNo, pageSize, sortBy, authToken);
//            return new ResponseEntity<>(inventoryReportList, HttpStatus.OK);
//        }
//
...
//                    inboundTransactionService.getStockMovementReport(warehouseId, itemCode, fromCreatedOn, toCreatedOn, authToken);
//            return new ResponseEntity<>(inventoryReportList, HttpStatus.OK);
//        }
//
//        /*
...
//            OrderStatusReport[] orderStatusReportList = inboundTransactionService.getOrderStatusReport(request, authToken);
...
//            ShipmentDeliveryReport[] shipmentDeliveryList = inboundTransactionService.getShipmentDeliveryReport(warehouseId,
...
//                                                           @RequestParam String authToken)
//                throws ParseException, Exception {
//            ShipmentDeliveryReport[] shipmentDeliveryList = inboundTransactionService.getShipmentDeliveryReportV2(companyCodeId, plantId, languageId, warehouseId,
//                    fromDeliveryDate, toDeliveryDate, storeCode, soType, orderNumber, authToken);
//            return new ResponseEntity<>(shipmentDeliveryList, HttpStatus.OK);
//        }
//
...
//                    inboundTransactionService.getShipmentDeliverySummaryReport(fromDeliveryDate, toDeliveryDate, customerCode, warehouseId, companyCodeId, plantId, languageId, authToken);
...
//                                                         @RequestParam String authToken) throws java.text.ParseException {
//            InventoryStockReport[] inventoryReportList = inboundTransactionService.getInventoryStockReport(findImBasicData1, authToken);
//            return new ResponseEntity<>(inventoryReportList, HttpStatus.OK);
//        }
//
//        ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
//                    inboundTransactionService.getShipmentDispatchSummaryReport(fromDeliveryDate, toDeliveryDate, customerCode, warehouseId, authToken);
...
//                                                             @RequestParam String authToken) throws Exception {
//            ReceiptConfimationReport receiptConfimationReport = inboundTransactionService.getReceiptConfimationReport(asnNumber, authToken);
...
//                                                                @RequestParam String authToken) throws Exception {
//            ReceiptConfimationReport receiptConfimationReport = inboundTransactionService.getReceiptConfimationReportV2(asnNumber, preInboundNo, companyCodeId, plantId, languageId, warehouseId, authToken);
//            return new ResponseEntity<>(receiptConfimationReport, HttpStatus.OK);
//        }
//
//        /*
...
//            MobileDashboard dashboard = inboundTransactionService.getMobileDashboard(companyCode, plantId, languageId, warehouseId, loginUserID, authToken);
...
//                                                   @RequestParam String authToken) throws Exception {
//            return inboundTransactionService.findMobileDashBoard(findMobileDashBoard, authToken);
//        }
//
//        ///*
//        //     * MobileDashboard
...
//        //                                                @RequestParam String authToken) throws Exception {
//        //        MobileDashboard dashboard = inboundTransactionService.getMobileDashboard(warehouseId, authToken);
//        //        return new ResponseEntity<>(dashboard, HttpStatus.OK);
//        //    }
//        /*
//         * -----------------------------Perpetual Count----------------------------------------------------
...
//            PerpetualHeader[] perpetualheaderList = inboundTransactionService.getPerpetualHeaders(authToken);
...
//                    inboundTransactionService.getPerpetualHeader(warehouseId, cycleCountTypeId, cycleCountNo,
...
//                                                           @RequestParam String authToken) throws Exception {
//            return inboundTransactionService.findPerpetualHeader(searchPerpetualHeader, authToken);
//        }
//
...
//                    inboundTransactionService.createPerpetualHeader(newPerpetualHeader, loginUserID, authToken);
...
//                    inboundTransactionService.runPerpetualHeader(runPerpetualHeader, authToken);
...
//                                                              @RequestParam String authToken) throws IllegalAccessException, InvocationTargetException {
//            PerpetualLineEntity[] perpetualLineEntity =
//                    inboundTransactionService.runPerpetualHeaderNew(runPerpetualHeader, authToken);
//            return new ResponseEntity<>(perpetualLineEntity, HttpStatus.OK);
//        }
//
...
//                                                      @RequestParam String authToken) throws IllegalAccessException, InvocationTargetException {
//            PerpetualHeader createdPerpetualHeader =
//                    inboundTransactionService.updatePerpetualHeader(warehouseId, cycleCountTypeId, cycleCountNo, movementTypeId,
...
//                                                       @RequestParam Long cycleCountTypeId, @RequestParam Long movementTypeId, @RequestParam Long subMovementTypeId,
//                                                       @RequestParam String loginUserID, @RequestParam String authToken) {
//            inboundTransactionService.deletePerpetualHeader(warehouseId, cycleCountTypeId, cycleCountNo, movementTypeId,
...
//                                                   @RequestParam String authToken) throws Exception {
//            return inboundTransactionService.findPerpetualLine(searchPerpetualLine, authToken);
//        }
//
...
//                                                         @RequestParam String authToken) throws Exception {
//            return inboundTransactionService.findPerpetualLineStream(searchPerpetualLine, authToken);
//        }
//
...
//                                                    @RequestParam String loginUserID, @RequestParam String authToken)
//                throws IllegalAccessException, InvocationTargetException {
//            PerpetualLine[] createdPerpetualLine = inboundTransactionService.updateAssingHHTUser(assignHHTUser, loginUserID, authToken);
...
//                    inboundTransactionService.updatePerpetualLine(cycleCountNo, updatePerpetualLine, loginUserID, authToken);
//            return new ResponseEntity<>(createdPerpetualLine, HttpStatus.OK);
//        }
//
//        /*
...
//            PeriodicHeaderEntity[] PeriodicheaderList = inboundTransactionService.getPeriodicHeaders(authToken);
...
//                    inboundTransactionService.getPeriodicHeader(warehouseId, cycleCountTypeId, cycleCountNo,
//                            movementTypeId, subMovementTypeId, authToken);
...
//                                                    @RequestParam String authToken) throws Exception {
//            PeriodicHeaderEntity[] results = inboundTransactionService.findPeriodicHeader(searchPeriodicHeader, authToken);
...
//                                                       @RequestParam String authToken) throws Exception {
//            PeriodicHeader[] results = inboundTransactionService.findPeriodicHeaderStream(searchPeriodicHeader, authToken);
//            return new ResponseEntity<>(results, HttpStatus.OK);
//        }
//
...
//            PeriodicHeaderEntity createdPeriodicHeader = inboundTransactionService.createPeriodicHeader(newPeriodicHeader, loginUserID, authToken);
//            log.info("createdPeriodicHeader:" + createdPeriodicHeader);
//
//            /* Call Batch */
////		inboundTransactionService.createCSV(newPeriodicHeader.getPeriodicLine());
...
//                                               @RequestParam String authToken)
//                throws Exception {
//            Page<?> periodicLineEntity = inboundTransactionService.runPeriodicHeader(warehouseId, pageNo, pageSize, sortBy, authToken);
...
//                    inboundTransactionService.updatePeriodicHeader(warehouseId, cycleCountTypeId, cycleCountNo,
...
//            inboundTransactionService.deletePeriodicHeader(warehouseId, cycleCountTypeId, cycleCountNo, loginUserID, authToken);
//            return new ResponseEntity<>(HttpStatus.NO_CONTENT);
//        }
//
//        //-------------------------------PeriodicLine---------------------------------------------------------------------
...
//                                                                                        @RequestParam String authToken) throws Exception {
//            return inboundTransactionService.findPeriodicLine(searchPeriodicLine, authToken);
//        }
//
//        //Stream
...
//                                                                                           @RequestParam String authToken) throws Exception {
//            return inboundTransactionService.findPeriodicLineNew(searchPeriodicLine, authToken);
//        }
//
...
//                    inboundTransactionService.updatePeriodicLineAssingHHTUser(assignHHTUser, loginUserID, authToken);
...
//                    inboundTransactionService.updatePeriodicLine(cycleCountNo, updatePeriodicLine, loginUserID, authToken);
...
//                throws IllegalAccessException, InvocationTargetException {
//            inboundTransactionService.getInventoryReport(authToken);
//            return new ResponseEntity<>(HttpStatus.OK);
//        }
//
...
//            Dashboard dashboard = inboundTransactionService.getDashboardCount(warehouseId, authToken);
//            return new ResponseEntity<>(dashboard, HttpStatus.OK);
//        }
//
...
//                                                            @RequestParam String authToken) throws Exception {
//            FastSlowMovingDashboard[] dashboard = inboundTransactionService.getFastSlowMovingDashboard(fastSlowMovingDashboardRequest, authToken);
//            return new ResponseEntity<>(dashboard, HttpStatus.OK);
//        }
//
//        // File Upload - Orders
...
//                throws IllegalAccessException, InvocationTargetException {
//            WarehouseApiResponse createdSO = inboundTransactionService.postASN(asn, authToken);
...
//            InboundOrder[] inboundOrderList = inboundTransactionService.getInboundOrders(authToken);
...
//            InboundOrder orders = inboundTransactionService.getInboundOrderById(orderId, authToken);
...
//            InboundIntegrationLog[] orders = inboundTransactionService.getFailedInboundOrders(authToken);
//            return new ResponseEntity<>(orders, HttpStatus.OK);
//        }
//
//        /*
...
//                    inboundTransactionService.getContainerReceiptV2(companyCode, plantId, languageId, warehouseId, containerReceiptNo, authToken);
...
//                                                     @RequestParam String warehouseId, @RequestParam String authToken) throws java.text.ParseException {
//            ContainerReceiptV2 containerreceipt =
//                    inboundTransactionService.getContainerReceiptV2(companyCode, plantId, languageId, warehouseId,
...
//                                                           @RequestParam String authToken) throws Exception {
//            return inboundTransactionService.findContainerReceiptV2(searchContainerReceipt, authToken);
//        }
//
//        //Create
...
//                                                        @RequestParam String authToken) throws IllegalAccessException, InvocationTargetException {
//            ContainerReceiptV2 createdContainerReceipt = inboundTransactionService.createContainerReceiptV2(newContainerReceipt, loginUserID, authToken);
...
//                    inboundTransactionService.updateContainerReceiptV2(companyCode, plantId, languageId, warehouseId,
...
//            inboundTransactionService.deleteContainerReceiptV2(companyCode, plantId, languageId, warehouseId, preInboundNo, refDocNumber, containerReceiptNo, loginUserID, authToken);
//            return new ResponseEntity<>(HttpStatus.NO_CONTENT);
//        }
//
//        /*
...
//            PreInboundHeaderV2 preinboundheader = inboundTransactionService.getPreInboundHeaderV2(preInboundNo, warehouseId, companyCode, plantId, languageId, authToken);
...
//                                                           @RequestParam String authToken) throws Exception {
//            return inboundTransactionService.findPreInboundHeaderV2(searchPreInboundHeader, authToken);
//        }
//
//        //Get
...
//                    inboundTransactionService.getPreInboundHeaderWithStatusIdV2(warehouseId, companyCode, plantId, languageId, authToken);
//            log.info("PreInboundHeader : " + preinboundheader);
//            return new ResponseEntity<>(preinboundheader, HttpStatus.OK);
//        }
//
...
//                                                        @RequestParam String authToken) throws IllegalAccessException, InvocationTargetException {
//            PreInboundHeaderV2 createdPreInboundHeader = inboundTransactionService.createPreInboundHeaderV2(newPreInboundHeader, loginUserID, authToken);
...
//                    inboundTransactionService.updatePreInboundHeaderV2(preInboundNo, warehouseId, companyCode, plantId, languageId,
...
//                                                          @RequestParam String authToken) {
//            inboundTransactionService.deletePreInboundHeaderV2(preInboundNo, warehouseId, companyCode, plantId, languageId, loginUserID, authToken);
//            return new ResponseEntity<>(HttpStatus.NO_CONTENT);
//        }
//
//        /*
...
//                    inboundTransactionService.createPreInboundLineBOMV2(preInboundNo, warehouseId, refDocNumber,
...
//            PreInboundLine[] preinboundline = inboundTransactionService.getPreInboundLineV2(preInboundNo, authToken);
...
//                                                             @RequestParam String authToken) throws Exception {
//            return inboundTransactionService.findPreInboundLineV2(searchPreInboundLine, authToken);
//        }
//
//        //Find
//        @ApiOperation(response = PreInboundLineOutputReport.class, value = "Search PreInboundLine v2") // label for swagger
//        @PostMapping("/preinboundline/v2/findPreInboundLine/report")
//        public PreInboundLineOutputReport[] findPreInboundLineReport(@RequestBody SearchPreInboundLineV2 searchPreInboundLine,
//                                                                     @RequestParam String authToken) throws Exception {
//            return inboundTransactionService.findPreInboundLineReport(searchPreInboundLine, authToken);
//        }
//
//        //Patch
...
//                                                       @RequestParam String authToken) throws java.text.ParseException {
//            PreInboundLine preinboundline = inboundTransactionService.patchPreInboundLineV2(
...
//                                                           @RequestParam String authToken) throws Exception {
//            return inboundTransactionService.findInboundHeaderV2(searchInboundHeader, authToken);
//        }
//
//        //Find-Stream
...
//                                                                 @RequestParam String authToken) throws Exception {
//            return inboundTransactionService.findInboundHeaderStreamV2(searchInboundHeader, authToken);
//        }
//
//        //replaceASN
...
//                throws IllegalAccessException, InvocationTargetException {
//            inboundTransactionService.replaceASNV2(refDocNumber, preInboundNo, asnNumber, authToken);
//            return new ResponseEntity<>(HttpStatus.OK);
//        }
//
...
//                                                    @RequestParam String plantId, @RequestParam String languageId,
//                                                    @RequestParam String authToken) throws Exception {
//            InboundHeaderEntityV2 dbInboundHeader = inboundTransactionService.getInboundHeaderV2(companyCode, plantId, languageId, warehouseId, refDocNumber, preInboundNo, authToken);
...
//                    inboundTransactionService.updateInboundHeaderConfirmV2(companyCode, plantId, languageId, warehouseId, preInboundNo, refDocNumber, loginUserID, authToken);
...
//                                                                    @RequestParam String loginUserID, @RequestParam String authToken) {
//            AXApiResponse createdInboundHeaderResponse =
//                    inboundTransactionService.updateInboundHeaderPartialConfirmV2(companyCode, plantId, languageId, warehouseId, preInboundNo, refDocNumber, loginUserID, authToken);
//            return new ResponseEntity<>(createdInboundHeaderResponse, HttpStatus.OK);
//        }
//
...
//                                                                                    @RequestParam String loginUserID, @RequestParam String authToken) {
//            AXApiResponse createdInboundHeaderResponse =
//                    inboundTransactionService.updateInboundHeaderWithIbLinePartialConfirmV2(inboundLineList, companyCode, plantId, languageId, warehouseId, preInboundNo, refDocNumber, loginUserID, authToken);
//            return new ResponseEntity<>(createdInboundHeaderResponse, HttpStatus.OK);
//        }
//
...
//                    inboundTransactionService.updateInboundHeaderV2(companyCode, plantId, languageId, warehouseId, refDocNumber, preInboundNo, loginUserID, updateInboundHeader, authToken);
...
//                                                       @RequestParam String languageId, @RequestParam String warehouseId,
//                                                       @RequestParam String preInboundNo, @RequestParam String loginUserID, @RequestParam String authToken) {
//            inboundTransactionService.deleteInboundHeaderV2(companyCode, plantId, languageId, warehouseId, refDocNumber, preInboundNo, loginUserID, authToken);
//            return new ResponseEntity<>(HttpStatus.NO_CONTENT);
//        }
//
//        /*
...
//            InboundLineV2[] lineNoList = inboundTransactionService.getInboundLinesV2(authToken);
...
//                    inboundTransactionService.getInboundLineV2(companyCode, plantId, languageId, warehouseId, refDocNumber, preInboundNo, lineNo, itemCode, authToken);
...
//                                                 @RequestParam String authToken) throws Exception {
//            return inboundTransactionService.findInboundLineV2(searchInboundLine, authToken);
//        }
//
...
//                                                   @RequestParam String authToken) throws IllegalAccessException, InvocationTargetException {
//            InboundLineV2 createdInboundLine = inboundTransactionService.createInboundLineV2(newInboundLine, loginUserID, authToken);
...
//                    inboundTransactionService.updateInboundLineV2(companyCode, plantId, languageId, warehouseId, refDocNumber,
...
//            InboundLineV2[] updatedInboundLines = inboundTransactionService.batchUpdateInboundLineV2(updateInboundLines, loginUserID, authToken);
...
//                                                     @RequestParam String loginUserID, @RequestParam String authToken) {
//            inboundTransactionService.deleteInboundLineV2(companyCode, plantId, languageId, warehouseId, refDocNumber, preInboundNo, lineNo, itemCode, loginUserID, authToken);
//            return new ResponseEntity<>(HttpStatus.NO_CONTENT);
//        }
//
//
...
//            StagingHeaderV2 stagingheader = inboundTransactionService.getStagingHeaderV2(companyCode, plantId, languageId, warehouseId,
...
//                throws Exception {
//            return inboundTransactionService.findStagingHeaderV2(searchStagingHeader, authToken);
//        }
//
//        //Create
...
//                                                     @RequestParam String loginUserID, @RequestParam String authToken)
//                throws IllegalAccessException, InvocationTargetException {
//            StagingHeaderV2 createdStagingHeader = inboundTransactionService.createStagingHeaderV2(newStagingHeader, loginUserID, authToken);
...
//                    inboundTransactionService.updateStagingHeaderV2(companyCode, plantId, languageId, warehouseId,
...
//                                                       @RequestParam String authToken) {
//            inboundTransactionService.deleteStagingHeaderV2(companyCode, plantId, languageId, warehouseId,
...
//                    inboundTransactionService.getStagingLineV2(companyCode, plantId, languageId, warehouseId,
...
//                                                       @RequestParam String authToken) throws Exception {
//            return inboundTransactionService.findStagingLineV2(searchStagingLine, authToken);
//        }
//        //Find
//        @ApiOperation(response = StagingLineEntityV2.class, value = "Search StagingLine V2") // label for swagger
//        @PostMapping("/stagingline/findStagingLine/v2/Report")
//        public StagingLineEntityV2[] findStagingLineV2Report(@RequestBody SearchStagingLineV2 searchStagingLine,
//                                                             @RequestParam String authToken) throws Exception {
//            return inboundTransactionService.findStagingLineV2Report(searchStagingLine, authToken);
//        }
//
//        //Find
//        @ApiOperation(response = StagingLineEntityV2.class, value = "Search StagingLine V2") // label for swagger
//        @PostMapping("/stagingline/findStagingLine/mobApp")
//        public GroupedStagingLineResponse[] findStagingLineMobApp(@RequestBody SearchStagingLineV2 searchStagingLine,
//                                                                  @RequestParam String authToken) throws Exception {
//            return inboundTransactionService.findStagingLineMobApp(searchStagingLine, authToken);
//        }
//
//        //Find
//        @ApiOperation(response = StagingLineEntityV2.class, value = "Search StagingLine V2") // label for swagger
//        @PostMapping("/stagingline/findStagingLine/mobApp/vehicleCount")
//        public GroupedStagingLineResponse[] findStagingLineMobAppVehicleCount(@RequestBody SearchStagingLineV2 searchStagingLine,
//                                                                              @RequestParam String authToken) throws Exception {
//            log.info("SearchSeagingLine Input ----> {}", searchStagingLine);
//            return inboundTransactionService.findStagingLineMobAppVehicle(searchStagingLine, authToken);
//        }
//
//        //Create
...
//                    inboundTransactionService.createStagingLineV2(newStagingLine, warehouseId, companyCodeId, plantId, languageId, loginUserID, authToken);
...
//                    inboundTransactionService.updateStagingLineV2(companyCode, plantId, languageId, warehouseId,
...
//                throws IllegalAccessException, InvocationTargetException {
//            StagingLineEntityV2[] createdStagingLine =
//                    inboundTransactionService.caseConfirmationV2(companyCode, plantId, languageId, caseConfirmations, caseCode, loginUserID, authToken);
//            return new ResponseEntity<>(createdStagingLine, HttpStatus.OK);
//        }
//
//        //Delete
...
//                                                   @RequestParam String caseCode, @RequestParam String preInboundNo,
//                                                   @RequestParam String itemCode, @RequestParam String loginUserID, @RequestParam String authToken) {
//            inboundTransactionService.deleteStagingLineV2(companyCode, plantId, languageId, warehouseId,
...
//                                               @RequestParam String loginUserID, @RequestParam String authToken) {
//            inboundTransactionService.deleteCasesV2(preInboundNo, lineNo, itemCode, caseCode, loginUserID, authToken);
//            return new ResponseEntity<>(HttpStatus.NO_CONTENT);
//        }
//
//        //AssignHHT
...
//            StagingLineEntityV2[] updatedStagingLine =
//                    inboundTransactionService.assignHHTUserV2(companyCode, plantId, languageId, assignHHTUsers, assignedUserId, loginUserID, authToken);
//            return new ResponseEntity<>(updatedStagingLine, HttpStatus.OK);
//        }
//
...
//            StagingLineEntityV2[] createdStagingLine =
//                    inboundTransactionService.updateStagingLinev2(stagingLine, loginUserID, authToken);
//            return new ResponseEntity<>(createdStagingLine, HttpStatus.OK);
//        }
//
//        @ApiOperation(response = StagingLineEntityV2[].class, value = "Update vehicle no ") // label for swagger
//        @PatchMapping("/stagingLine/update/vehicleNo")
//        public ResponseEntity<?> stagingLineUpdate(@Valid @RequestBody StagingLineEntityV2[] stagingLine, @RequestParam String loginUserID, @RequestParam String authToken) {
//            StagingLineEntityV2[] createdStagingLine =
//                    inboundTransactionService.updateVehicleNo(stagingLine, loginUserID, authToken);
//            return new ResponseEntity<>(createdStagingLine, HttpStatus.OK);
//        }
//
//
...
//                    inboundTransactionService.getGrHeaderV2(companyCode, plantId, languageId, warehouseId,
...
//                throws Exception {
//            return inboundTransactionService.findGrHeaderV2(searchGrHeader, authToken);
//        }
//
//        //Create
...
//                                                @RequestParam String authToken) throws IllegalAccessException, InvocationTargetException {
//            GrHeaderV2 createdGrHeader = inboundTransactionService.createGrHeaderV2(newGrHeader, loginUserID, authToken);
...
//                    inboundTransactionService.updateGrHeaderV2(companyCode, plantId, languageId, warehouseId,
...
//                                                  @RequestParam String authToken) {
//            inboundTransactionService.deleteGrHeaderV2(companyCode, plantId, languageId, warehouseId,
//                    preInboundNo, refDocNumber, stagingNo, goodsReceiptNo,
...
//                                             @RequestParam String itemCode, @RequestParam String authToken) throws java.text.ParseException {
//            GrLineV2 dbGrLine =
//                    inboundTransactionService.getGrLineV2(companyCode, plantId, languageId, warehouseId,
...
//                                             @RequestParam String authToken) throws java.text.ParseException {
//            GrLineV2[] grline = inboundTransactionService.getGrLineV2(companyCode, plantId, languageId, preInboundNo, refDocNumber, packBarcodes, lineNo, itemCode, authToken);
...
//                throws Exception {
//            return inboundTransactionService.findGrLineV2(searchGrLine, authToken);
//        }
//
//        //Find
...
//                throws Exception {
//            return inboundTransactionService.findGrLineSQLV2(searchGrLine, authToken);
//        }
//
//        //Create
...
//                                              @RequestParam String authToken) throws IllegalAccessException, InvocationTargetException {
//            GrLineV2[] createdGrLine = inboundTransactionService.createGrLineV2(newGrLine, loginUserID, authToken);
...
//                    inboundTransactionService.updateGrLineV2(companyCode, plantId, languageId, warehouseId,
//                            preInboundNo, refDocNumber, goodsReceiptNo, palletCode, caseCode,
...
//                                                @RequestParam String loginUserID, @RequestParam String authToken) {
//            inboundTransactionService.deleteGrLineV2(companyCode, plantId, languageId, warehouseId,
...
//                                                  @RequestParam String loginUserID, @RequestParam String authToken) {
//            PackBarcode[] packBarcodes =
//                    inboundTransactionService.generatePackBarcodeV2(companyCodeId, plantId, languageId, acceptQty,
...
//                    inboundTransactionService.generateBatchSerialNumber(companyCodeId, plantId, languageId, warehouseId, storageMethod, authToken);
...
//            PutAwayHeaderV2 dbPutAwayHeader = inboundTransactionService.getPutAwayHeaderV2(companyCode, plantId, languageId, warehouseId,
...
//            PutAwayHeaderV2[] putawayheader = inboundTransactionService.getPutAwayHeaderV2(companyCode, plantId, languageId, refDocNumber, authToken);
//            log.info("PutAwayHeader : " + putawayheader);
//            return new ResponseEntity<>(putawayheader, HttpStatus.OK);
//        }
//
...
//                throws Exception {
//            return inboundTransactionService.findPutAwayHeaderV2(searchPutAwayHeader, authToken);
//        }
//
//        //Create
...
//                                                     @RequestParam String authToken) throws IllegalAccessException, InvocationTargetException {
//            PutAwayHeaderV2 createdPutAwayHeader = inboundTransactionService.createPutAwayHeaderV2(newPutAwayHeader, loginUserID, authToken);
//            return new ResponseEntity<>(createdPutAwayHeader, HttpStatus.OK);
//        }
//
//        //Upadte
...
//                    inboundTransactionService.updatePutAwayHeaderV2(companyCode, plantId, languageId, warehouseId, preInboundNo,
...
//                                                      @RequestParam String loginUserID, @RequestParam String authToken)
//                throws IllegalAccessException, InvocationTargetException {
//            inboundTransactionService.updatePutAwayHeaderV2(companyCode, plantId, languageId, warehouseId, refDocNumber, packBarcodes, loginUserID, authToken);
//            return new ResponseEntity<>(HttpStatus.OK);
//        }
//
//        //Update
...
//                                                              @RequestParam String loginUserID, @RequestParam String authToken) {
//            inboundTransactionService.batchPutAwayHeaderReversalV2(inboundReversalInput, loginUserID, authToken);
//            return new ResponseEntity<>(HttpStatus.OK);
//        }
//
//        //Delete
...
//            inboundTransactionService.deletePutAwayHeaderV2(companyCode, plantId, languageId, warehouseId,
//                    preInboundNo, refDocNumber, goodsReceiptNo, palletCode, caseCode, packBarcodes, putAwayNumber,
//                    proposedStorageBin, loginUserID, authToken);
//            return new ResponseEntity<>(HttpStatus.NO_CONTENT);
//        }
//
//        //Create Putaway header
//        @ApiOperation(response = PutAwayHeaderV2[].class, value = "Create PutAwayHeader from SAP") // label for swagger
...
//            PutAwayHeaderV2[] createdPutAwayHeader = inboundTransactionService.createPutAwayHeaderV3(putawayHeaders, authToken);
//            return new ResponseEntity<>(createdPutAwayHeader, HttpStatus.OK);
//        }
//
//
...
//                                                  @RequestParam String proposedStorageBin, @RequestParam String authToken) throws java.text.ParseException {
//            PutAwayLineV2 dbPutAwayLine = inboundTransactionService.getPutAwayLineV2(companyCode, plantId, languageId, warehouseId,
...
//                                                                @RequestParam String plantId, @RequestParam String languageId, @RequestParam String authToken) throws java.text.ParseException {
//            PutAwayLineV2[] putawayline = inboundTransactionService.getPutAwayLineV2(companyCode, plantId, languageId, refDocNumber, authToken);
//            log.info("PutAwayLine : " + putawayline);
//            return new ResponseEntity<>(putawayline, HttpStatus.OK);
//        }
//
...
//                                                 @RequestParam String authToken) throws Exception {
//            return inboundTransactionService.findPutAwayLineV2(searchPutAwayLine, authToken);
//        }
//
//        //Find
//        @ApiOperation(response = PutAwayLineV2.class, value = "Search PutAwayLine V2") // label for swagger
//        @PostMapping("/putawayline/findPutAwayLine/distribution/report")
//        public PutawayUserGroup[] findPutawayLineDistribution(@RequestBody SearchPutAwayLineV2 searchPutAwayLine,
//                                                              @RequestParam String authToken) throws Exception {
//            return inboundTransactionService.findPutawayLineDistribution(searchPutAwayLine, authToken);
//        }
//
//        //Find
//        @ApiOperation(response = PutAwayLineV2.class, value = "Search PutAwayLine V3") // label for swagger
//        @PostMapping("/putawayline/findPutAwayLine/v3")
//        public PutAwayLineV2[] findPutAwayLineV3(@RequestBody SearchPutAwayLineV2 searchPutAwayLine,
//                                                 @RequestParam String authToken) throws Exception {
//            return inboundTransactionService.findPutAwayLineV3(searchPutAwayLine, authToken);
//        }
//
////    //Find
////    @ApiOperation(response = PutAwayLineV2.class, value = "Search PutAwayLine V2") // label for swagger
////    @PostMapping("/putawayline/findPutAwayLine/MobApp")
////    public PutAwayPalletGroupResponse[] findPutAwayLineMobApp(@RequestBody SearchPutAwayLineV2 searchPutAwayLine,
////                                             @RequestParam String authToken) throws Exception {
////        return inboundTransactionService.findPutAwayLineMobApp(searchPutAwayLine, authToken);
////    }
//
//        //Find
//        @ApiOperation(response = PutAwayLineV2.class, value = "Search PutAwayHeader V2") // label for swagger
//        @PostMapping("/putawayline/findPutAwayLine/MobApp")
//        public PutAwayPalletGroupResponse[] findPutAwayHeaderMobApp(@RequestBody SearchPutAwayHeaderV2 searchPutAwayLine,
//                                                                    @RequestParam String authToken) throws Exception {
//            return inboundTransactionService.findPutAwayHeaderMobApp(searchPutAwayLine, authToken);
//        }
//
//        //Create
...
//                                                   @RequestParam String authToken) throws IllegalAccessException, InvocationTargetException {
//            PutAwayLineV2[] createdPutAwayLine = inboundTransactionService.createPutAwayLineV2(newPutAwayLine, loginUserID, authToken);
//            return new ResponseEntity<>(createdPutAwayLine, HttpStatus.OK);
//        }
//
//        //Create
...
//                                                   @RequestParam String authToken) throws IllegalAccessException, InvocationTargetException {
//            PutAwayLineV2[] createdPutAwayLine = inboundTransactionService.createPutAwayLineV3(newPutAwayLine, loginUserID, authToken);
//            return new ResponseEntity<>(createdPutAwayLine, HttpStatus.OK);
//        }
//
//        //Update
...
//                    inboundTransactionService.updatePutAwayLineV2(companyCode, plantId, languageId, warehouseId,
//                            goodsReceiptNo, preInboundNo, refDocNumber, putAwayNumber, lineNo, itemCode,
//                            proposedStorageBin, confirmedStorageBin, updatePutAwayLine, loginUserID, authToken);
//            return new ResponseEntity<>(updatedPutAwayLine, HttpStatus.OK);
//        }
...
//                                                     @RequestParam String loginUserID, @RequestParam String authToken) {
//            inboundTransactionService.deletePutAwayLineV2(companyCode, plantId, languageId, warehouseId,
...
//                                             @RequestParam String authToken) throws Exception {
//            return inboundTransactionService.findInventoryV2(searchInventory, authToken);
//        }
//
...
//            return inboundTransactionService.findInventoryV3(searchInventory, authToken);
//        }
//
...
//                                                 @RequestParam String authToken) throws IllegalAccessException, InvocationTargetException {
//            InventoryV2 createdInventory = inboundTransactionService.createInventoryV2(newInventory, loginUserID, authToken);
//            return new ResponseEntity<>(createdInventory, HttpStatus.OK);
//        }
//
...
//                    inboundTransactionService.updateInventoryV2(companyCodeId, plantId, languageId, warehouseId, packBarcodes, itemCode,
...
//            inboundTransactionService.deleteInventoryV2(companyCodeId, plantId, languageId, warehouseId, manufacturerName,
...
//                throws IllegalAccessException, InvocationTargetException {
//            WarehouseApiResponse createdSO = inboundTransactionService.postASNV2(asnv2, authToken);
//            return new ResponseEntity<>(createdSO, HttpStatus.OK);
//        }
//
...
//                throws IllegalAccessException, InvocationTargetException {
//            WarehouseApiResponse createdStockReceipt = inboundTransactionService.postStockReceipt(stockReceipt, authToken);
...
//                throws IllegalAccessException, InvocationTargetException {
//            WarehouseApiResponse createdSO = inboundTransactionService.postSOReturnV2(saleOrderReturnV2, authToken);
//            return new ResponseEntity<>(createdSO, HttpStatus.OK);
//        }
//
//        // B2b Transfer IN
...
//                throws IllegalAccessException, InvocationTargetException {
//            WarehouseApiResponse createdSO = inboundTransactionService.postB2bTransferIn(b2bTransferIn, authToken);
//            return new ResponseEntity<>(createdSO, HttpStatus.OK);
//        }
//
//        // B2b Transfer IN
...
//                throws IllegalAccessException, InvocationTargetException {
//            WarehouseApiResponse createdSO = inboundTransactionService.postInterWarehouseTransferInV2(interWarehouseTransferInV2, authToken);
//            return new ResponseEntity<>(createdSO, HttpStatus.OK);
//        }
//
//        //====================================================InhouseTransferHeader============================================
...
//            DeliveryHeader[] deliveryHeaders = inboundTransactionService.getAllDeliveryHeader(authToken);
...
//                    = inboundTransactionService.getDeliveryHeader(warehouseId, deliveryNo, companyCodeId, languageId, plantId, authToken);
//
...
//                    = inboundTransactionService.createDeliveryHeader(addDeliveryHeader, loginUserID, authToken);
...
//                throws IllegalAccessException, InvocationTargetException {
//
//            DeliveryHeader dbDeliveryHeader = inboundTransactionService.updateDeliveryHeader(warehouseId, deliveryNo, companyCodeId,
...
//                                               @RequestParam String authToken) {
//
//            inboundTransactionService.deleteDeliveryHeader(warehouseId, deliveryNo, companyCodeId,
...
//                                                   @RequestParam String authToken) throws Exception {
//            return inboundTransactionService.findDeliveryHeader(searchDeliveryHeader, authToken);
//        }
//
//
//        /*
...
//            DeliveryLine[] deliveryLines = inboundTransactionService.getAllDeliveryLine(authToken);
...
//                throws IllegalAccessException, InvocationTargetException {
//
//            DeliveryLine[] createDeliveryLine = inboundTransactionService.createDeliveryLine(addDeliveryLine, loginUserID, authToken);
...
//                                            @RequestParam String warehouseId, @RequestParam String authToken) {
//
//            DeliveryLine dbDeliveryLine = inboundTransactionService.getDeliveryLine(warehouseId, deliveryNo, itemCode, lineNumber,
...
//                throws IllegalAccessException, InvocationTargetException {
//
//            DeliveryLine[] dbDeliveryLine = inboundTransactionService.updateDeliveryLine(loginUserID, updateDeliveryLine, authToken);
//            return new ResponseEntity<>(dbDeliveryLine, HttpStatus.OK);
//        }
//
//        // DELETE
...
//                                                    @RequestParam String authToken) {
//
//            inboundTransactionService.deleteDeliveryLine(warehouseId, deliveryNo, itemCode, lineNumber, refDocNumber, invoiceNumber,
...
//                                               @RequestParam String authToken) throws Exception {
//            return inboundTransactionService.findDeliveryLine(searchDeliveryLine, authToken);
//        }
//
//        // GET
...
//
//            DeliveryLineCount dbDeliveryLine = inboundTransactionService.getDeliveryLineCount(companyCodeId, plantId, languageId, warehouseId, driverId, authToken);
//            return new ResponseEntity<>(dbDeliveryLine, HttpStatus.OK);
//        }
//
//        //FIND
...
//                                                       @RequestParam String authToken) throws Exception {
//            return inboundTransactionService.findDeliveryLineCount(findDeliveryLineCount, authToken);
//        }
//
//        /*-----------------------------CycleCountOrder------------------------------------------------*/
//
...
//                throws IllegalAccessException, InvocationTargetException {
//            WarehouseApiResponse createdPerpetual = inboundTransactionService.postPerpetual(perpetual, authToken);
...
//                throws IllegalAccessException, InvocationTargetException {
//            WarehouseApiResponse createdPeriodic = inboundTransactionService.postPeriodic(periodic, authToken);
...
//                                                                 @RequestParam String authToken) throws Exception {
//            return inboundTransactionService.findDeliveryConfirmation(searchDeliveryConfirmation, authToken);
//        }
//
//
//        /*
...
//            PerpetualHeaderEntityV2[] perpetualheaderList = inboundTransactionService.getPerpetualHeadersV2(authToken);
//            return new ResponseEntity<>(perpetualheaderList, HttpStatus.OK);
//        }
//
...
//                    inboundTransactionService.getPerpetualHeaderV2(companyCodeId, plantId, languageId, warehouseId, cycleCountTypeId, cycleCountNo,
//                            movementTypeId, subMovementTypeId, authToken);
//            log.info("PerpetualHeader : " + perpetualheader);
//            return new ResponseEntity<>(perpetualheader, HttpStatus.OK);
//        }
...
////                                                     @RequestParam String authToken) throws Exception {
////        return inboundTransactionService.findPerpetualHeaderV2(searchPerpetualHeader, authToken);
////    }
...
//                                                            @RequestParam String authToken) throws Exception {
//            return inboundTransactionService.findPerpetualHeaderEntityV2(searchPerpetualHeader, authToken);
//        }
//
...
//            WarehouseApiResponse createdPerpetualHeader = inboundTransactionService.postPerpetualHeaderV2(newPerpetualHeader, authToken);
//            return new ResponseEntity<>(createdPerpetualHeader, HttpStatus.OK);
//        }
//
//        /*
...
//                    inboundTransactionService.runPerpetualHeaderV2(runPerpetualHeader, authToken);
//            return new ResponseEntity<>(perpetualLineEntity, HttpStatus.OK);
//        }
//
...
//                                                                @RequestParam String authToken) throws IllegalAccessException, InvocationTargetException {
//            PerpetualLineV2[] perpetualLineEntity =
//                    inboundTransactionService.runPerpetualHeaderNewV2(runPerpetualHeader, authToken);
//            return new ResponseEntity<>(perpetualLineEntity, HttpStatus.OK);
//        }
//
...
//                    inboundTransactionService.updatePerpetualHeaderV2(companyCodeId, plantId, languageId, warehouseId, cycleCountTypeId, cycleCountNo, movementTypeId,
//                            subMovementTypeId, loginUserID, updatePerpetualHeader, authToken);
//            return new ResponseEntity<>(createdPerpetualHeader, HttpStatus.OK);
//        }
//
...
//                                                         @RequestParam String warehouseId, @RequestParam Long cycleCountTypeId, @RequestParam Long movementTypeId, @RequestParam Long subMovementTypeId,
//                                                         @RequestParam String loginUserID, @RequestParam String authToken) {
//            inboundTransactionService.deletePerpetualHeaderV2(companyCodeId, plantId, languageId, warehouseId, cycleCountTypeId, cycleCountNo, movementTypeId,
//                    subMovementTypeId, loginUserID, authToken);
//            return new ResponseEntity<>(HttpStatus.NO_CONTENT);
//        }
//
...
//                                                     @RequestParam String authToken) throws Exception {
//            return inboundTransactionService.findPerpetualLineV2(searchPerpetualLine, authToken);
//        }
//
...
//                                                      @RequestParam String loginUserID, @RequestParam String authToken)
//                throws IllegalAccessException, InvocationTargetException {
//            PerpetualLineV2[] createdPerpetualLine = inboundTransactionService.updateAssingHHTUserV2(assignHHTUser, loginUserID, authToken);
//            return new ResponseEntity<>(createdPerpetualLine, HttpStatus.OK);
//        }
//
...
//                    inboundTransactionService.updatePerpetualLineV2(cycleCountNo, updatePerpetualLine, loginUserID, authToken);
//            return new ResponseEntity<>(createdPerpetualLine, HttpStatus.OK);
//        }
//
...
//                    inboundTransactionService.updatePerpetualLineConfirmV2(cycleCountNo, updatePerpetualLine, loginUserID, authToken);
//            return new ResponseEntity<>(createdPerpetualLine, HttpStatus.OK);
//        }
//
...
//                    inboundTransactionService.updatePerpetualZeroStkLine(updatePerpetualLine, loginUserID, authToken);
//            return new ResponseEntity<>(createdPerpetualLine, HttpStatus.OK);
//        }
//
...
//                    inboundTransactionService.updatePeriodicZeroStkLine(updatePeriodicLine, loginUserID, authToken);
//            return new ResponseEntity<>(createdPeriodicLine, HttpStatus.OK);
//        }
//
//        /*
...
//            PeriodicHeaderEntity[] PeriodicheaderList = inboundTransactionService.getPeriodicHeadersV2(authToken);
//            return new ResponseEntity<>(PeriodicheaderList, HttpStatus.OK);
//        }
//
...
//                    inboundTransactionService.getPeriodicHeaderV2(warehouseId, companyCode, plantId, languageId, cycleCountTypeId, cycleCountNo, authToken);
//            return new ResponseEntity<>(Periodicheader, HttpStatus.OK);
//        }
//
...
////                                                   @RequestParam String authToken) throws Exception {
////        return inboundTransactionService.findPeriodicHeaderV2(searchPeriodicHeader, authToken);
////    }
//
...
////                                                               @RequestParam String authToken) throws Exception {
////        return inboundTransactionService.findPeriodicHeaderEntityV2(searchPeriodicHeader, authToken);
////    }
//
//        //Stream
...
//                                                         @RequestParam String authToken) throws Exception {
//            PeriodicHeaderV2[] results = inboundTransactionService.findPeriodicHeaderStreamV2(searchPeriodicHeader, authToken);
//            return new ResponseEntity<>(results, HttpStatus.OK);
//        }
//
...
//            WarehouseApiResponse createdPeriodicHeader = inboundTransactionService.postPeriodicHeaderV2(newPeriodicHeader, authToken);
//            log.info("createdPeriodicHeader:" + createdPeriodicHeader);
//            return new ResponseEntity<>(createdPeriodicHeader, HttpStatus.OK);
//        }
//
...
//                    inboundTransactionService.updatePeriodicHeaderV2(companyCode, plantId, languageId, warehouseId, cycleCountTypeId, cycleCountNo,
//                            loginUserID, updatePeriodicHeader, authToken);
//            return new ResponseEntity<>(createdPeriodicHeader, HttpStatus.OK);
//        }
//
...
//                                                        @RequestParam String plantId, @RequestParam String languageId,
//                                                        @RequestParam Long cycleCountTypeId, @RequestParam String loginUserID, @RequestParam String authToken) {
//            inboundTransactionService.deletePeriodicHeaderV2(companyCode, plantId, languageId, warehouseId, cycleCountTypeId, cycleCountNo, loginUserID, authToken);
//            return new ResponseEntity<>(HttpStatus.NO_CONTENT);
//        }
//
//        //-------------------------------PeriodicLine---------------------------------------------------------------------
...
//                                                   @RequestParam String authToken) throws Exception {
//            return inboundTransactionService.findPeriodicLineV2(searchPeriodicLine, authToken);
//        }
//
...
//                throws IllegalAccessException, InvocationTargetException {
//            PeriodicLineV2[] createdPeriodicLine =
//                    inboundTransactionService.updatePeriodicLineAssingHHTUserV2(assignHHTUser, loginUserID, authToken);
//            return new ResponseEntity<>(createdPeriodicLine, HttpStatus.OK);
//        }
//
...
//                    inboundTransactionService.updatePeriodicLineV2(cycleCountNo, updatePeriodicLine, loginUserID, authToken);
//            return new ResponseEntity<>(updatedPeriodicLine, HttpStatus.OK);
//        }
//
...
//                    inboundTransactionService.updatePeriodicLineConfirmV2(cycleCountNo, updatePerpetualLine, loginUserID, authToken);
...
//                    inboundTransactionService.getStockAdjustment(companyCode, plantId, languageId, warehouseId, stockAdjustmentKey,
...
//                                                     @RequestParam String authToken) throws Exception {
//            return inboundTransactionService.findStockAdjustment(searchInventory, authToken);
//        }
//
...
//                    inboundTransactionService.updateStockAdjustment(companyCode, plantId, languageId, warehouseId, stockAdjustmentKey, itemCode,
...
//                                                       @RequestParam String manufacturerName, @RequestParam String storageBin,
//                                                       @RequestParam String loginUserID, @RequestParam String authToken) {
//            inboundTransactionService.deleteStockAdjustment(companyCode, plantId, languageId, warehouseId, stockAdjustmentKey, itemCode, manufacturerName, storageBin, loginUserID, authToken);
//            return new ResponseEntity<>(HttpStatus.NO_CONTENT);
//        }
//
...
//            WarehouseApiResponse createdStockAdjustment = inboundTransactionService.createStockAdjustmentV2(newStockAdjustment, authToken);
...
//                                                          @RequestParam String loginUserID, @RequestParam String authToken) throws IllegalAccessException, InvocationTargetException {
//
//            WarehouseApiResponse result = inboundTransactionService.replaceInvoice(companyCode, plantId, languageId, warehouseId, newInvoiceNumber, oldInvoiceNumber,
...
//                                                    @RequestParam String loginUserID, @RequestParam String authToken) {
//
//            PreInboundHeaderV2 result = inboundTransactionService.inboundOrderCancellation(inboundOrderCancelInput, loginUserID, authToken);
//            return new ResponseEntity<>(result, HttpStatus.OK);
//        }
//
...
//            ExceptionLog[] exceptionLogs = inboundTransactionService.getAllExceptionLogs(authToken);
...
//                                                    @RequestParam String authToken) {
//            InboundOrderV2[] inboundOrderV2 = inboundTransactionService.findInboundOrderV2(findInboundOrderV2, authToken);
...
//                                                        @RequestParam String authToken) {
//            InboundOrderLinesV2[] inboundOrderLinesV2 = inboundTransactionService.findInboundOrderLinesV2(findInboundOrderLineV2, authToken);
...
//                                                                 @RequestParam String authToken) throws Exception {
//            return inboundTransactionService.findSupplierInvoiceHeader(searchSupplierInvoiceHeader, authToken);
//        }
//
...
//                                                                     @RequestParam String authToken) throws Exception {
//            return inboundTransactionService.binningProductivityReport(searchBinningProductivityReport, authToken);
//        }
//
//        //Find
...
//                                                                @RequestParam String authToken) throws Exception {
//            return inboundTransactionService.getStorageBinDashBoard(storageBinDashBoardInput, authToken);
//        }
//
//        //PutAway - Report
...
//                                          @RequestParam String authToken) throws Exception {
//            return inboundTransactionService.putAwayReport(findReport, authToken);
//        }
//
...
//        }
//
////    =============================================Walkaroo-Inbound Order List API======================================
//
//        // Inbound Orders - List
//        @ApiOperation(response = ASNV2[].class, value = "List Inbound Order") // label for swagger
//        @PostMapping("/warehouse/inbound/asn/list/v3")
//        public ResponseEntity<?> postASNList(@Valid @RequestBody List<ASNV2> asnv2, @RequestParam String authToken)
//                throws IllegalAccessException, InvocationTargetException {
//            WarehouseApiResponse[] createdSO = inboundTransactionService.postASNV3(asnv2, authToken);
//            return new ResponseEntity<>(createdSO, HttpStatus.OK);
//        }
//
//        @ApiOperation(response = ASNV2[].class, value = "List Inbound Order") // label for swagger
//        @PostMapping("/warehouse/inbound/asn/listData/v3")
//        public ResponseEntity<?> postASNList1(@RequestParam String companyCodeId, @RequestParam String plantId,
//                                              @RequestParam String languageId, @RequestParam String warehouseId,
//                                              @RequestParam String loginUserID, @RequestParam Long inboundOrderTypeId,
//                                              @RequestBody List<AsnList> asnv2, @RequestParam String authToken)
//                throws IllegalAccessException, InvocationTargetException {
//            List<InboundOrderProcessV4> allRowsList = excelDataProcessService.inboundDataSet1(companyCodeId, plantId, languageId, warehouseId, inboundOrderTypeId, loginUserID, asnv2);
//            List<ASNV2> asnV2Orders = null;
//            if (inboundOrderTypeId == 1L) {
//                asnV2Orders = orderPreparationService.prepAsnMultipleDataV4(companyCodeId, plantId, languageId, warehouseId, loginUserID, allRowsList);
//            }
//            WarehouseApiResponse[] createdSO = inboundTransactionService.postASNV3(asnV2Orders, authToken);
//            return new ResponseEntity<>(createdSO, HttpStatus.OK);
//        }
//
//        @ApiOperation(response = ASNV2[].class, value = "List Inbound Order") // label for swagger
//        @PostMapping("/warehouse/inbound/asn/v3")
//        public ResponseEntity<?> postASNList2(@RequestBody List<AsnList> asnv2, @RequestParam String authToken)
//                throws IllegalAccessException, InvocationTargetException {
//            List<InboundOrderProcessV4> allRowsList = excelDataProcessService.inboundDataSet(asnv2);
//            List<ASNV2> asnV2Orders = orderPreparationService.prepAsnMultipleData(allRowsList);
//            WarehouseApiResponse[] createdSO = inboundTransactionService.postASNV3(asnV2Orders, authToken);
//            return new ResponseEntity<>(createdSO, HttpStatus.OK);
//        }
//
...
//        public ResponseEntity<?> postASNListTest(@RequestBody List<AsnList> asnv2, @RequestParam String authToken)
//                throws IllegalAccessException, InvocationTargetException {
//            List<InboundOrderProcessV4> allRowsList = excelDataProcessService.inboundDataSet(asnv2);
//            List<ASNV2> asnV2Orders = orderPreparationService.prepAsnMultipleData(allRowsList);
//            WarehouseApiResponse[] createdSO = inboundTransactionService.postASNV4(asnV2Orders, authToken);
//            return new ResponseEntity<>(createdSO, HttpStatus.OK);
//        }
//
//        /*
...
//            PalletIdAssignment palletIdAssignments = inboundTransactionService.getPalletIdAssignment(companyCodeId, plantId, languageId, warehouseId, pId, authToken);
...
//                                                   @RequestParam String languageId, @RequestParam String warehouseId, @RequestParam String authToken) {
//            PalletIdAssignment palletIdAssignmentV3 = inboundTransactionService.getPalletIdAssignmentV3(companyCodeId, plantId, languageId, warehouseId, palletId, authToken);
...
//                                                        @RequestParam String loginUserID, @RequestParam String authToken) throws Exception {
//            PalletIdAssignment[] createdPalletIdAssignment = inboundTransactionService.createPalletIdAssignment(companyCodeId, plantId, languageId, warehouseId, newPalletIdAssignment, loginUserID, authToken);
...
//                    inboundTransactionService.updatePalletIdAssignment(companyCodeId, plantId, languageId, warehouseId, updatepalletIdAssignmentList, loginUserID, authToken);
...
//                    inboundTransactionService.updatePalletIdStatus(companyCodeId, plantId, languageId, warehouseId, updatepalletIdStatus, loginUserID, authToken);
...
//                                                  @RequestParam String loginUserID, @RequestParam String authToken)
//                throws IllegalAccessException, InvocationTargetException {
//            inboundTransactionService.deletePalletIdAssignment(companyCodeId, plantId, languageId, warehouseId, pId, loginUserID, authToken);
//            return new ResponseEntity<>(HttpStatus.NO_CONTENT);
//        }
//
//        //Stream - JPA
...
//            return inboundTransactionService.findPalletIdAssignment(findPalletIdAssignment, authToken);
//        }
//
//
//        //SAP Initiate
...
//            WarehouseApiResponse created = inboundTransactionService.postData(input, authToken);
...
//            WarehouseApiResponse created = inboundTransactionService.createInventoryv3(excessConfirmations, loginUserID,authToken);
//            return new ResponseEntity<>(created, HttpStatus.OK);
//        }
//
//        //Sap Manual Process
//        @ApiOperation(response = WarehouseApiResponse.class, value = "Sap Manual Process") // label for swagger
//        @PostMapping("/sapManual/send")
//        public ResponseEntity<?> sapManualProcess(@RequestBody List<SAPData> sapData, @RequestParam String authToken) throws Exception {
//            WarehouseApiResponse created = inboundTransactionService.sapPush(sapData, authToken);
//            return new ResponseEntity<>(created, HttpStatus.OK);
//        }
//
//        @ApiOperation(response = GrReversalResponse.class, value = "Gr Reversal Updation")
//        @PostMapping("/gr/reversal")
//        public ResponseEntity<?> grReversalUpdate(@RequestBody List<PreInboundLineV2> preInboundLineEntityV2List, @RequestParam String loginUserID, @RequestParam String authToken) {
//            GrReversalResponse response = inboundTransactionService.grReversalUpdation(preInboundLineEntityV2List, loginUserID, authToken);
//            return new ResponseEntity<>(response, HttpStatus.OK);
//        }
//
//    }
