...
@Slf4j
@Validated
@Api(tags = {"SpecialStockIndicatorId"}, value = "SpecialStockIndicatorId  Operations related to SpecialStockIndicatorIdController")
// label for swagger
...
public class SpecialStockIndicatorIdController {
    ...
    @ApiOperation(response = SpecialStockIndicatorId.class, value = "Create SpecialStockIndicatorId")
    // label for swagger
    @PostMapping("")
