...
public class DataSourceConfig {
    ...
    public DynamicDataSource dataSource() {
        ...
        DataSource db1 = createDataSource("WK_MDU");
        DataSource db2 = createDataSource("WK_CMP");

        targetDataSources.put("WK",db);
        targetDataSources.put("WK_MDU",db1);
        targetDataSources.put("WK_CMP",db2);
    ...
    private DataSource createDataSource(String dbName) {
        ...
        switch (dbName) {
            ...
            case "WK_MDU":
                dataSource.setDriverClassName("com.microsoft.sqlserver.jdbc.SQLServerDriver");
                dataSource.setUrl("jdbc:sqlserver://10.10.14.24;databaseName=WK_MDU");
                dataSource.setUsername("sa");
                dataSource.setPassword("Sd2se5y3mPD9BLr3QzZMyNU1V");
                break;
            case "WK_CMP":
                dataSource.setDriverClassName("com.microsoft.sqlserver.jdbc.SQLServerDriver");
                dataSource.setUrl("jdbc:sqlserver://10.10.14.24;databaseName=WK_CMP");
                dataSource.setUsername("sa");
                dataSource.setPassword("Sd2se5y3mPD9BLr3QzZMyNU1V");
                break;
            default:
