...
public class IDMasterServiceController {
	...
	@ApiOperation(response = HhtUser.class, value = "Update HhtUser") // label for swagger
	@PostMapping("/hhtuser/update/list/v2")
	public ResponseEntity<?> patchHhtUser(@RequestParam String loginUserID, @RequestParam String authToken,
										  @Valid @RequestBody List<UpdateHhtUser> updateHhtUser) throws IllegalAccessException, InvocationTargetException {

		HhtUser[] updatedHhtUser = idmasterService.updateHhtUserList(updateHhtUser, loginUserID, authToken);
		return new ResponseEntity<>(updatedHhtUser, HttpStatus.OK);
	}
	...
	@ApiOperation(response = HhtUser.class, value = "Delete HhtUser") // label for swagger
	@PostMapping("/hhtuser/delete/list/v2")
	public ResponseEntity<?> deleteHhtUserV2(@RequestBody List<HhtUser> hhtUserList, @RequestParam String loginUserID, @RequestParam String authToken) {

		idmasterService.deleteHhtUserV2(hhtUserList, loginUserID, authToken);
		return new ResponseEntity<>(HttpStatus.NO_CONTENT);
	}
