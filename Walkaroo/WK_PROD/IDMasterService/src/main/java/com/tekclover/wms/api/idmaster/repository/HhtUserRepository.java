...
public interface HhtUserRepository extends JpaRepository<HhtUser, Long>, JpaSpecificationExecutor<HhtUser> {
    ...
    public Optional<HhtUser> findByUserIdAndUserNameAndWarehouseIdAndCompanyCodeIdAndPlantIdAndLanguageIdAndDeletionIndicator(
            String userId,String userName, String warehouseId, String companyCodeId, String plantId, String languageId, Long deletionIndicator);
...
//            String userId, String warehouseId, String companyCodeId, String plantId, String languageId, Long deletionIndicator);
    ...
    @Modifying
    @Query(value = "UPDATE tblhhtuser SET IS_DELETED = 1 WHERE c_id IN (:companyCodeId) AND lang_id IN (:languageId) AND plant_id IN (:plantId) and " +
            "usr_id IN (:userId) And wh_id IN (:warehouseId) AND IS_DELETED = 0", nativeQuery = true)
    void deleteHhtUserList(@Param(value = "userId") String userId,
