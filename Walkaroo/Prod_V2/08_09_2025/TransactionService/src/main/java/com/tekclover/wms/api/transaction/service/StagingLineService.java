...
//                }
    ...
    public List<StagingLineEntityV2> updateVehicleNo(List<StagingLineEntityV2> stagingLine, String loginUserID) {
        ...
        stagingLine.forEach(staging -> {
            ...
            if(stagingLine1 != null){
                ...
                stagingLine1.setUpdatedBy(loginUserID);
                stagingLine1.setUpdatedOn(new Date());
                String statusDescription = stagingLineV2Repository.getStatusDescription(13L, staging.getLanguageId());
                stagingLine1.setStatusDescription(statusDescription);
                StagingLineEntityV2 stagingLineEntityV2 = stagingLineV2Repository.save(stagingLine1);
