...
public class DeliveryLineController {
    ...
    public ResponseEntity<?> postDeliveryLine(@Valid @RequestBody List<AddDeliveryLine> newDeliveryLine,
        ...
        try {
            String currentDB = baseService.getDataBase(newDeliveryLine.get(0).getPlantId(),newDeliveryLine.get(0).getWarehouseId());
            DataBaseContextHolder.clear();
            DataBaseContextHolder.setCurrentDb(currentDB);
            log.info("Current DB " + currentDB);
    ...
    public ResponseEntity<?> patchDeliveryLine( @Valid @RequestBody List<UpdateDeliveryLine> updateDeliveryLine,
        ...
        try {
            String currentDB = baseService.getDataBase(updateDeliveryLine.get(0).getPlantId(),updateDeliveryLine.get(0).getWarehouseId());
            DataBaseContextHolder.clear();
            DataBaseContextHolder.setCurrentDb(currentDB);
            log.info("Current DB " + currentDB);
    ...
    public ResponseEntity<?> findDeliveryLine(@Valid @RequestBody SearchDeliveryLine searchDeliveryLine) throws Exception {
        try {
            String currentDB = baseService.getDataBase(searchDeliveryLine.getPlantId().get(0),searchDeliveryLine.getWarehouseId().get(0));
            DataBaseContextHolder.clear();
            DataBaseContextHolder.setCurrentDb(currentDB);
            log.info("Current DB " + currentDB);
    ...
    public ResponseEntity<?> findDeliveryLineCount(@Valid @RequestBody FindDeliveryLineCount findDeliveryLineCount) throws Exception {
        try {
            String currentDB = baseService.getDataBase(findDeliveryLineCount.getPlantId(),findDeliveryLineCount.getWarehouseId());
            DataBaseContextHolder.clear();
            DataBaseContextHolder.setCurrentDb(currentDB);
            log.info("Current DB " + currentDB);
