...
@EnableJpaRepositories(basePackages = "com.tekclover.wms.api.inbound.transaction",entityManagerFactoryRef = "entityManager", transactionManagerRef = "inboundTransactionManager")
public class DataSourceConfig {
    ...
    private DataSource mduDataSource() {
        return buildDataSource(
                "MDU",
                "jdbc:sqlserver://10.20.0.34;databaseName=WMS_WK_PRD",
                "sa",
    ...
    private DataSource chnDataSource() {
        return buildDataSource(
                "CHN",
                "jdbc:sqlserver://10.10.6.30;databaseName=WMS_CHN",
                "sa",
                "SuHcHQR72nxvyJx6EPpoOsK4V"
        );
    }
    ...
    private DataSource ngp1DataSource() {
        return buildDataSource(
                "NGP1",
                "jdbc:sqlserver://10.10.10.61;databaseName=WMS_NGP1",
                "sa",
                "4V7lOXaxgAi3i6mgJL7qBUSPM"
        );
    }

    private DataSource ngp2DataSource() {
        return buildDataSource(
                "NGP2",
    ...
    private DataSource knpDataSource() {
        return buildDataSource(
                "KNP",
...
//        config.setLeakDetectionThreshold(30000); //
    ...
    public LocalContainerEntityManagerFactoryBean entityManager() {
        ...
        emf.setPackagesToScan("com.tekclover.wms.api.inbound.transaction.model");
