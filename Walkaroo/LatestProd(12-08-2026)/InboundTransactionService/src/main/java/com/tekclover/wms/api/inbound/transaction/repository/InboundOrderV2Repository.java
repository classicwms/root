...
public interface InboundOrderV2Repository extends JpaRepository<InboundOrderV2, Long>,
    ...
    @Query(value = "select top 2 * from tbliborder2 where processed_status_id in (0,900) order by order_received_on ", nativeQuery = true)
...
//                                 @Param("warehouseId") String warehouseId);
    ...
    @Query(value =
            ...
            nativeQuery = true)
    Integer getObQueuedOrdersCount(
            @Param("companyCode") String companyCode,
            @Param("plantId") String plantId,
            @Param("warehouseId") String warehouseId);
    ...
    @Query(value =
            "SELECT COUNT(*) " +
                    ...
                    "AND order_received_on < DATEADD(DAY,1,CAST(GETDATE() AS DATE))",
            nativeQuery = true)
    Integer getObFailedOrdersCount(
            @Param("companyCode") String companyCode,
            @Param("plantId") String plantId,
            @Param("warehouseId") String warehouseId);
