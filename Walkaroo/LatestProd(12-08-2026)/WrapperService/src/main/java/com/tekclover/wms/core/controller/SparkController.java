...
//    //Find StagingLine
//    @ApiOperation(response = PreInboundLineV2New.class, value = "Spark Preinboundline details")
//    @PostMapping("/preinboundline/v2/new")
//    public ResponseEntity<?> findPreinboundlineV2(@RequestBody FindStagingLineV2 findStagingLineV2) throws Exception {
//        PreInboundLineV2New[] preInboundLineV2 = sparkService.findPreInboundLineV2(findStagingLineV2);
...
//    }
    ...
    //Find StagingLine
    @ApiOperation(response = UnLoadingDashBoardResponse.class, value = "Spark Find UnLoadingDashBoard")
    @PostMapping("/unloading/vehicle/dashboard")
    public ResponseEntity<?> findUnLoadingDashBoard(@RequestBody UnLoadingDashBoardRequest request) throws Exception {
        UnLoadingDashBoardResponse[] preInboundLineV2 = sparkService.findUnLoadinDashBoard(request);
        return new ResponseEntity<>(preInboundLineV2, HttpStatus.OK);
    }
        //Palletization DashBoard
    @ApiOperation(response = PalletizationDashBoardResponse.class, value = "Spark Find Palletization DashBoard")
    @PostMapping("/palletization/dashboard")
    public ResponseEntity<?> findUnLoadingPalletization(@RequestBody UnLoadingDashBoardRequest unLoadingDashBoardRequest) throws Exception {
        PalletizationDashBoardResponse[] palletization = sparkService.findUnLoadingPalletization(unLoadingDashBoardRequest);
        return new ResponseEntity<>(palletization, HttpStatus.OK);
    }

    //Palletization DashBoard
    @ApiOperation(response = PalletizationDashBoardResponseList.class, value = "Spark Find Palletization DashBoard")
    @PostMapping("/palletization/dashboard/list")
    public ResponseEntity<?> findUnLoadingPalletizationList(@RequestBody UnLoadingDashBoardRequest unLoadingDashBoardRequest) throws Exception {
        PalletizationDashBoardResponseList[] palletization = sparkService.findUnLoadingPalletizationList(unLoadingDashBoardRequest);
        return new ResponseEntity<>(palletization, HttpStatus.OK);
    }

    //PutAway DashBoard
    @ApiOperation(response = PutAwayDashBoardByTruckResponse.class, value = "Spark Find PutAway DashBoard by truck")
    @PostMapping("/putaway/vehicle/dashboard")
    public ResponseEntity<?> findPutAwayByTruck(@RequestBody UnLoadingDashBoardRequest unLoadingDashBoardRequest) throws Exception {
        PutAwayDashBoardByTruckResponse[] palletization = sparkService.findPutAwayByTruck(unLoadingDashBoardRequest);
        return new ResponseEntity<>(palletization, HttpStatus.OK);
    }

    //PutAway DashBoard
    @ApiOperation(response = PutAwayDashBoardByUserResponse.class, value = "Spark Find PutAway DashBoard by user")
    @PostMapping("/putaway/user/dashboard")
    public ResponseEntity<?> findPutAwayByUser(@RequestBody UnLoadingDashBoardRequest unLoadingDashBoardRequest) throws Exception {
        PutAwayDashBoardByUserResponse[] palletization = sparkService.findPutAwayByUser(unLoadingDashBoardRequest);
        return new ResponseEntity<>(palletization, HttpStatus.OK);
    }

    //PutAway DashBoard
    @ApiOperation(response = CapacityUtilizationByPlantResponse.class, value = "Spark Capacity Utilization By Plant")
    @PostMapping("/capacity/Utilization/by/plant")
    public ResponseEntity<?> capacityUtilizationByPlant(@RequestBody CapacityUtilizationByPlantRequest request) throws Exception {
        CapacityUtilizationByPlantResponse[] palletization = sparkService.capacityUtilizationByPlant(request);
        return new ResponseEntity<>(palletization, HttpStatus.OK);
    }


    //PutAway DashBoard List
    @ApiOperation(response = PutAwayDashBoardUserListRes.class, value = "Spark Find PutAway DashBoard by user List")
    @PostMapping("/putaway/user/dashboard/list")
    public ResponseEntity<?> findPutAwayByUsersList(@RequestBody UnLoadingDashBoardRequest unLoadingDashBoardRequest) throws Exception {
        PutAwayDashBoardUserListRes[] palletization = sparkService.findPutAwayByUsersList(unLoadingDashBoardRequest);
        return new ResponseEntity<>(palletization, HttpStatus.OK);
    }

    //Occupancy DashBoard
    @ApiOperation(response = OccupancyDashboardCountRes.class, value = "Spark Occupancy Dashboard By Plant")
    @PostMapping("occupancy/dashboard")
    public ResponseEntity<?> occupancyDashboardByPlant(@RequestBody CapacityUtilizationByPlantRequest request) throws Exception {
        OccupancyDashboardCountRes[] palletization = sparkService.occupancyDashboardByPlant(request);
        return new ResponseEntity<>(palletization, HttpStatus.OK);
    }

    //StagingLine TruckCount
    @ApiOperation(response = PalletizationDashBoardResponse.class, value = "Spark Find StagingLine TruckCount")
    @PostMapping("/staging/truckcount")
    public ResponseEntity<?> findVehicleCountStaging(@RequestBody UnLoadingDashBoardRequest unLoadingDashBoardRequest) throws Exception {
        VehicleCountDashboardRes[] palletization = sparkService.findVehicleCountStaging(unLoadingDashBoardRequest);
        return new ResponseEntity<>(palletization, HttpStatus.OK);
    }

    //PutAway TruckCount
    @ApiOperation(response = PalletizationDashBoardResponse.class, value = "Spark Find PutAway TruckCount")
    @PostMapping("/putaway/truckcount")
    public ResponseEntity<?> findVehicleCountPutAway(@RequestBody UnLoadingDashBoardRequest unLoadingDashBoardRequest) throws Exception {
        VehicleCountDashboardRes[] palletization = sparkService.findVehicleCountPutAway(unLoadingDashBoardRequest);
        return new ResponseEntity<>(palletization, HttpStatus.OK);
    }

    @ApiOperation(response = PickupDashBoardResponse.class, value = "Spark Find Pickup by Customer")
    @PostMapping("/pickup/customer/dashboard")
    public ResponseEntity<?> pickupDashBoardByCustomer(@RequestBody PickupDashBoardRequest request) throws Exception {
        PickupDashBoardResponse[] responses = sparkService.pickupDashBoardByCustomer(request);
        return new ResponseEntity<>(responses, HttpStatus.OK);
    }

    @ApiOperation(response = PickupDashBoardResponse.class, value = "Spark Find Pickup by Order")
    @PostMapping("/pickup/order/dashboard")
    public ResponseEntity<?> pickupDashBoardByOrder(@RequestBody PickupDashBoardRequest request) throws Exception {
        PickupDashBoardResponse[] responses = sparkService.pickupDashBoardByOrder(request);
        return new ResponseEntity<>(responses, HttpStatus.OK);
    }

    @ApiOperation(response = AgingDashBoardResponse.class, value = "Spark Find Aging Report")
    @PostMapping("/aging/dashboard")
    public ResponseEntity<?> agingDashBoard(@RequestBody AgingDashBoardRequest request) throws Exception {
        AgingDashBoardResponse[] responses = sparkService.agingDashBoard(request);
        return new ResponseEntity<>(responses, HttpStatus.OK);
    }

    @ApiOperation(response = InventoryByAgingResponse.class, value = "Spark Find Aging Report by key")
    @PostMapping("/aging/dashboard/by/item")
    public ResponseEntity<?> findInventoryByAging(@RequestBody InventoryByAgingRequest request) throws Exception {
        InventoryByAgingResponse[] responses = sparkService.findInventoryByAging(request);
        return new ResponseEntity<>(responses, HttpStatus.OK);
    }

    @ApiOperation(response = InventoryByAgingResponse.class, value = "Spark Find Aging Report")
    @PostMapping("/aging/dashboard/by/location")
    public ResponseEntity<?> findAllInventoryByAging(@RequestBody InventoryByAgingRequest request) throws Exception {
        InventoryByAgingResponse[] responses = sparkService.findAllInventoryByAging(request);
        return new ResponseEntity<>(responses, HttpStatus.OK);
    }

    @ApiOperation(response = AgingDashBoardByCategoryResponse.class, value = "Spark Find Aging Report By Category")
    @PostMapping("/aging/dashboard/by/category")
    public ResponseEntity<?> agingDashBoardByCategory(@RequestBody AgingDashBoardRequest request) throws Exception {
        AgingDashBoardByCategoryResponse[] responses = sparkService.agingDashBoardByCategory(request);
        return new ResponseEntity<>(responses, HttpStatus.OK);
    }

    @ApiOperation(response = AgingByCategoryResponse.class, value = "Spark Find Aging Report by item and category")
    @PostMapping("/aging/by/item/and/category")
    public ResponseEntity<?> findInventoryByAgingByCategory(@RequestBody AgingByCategoryRequest request) throws Exception {
        AgingByCategoryResponse[] responses = sparkService.findInventoryByAgingByCategory(request);
        return new ResponseEntity<>(responses, HttpStatus.OK);
    }

    @ApiOperation(response = AgingByCategoryResponse.class, value = "Spark Find Aging Report by location and category")
    @PostMapping("/aging/by/location/and/category")
    public ResponseEntity<?> findAllInventoryByAgingByCategory(@RequestBody AgingByCategoryRequest request) throws Exception {
        AgingByCategoryResponse[] responses = sparkService.findAllInventoryByAgingByCategory(request);
        return new ResponseEntity<>(responses, HttpStatus.OK);
    }
