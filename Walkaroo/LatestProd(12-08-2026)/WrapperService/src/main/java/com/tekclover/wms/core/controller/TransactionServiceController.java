...
public class TransactionServiceController {
    ...
    public ResponseEntity<?> getContainerReceipts(@RequestParam String authToken) throws Exception {
        ContainerReceipt[] containerReceiptNoList = inboundTransactionService.getContainerReceipts(authToken);
    ...
    public ResponseEntity<?> getContainerReceipt(@PathVariable String containerReceiptNo,
        ...
        ContainerReceipt containerreceipt =
                inboundTransactionService.getContainerReceipt(containerReceiptNo, authToken);
    ...
    public ContainerReceipt[] findContainerReceipt(@RequestBody SearchContainerReceipt searchContainerReceipt,
                                                   @RequestParam String authToken) throws Exception {
        return inboundTransactionService.findContainerReceipt(searchContainerReceipt, authToken);
    }
    ...
    public ContainerReceipt[] findContainerReceiptNew(@RequestBody SearchContainerReceipt searchContainerReceipt,
                                                      @RequestParam String authToken) throws Exception {
        return inboundTransactionService.findContainerReceiptNew(searchContainerReceipt, authToken);
    }
    ...
    public ResponseEntity<?> postContainerReceipt(@Valid @RequestBody ContainerReceipt newContainerReceipt, @RequestParam String loginUserID,
        ...
        ContainerReceipt createdContainerReceipt = inboundTransactionService.createContainerReceipt(newContainerReceipt, loginUserID, authToken);
    ...
    public ResponseEntity<?> patchContainerReceipt(@PathVariable String containerReceiptNo,
        ...
        ContainerReceipt updatedContainerReceipt =
                inboundTransactionService.updateContainerReceipt(containerReceiptNo, loginUserID, updateContainerReceipt, authToken);
    ...
    public ResponseEntity<?> deleteContainerReceipt(@PathVariable String containerReceiptNo,
        ...
        inboundTransactionService.deleteContainerReceipt(preInboundNo, refDocNumber, containerReceiptNo, warehouseId, loginUserID, authToken);
    ...
    public ResponseEntity<?> getPreInboundHeaders(@RequestParam String authToken) throws Exception {
        PreInboundHeader[] preinboundheaderList = inboundTransactionService.getPreInboundHeaders(authToken);
    ...
    public ResponseEntity<?> getPreInboundHeader(@PathVariable String preInboundNo, @RequestParam String warehouseId,
                                                 @RequestParam String authToken) throws Exception {
        PreInboundHeader preinboundheader = inboundTransactionService.getPreInboundHeader(preInboundNo, warehouseId, authToken);
    ...
    public PreInboundHeader[] findPreInboundHeader(@RequestBody SearchPreInboundHeader searchPreInboundHeader,
                                                   @RequestParam String authToken) throws Exception {
        return inboundTransactionService.findPreInboundHeader(searchPreInboundHeader, authToken);
    }
    ...
    public PreInboundHeader[] findPreInboundHeaderNew(@RequestBody SearchPreInboundHeader searchPreInboundHeader,
                                                      @RequestParam String authToken) throws Exception {
        return inboundTransactionService.findPreInboundHeaderNew(searchPreInboundHeader, authToken);
    }
    ...
    public ResponseEntity<?> getPreInboundHeader(@PathVariable String warehouseId,
        ...
        PreInboundHeader[] preinboundheader =
                inboundTransactionService.getPreInboundHeaderWithStatusId(warehouseId, authToken);
        return new ResponseEntity<>(preinboundheader, HttpStatus.OK);
    }
    ...
    public ResponseEntity<?> postPreInboundHeader(@Valid @RequestBody PreInboundHeader newPreInboundHeader, @RequestParam String loginUserID,
                                                  @RequestParam String authToken) throws IllegalAccessException, InvocationTargetException {
        PreInboundHeader createdPreInboundHeader = inboundTransactionService.createPreInboundHeader(newPreInboundHeader, loginUserID, authToken);
    ...
    public ResponseEntity<?> patchPreInboundHeader(@PathVariable String preInboundNo, @RequestParam String warehouseId,
        ...
        PreInboundHeader createdPreInboundHeader =
                inboundTransactionService.updatePreInboundHeader(preInboundNo, warehouseId, loginUserID, updatePreInboundHeader, authToken);
        return new ResponseEntity<>(createdPreInboundHeader, HttpStatus.OK);
    }
    ...
    public ResponseEntity<?> deletePreInboundHeader(@PathVariable String preInboundNo, @RequestParam String warehouseId,
                                                    @RequestParam String loginUserID, @RequestParam String authToken) {
        inboundTransactionService.deletePreInboundHeader(preInboundNo, warehouseId, loginUserID, authToken);
        return new ResponseEntity<>(HttpStatus.NO_CONTENT);
    }
    ...
    public ResponseEntity<?> processASN(@RequestBody List<PreInboundLine> newPreInboundLine, @RequestParam String loginUserID,
            ...
            throws IllegalAccessException, InvocationTargetException {
        StagingHeader createdStagingHeader = inboundTransactionService.processASN(newPreInboundLine, loginUserID, authToken);
    ...
    public ResponseEntity<?> postPreInboundLineBOM(@RequestParam String preInboundNo,
        ...
        PreInboundLine[] createdPreInboundLine =
                inboundTransactionService.createPreInboundLineBOM(preInboundNo, warehouseId, refDocNumber, itemCode,
    ...
    public ResponseEntity<?> getPreInboundLine(@PathVariable String preInboundNo, @RequestParam String authToken) throws Exception {
        PreInboundLine[] preinboundline = inboundTransactionService.getPreInboundLine(preInboundNo, authToken);
    ...
    public ResponseEntity<?> getInboundHeaders(@RequestParam String authToken) throws Exception {
        InboundHeader[] refDocNumberList = inboundTransactionService.getInboundHeaders(authToken);
    ...
    public ResponseEntity<?> getInboundHeader(@PathVariable String refDocNumber, @RequestParam String warehouseId,
        ...
        InboundHeader dbInboundHeader = inboundTransactionService.getInboundHeader(warehouseId, refDocNumber, preInboundNo, authToken);
    ...
    public InboundHeader[] findInboundHeader(@RequestBody SearchInboundHeader searchInboundHeader,
                                             @RequestParam String authToken) throws Exception {
        return inboundTransactionService.findInboundHeader(searchInboundHeader, authToken);
    }
    ...
    public InboundHeader[] findInboundHeaderNew(@RequestBody SearchInboundHeader searchInboundHeader,
                                                @RequestParam String authToken) throws Exception {
        return inboundTransactionService.findInboundHeaderNew(searchInboundHeader, authToken);
    }
    ...
    public ResponseEntity<?> getInboundHeader(@RequestParam String warehouseId, @RequestParam String authToken) throws Exception {
        InboundHeaderEntity[] inboundheaderEntity = inboundTransactionService.getInboundHeaderWithStatusId(warehouseId, authToken);
    ...
    public ResponseEntity<?> postInboundHeader(@Valid @RequestBody InboundHeader newInboundHeader, @RequestParam String loginUserID,
                                               @RequestParam String authToken) throws IllegalAccessException, InvocationTargetException {
        InboundHeader createdInboundHeader = inboundTransactionService.createInboundHeader(newInboundHeader, loginUserID, authToken);
    ...
    public ResponseEntity<?> patchInboundHeader(@PathVariable String refDocNumber, @RequestParam String warehouseId,
        ...
        InboundHeader updatedInboundHeader =
                inboundTransactionService.updateInboundHeader(warehouseId, refDocNumber, preInboundNo, loginUserID, updateInboundHeader, authToken);
    ...
    public ResponseEntity<?> replaceASN(@RequestParam String refDocNumber, @RequestParam String preInboundNo,
            ...
            throws IllegalAccessException, InvocationTargetException {
        inboundTransactionService.replaceASN(refDocNumber, preInboundNo, asnNumber, authToken);
    ...
    public ResponseEntity<?> patchInboundHeaderConfirm(@RequestParam String warehouseId, @RequestParam String preInboundNo,
        ...
        AXApiResponse createdInboundHeaderResponse =
                inboundTransactionService.updateInboundHeaderConfirm(warehouseId, preInboundNo, refDocNumber, loginUserID, authToken);
    ...
    public ResponseEntity<?> deleteInboundHeader(@PathVariable String refDocNumber, @RequestParam String warehouseId,
                                                 @RequestParam String preInboundNo, @RequestParam String loginUserID, @RequestParam String authToken) {
        inboundTransactionService.deleteInboundHeader(warehouseId, refDocNumber, preInboundNo, loginUserID, authToken);
        return new ResponseEntity<>(HttpStatus.NO_CONTENT);
    }
...
//==============================================InboundHeader=V2==================================================
    ...
    public ResponseEntity<?> getInboundLines(@RequestParam String authToken) throws Exception {
        InboundLine[] lineNoList = inboundTransactionService.getInboundLines(authToken);
    ...
    public ResponseEntity<?> getInboundLine(@PathVariable Long lineNo, @RequestParam String languageId, @RequestParam String companyCodeId,
        ...
        InboundLine dbInboundLine =
                inboundTransactionService.getInboundLine(warehouseId, refDocNumber, preInboundNo, lineNo, itemCode, authToken);
    ...
    public InboundLine[] findInboundLine(@RequestBody SearchInboundLine searchInboundLine,
                                         @RequestParam String authToken) throws Exception {
        return inboundTransactionService.findInboundLine(searchInboundLine, authToken);
    }
    ...
    public ResponseEntity<?> postInboundLine(@Valid @RequestBody InboundLine newInboundLine, @RequestParam String loginUserID,
                                             @RequestParam String authToken) throws IllegalAccessException, InvocationTargetException {
        InboundLine createdInboundLine = inboundTransactionService.createInboundLine(newInboundLine, loginUserID, authToken);
    ...
    public ResponseEntity<?> patchInboundLine(@RequestParam Long lineNo, @RequestParam String warehouseId, @RequestParam String refDocNumber,
        ...
        InboundLine updatedInboundLine =
                inboundTransactionService.updateInboundLine(warehouseId, refDocNumber, preInboundNo, lineNo, itemCode, loginUserID, updateInboundLine, authToken);
    ...
    public ResponseEntity<?> deleteInboundLine(@PathVariable Long lineNo, @RequestParam String warehouseId,
                                               ...
                                               @RequestParam String loginUserID, @RequestParam String authToken) {
        inboundTransactionService.deleteInboundLine(warehouseId, refDocNumber, preInboundNo, lineNo, itemCode, loginUserID, authToken);
        return new ResponseEntity<>(HttpStatus.NO_CONTENT);
    }
    ...
    public ResponseEntity<?> getStagingHeaders(@RequestParam String authToken) throws Exception {
        StagingHeader[] stagingheaderList = inboundTransactionService.getStagingHeaders(authToken);
    ...
    public ResponseEntity<?> getStagingHeader(@PathVariable String stagingNo, @RequestParam String languageId,
        ...
        StagingHeader stagingheader = inboundTransactionService.getStagingHeader(warehouseId, preInboundNo, refDocNumber, stagingNo, authToken);
    ...
    public StagingHeader[] findStagingHeader(@RequestBody SearchStagingHeader searchStagingHeader, @RequestParam String authToken)
            throws Exception {
        return inboundTransactionService.findStagingHeader(searchStagingHeader, authToken);
    }
    ...
    public StagingHeader[] findStagingHeaderNew(@RequestBody SearchStagingHeader searchStagingHeader, @RequestParam String authToken)
            throws Exception {
        return inboundTransactionService.findStagingHeaderNew(searchStagingHeader, authToken);
    }
    ...
    public ResponseEntity<?> postStagingHeader(@Valid @RequestBody StagingHeader newStagingHeader,
                                               @RequestParam String loginUserID, @RequestParam String authToken)
            throws IllegalAccessException, InvocationTargetException {
        StagingHeader createdStagingHeader = inboundTransactionService.createStagingHeader(newStagingHeader, loginUserID, authToken);
        return new ResponseEntity<>(createdStagingHeader, HttpStatus.OK);
    }
    ...
    public ResponseEntity<?> patchStagingHeader(@PathVariable String stagingNo, @RequestParam String warehouseId,
        ...
        StagingHeader createdStagingHeader =
                inboundTransactionService.updateStagingHeader(warehouseId, preInboundNo, refDocNumber, stagingNo, loginUserID,
    ...
    public ResponseEntity<?> deleteStagingHeader(@PathVariable String stagingNo, @RequestParam String warehouseId,
                                                 ...
                                                 @RequestParam String authToken) {
        inboundTransactionService.deleteStagingHeader(warehouseId, preInboundNo, refDocNumber, stagingNo, loginUserID, authToken);
        return new ResponseEntity<>(HttpStatus.NO_CONTENT);
    }
    ...
    public ResponseEntity<?> getStagingHeader(@PathVariable Long numberOfCases, @RequestParam String warehouseId,
                                              @RequestParam String authToken) {
        String[] stagingheader = inboundTransactionService.generateNumberRanges(numberOfCases, warehouseId, authToken);
        log.info("StagingHeader : " + stagingheader);
        return new ResponseEntity<>(stagingheader, HttpStatus.OK);
    }
...
// -------------------------------------StagingHeader-V2--------------------------------------------------------------------------------------------
    ...
    public ResponseEntity<?> getStagingLines(@RequestParam String authToken) throws Exception {
        StagingLineEntity[] palletCodeList = inboundTransactionService.getStagingLines(authToken);
    ...
    public ResponseEntity<?> getStagingLine(@PathVariable Long lineNo, @RequestParam String warehouseId,
        ...
        StagingLineEntity dbStagingLine =
                inboundTransactionService.getStagingLine(warehouseId, preInboundNo, refDocNumber, stagingNo, palletCode, caseCode, lineNo, itemCode, authToken);
    ...
    public StagingLineEntity[] findStagingLine(@RequestBody SearchStagingLine searchStagingLine,
                                               @RequestParam String authToken) throws Exception {
        return inboundTransactionService.findStagingLine(searchStagingLine, authToken);
    }
    ...
    public ResponseEntity<?> postStagingLine(@Valid @RequestBody List<StagingLine> newStagingLine,
        ...
        StagingLineEntity[] createdStagingLine =
                inboundTransactionService.createStagingLine(newStagingLine, loginUserID, authToken);
    ...
    public ResponseEntity<?> patchStagingLine(@PathVariable Long lineNo, @RequestParam String warehouseId,
        ...
        StagingLineEntity updatedStagingLine =
                inboundTransactionService.updateStagingLine(warehouseId, preInboundNo, refDocNumber, stagingNo, palletCode, caseCode,
    ...
    public ResponseEntity<?> patchStagingLineForCaseConfirmation(@RequestBody List<CaseConfirmation> caseConfirmations,
            ...
            throws IllegalAccessException, InvocationTargetException {
        StagingLineEntity[] createdStagingLine =
                inboundTransactionService.caseConfirmation(caseConfirmations, caseCode, loginUserID, authToken);
        return new ResponseEntity<>(createdStagingLine, HttpStatus.OK);
    }
    ...
    public ResponseEntity<?> deleteStagingLine(@PathVariable Long lineNo, @RequestParam String warehouseId,
                                               ...
                                               @RequestParam String caseCode, @RequestParam String palletCode, @RequestParam String itemCode,
                                               @RequestParam String loginUserID, @RequestParam String authToken) {
        inboundTransactionService.deleteStagingLine(warehouseId, preInboundNo, refDocNumber, stagingNo, palletCode, caseCode, lineNo,
    ...
    public ResponseEntity<?> deleteCases(@PathVariable Long lineNo, @RequestParam String preInboundNo,
                                         ...
                                         @RequestParam String authToken) {
        inboundTransactionService.deleteCases(preInboundNo, lineNo, itemCode, caseCode, loginUserID, authToken);
        return new ResponseEntity<>(HttpStatus.NO_CONTENT);
    }
    ...
    public ResponseEntity<?> assignHHTUser(@RequestBody List<AssignHHTUser> assignHHTUsers, @RequestParam String assignedUserId,
        ...
        log.info("hello");
        StagingLineEntity[] updatedStagingLine =
                inboundTransactionService.assignHHTUser(assignHHTUsers, assignedUserId, loginUserID, authToken);
        return new ResponseEntity<>(updatedStagingLine, HttpStatus.OK);
    }
    ...
    public ResponseEntity<?> stagingLineUpdate(@Valid @RequestBody List<GrHeaderV2> grHeaderV2s, @RequestParam String loginUserID, @RequestParam String authToken) {
        GrHeaderV2[] createdStagingLine =
                inboundTransactionService.updateVehicleNo(grHeaderV2s, loginUserID, authToken);
        return new ResponseEntity<>(createdStagingLine, HttpStatus.OK);
    }
    ...
    public ResponseEntity<?> getGrHeaders(@RequestParam String authToken) throws Exception {
        GrHeader[] goodsReceiptNoList = inboundTransactionService.getGrHeaders(authToken);
    ...
    public ResponseEntity<?> getGrHeader(@PathVariable String goodsReceiptNo, @RequestParam String warehouseId,
        ...
        GrHeader dbGrHeader =
                inboundTransactionService.getGrHeader(warehouseId, preInboundNo, refDocNumber, stagingNo, goodsReceiptNo, palletCode,
                        caseCode, authToken);
    ...
    public GrHeader[] findGrHeader(@RequestBody SearchGrHeader searchGrHeader, @RequestParam String authToken)
            throws Exception {
        return inboundTransactionService.findGrHeader(searchGrHeader, authToken);
    }
    ...
    public GrHeader[] findGrHeaderNew(@RequestBody SearchGrHeader searchGrHeader, @RequestParam String authToken)
            throws Exception {
        return inboundTransactionService.findGrHeaderNew(searchGrHeader, authToken);
    }
    ...
    public ResponseEntity<?> postGrHeader(@Valid @RequestBody GrHeader newGrHeader, @RequestParam String loginUserID,
                                          @RequestParam String authToken) throws IllegalAccessException, InvocationTargetException {
        GrHeader createdGrHeader = inboundTransactionService.createGrHeader(newGrHeader, loginUserID, authToken);
    ...
    public ResponseEntity<?> patchGrHeader(@RequestParam String goodsReceiptNo, @RequestParam String warehouseId,
        ...
        GrHeader updatedGrHeader =
                inboundTransactionService.updateGrHeader(warehouseId, preInboundNo, refDocNumber, stagingNo, goodsReceiptNo,
    ...
    public ResponseEntity<?> deleteGrHeader(@PathVariable String goodsReceiptNo, @RequestParam String warehouseId,
                                            ...
                                            @RequestParam String palletCode, @RequestParam String caseCode, @RequestParam String loginUserID,
                                            @RequestParam String authToken) {
        inboundTransactionService.deleteGrHeader(warehouseId, preInboundNo, refDocNumber, stagingNo, goodsReceiptNo, palletCode, caseCode, loginUserID, authToken);
        return new ResponseEntity<>(HttpStatus.NO_CONTENT);
    }
    ...
    public ResponseEntity<?> getGrLines(@RequestParam String authToken) throws Exception {
        GrLine[] itemCodeList = inboundTransactionService.getGrLines(authToken);
    ...
    public ResponseEntity<?> getGrLine(@PathVariable Long lineNo, @RequestParam String warehouseId,
        ...
        GrLine dbGrLine =
                inboundTransactionService.getGrLine(warehouseId, preInboundNo, refDocNumber, goodsReceiptNo, palletCode, caseCode,
    ...
    public ResponseEntity<?> getGrLine(@PathVariable Long lineNo, @RequestParam String preInboundNo,
                                       ...
                                       @RequestParam String authToken) throws Exception {
        GrLine[] grline = inboundTransactionService.getGrLine(preInboundNo, refDocNumber, packBarcodes, lineNo, itemCode, authToken);
    ...
    public GrLine[] findGrLine(@RequestBody SearchGrLine searchGrLine, @RequestParam String authToken)
            throws Exception {
        return inboundTransactionService.findGrLine(searchGrLine, authToken);
    }
    ...
    public ResponseEntity<?> postGrLine(@Valid @RequestBody List<AddGrLine> newGrLine, @RequestParam String loginUserID,
                                        @RequestParam String authToken) throws IllegalAccessException, InvocationTargetException {
        GrLine[] createdGrLine = inboundTransactionService.createGrLine(newGrLine, loginUserID, authToken);
    ...
    public ResponseEntity<?> patchGrLine(@RequestParam Long lineNo, @RequestParam String warehouseId, @RequestParam String preInboundNo,
        ...
        GrLine updatedGrLine =
                inboundTransactionService.updateGrLine(warehouseId, preInboundNo, refDocNumber, goodsReceiptNo, palletCode, caseCode,
    ...
    //putawayheader/bulkupdate/mobApp
...
//    @ApiOperation(response = SaleOrderReturnV2.class, value = "Sales Order Return Upload Excel")
//    @PostMapping("/warehouse/inbound/soreturn/uploadExcel")
//    public ResponseEntity<?> postSoReturnUploadExcel(@RequestBody List<AsnList> asnLists, @RequestParam String authToken)
//            throws IllegalAccessException, InvocationTargetException {
//        List<InboundOrderProcessV4> allRowList = excelDataProcessService.inboundDataSet(asnLists);
//
//        List<SaleOrderReturnV2> saleOrderReturn = orderPreparationService.prepSoReturnMultipleData(allRowList);
//        WarehouseApiResponse[] returnedSo = inboundTransactionService.postSOReturnUploadExcel(saleOrderReturn, authToken);
//        return new ResponseEntity<>(returnedSo, HttpStatus.OK);
//    }
...
//    }
    ...
    public ResponseEntity<?> updateAssignPickerForPrint(@Valid @RequestBody List<PickupHeaderV2> updatePickupHeaderList, @RequestParam String loginUserID,
            ...
            throws IllegalAccessException, InvocationTargetException {
        PickupHeaderV2[] updatedPickupHeader =
                outboundTransactionService.updateAssignPickerPrintConfirm(updatePickupHeaderList, loginUserID, authToken);
        return new ResponseEntity<>(updatedPickupHeader, HttpStatus.OK);
    }
...
//    }
    ...
    @PostMapping("/inventory/stock/report")
    public ResponseEntity<?> newReport(@RequestBody TransactionReport findReport, @RequestParam String authToken) throws Exception {
        TransactionReportRes[] reportResult = inboundTransactionService.findTransactionReport(findReport, authToken);
    ...
    public ResponseEntity<?> outboundOrderReversal(@Valid @RequestBody List<OutboundOrderReversal> outboundOrderReversalList, @RequestParam String authToken) {
        OutboundOrderReversal[] response =
                outboundTransactionService.outboundOrderReversals(outboundOrderReversalList, authToken);
        return new ResponseEntity<>(response, HttpStatus.OK);
    }
    ...
    public ResponseEntity<?> postInventory(@RequestParam String companyCodeId, @RequestParam String plantId,
        ...
        response = fileStorageService.processInventory(companyCodeId,plantId,languageID,warehouseId,loginUserID,file);
        return new ResponseEntity<>(response,HttpStatus.OK);
    }
    ...
    @ApiOperation(response = BinOccupancyDashboardResponse.class, value = "Get Bin OccupancyDashBoard") // label for swagger
    @GetMapping("/bin/occupancy/dashboard")
    public ResponseEntity<?> binOccupanceDashboard(@RequestParam String authToken){
