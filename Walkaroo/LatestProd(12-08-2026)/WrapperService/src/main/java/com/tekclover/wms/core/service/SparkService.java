...
//        headers.add("Authorization", "Bearer " + authToken);
    ...
    public OutboundHeaderSpark[] getOutboundHeader(FindOutboundHeaderNew findOutboundHeaderNew) {
        try {
            HttpHeaders headers = new HttpHeaders();
            headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
            headers.add("User-Agent", " RestTemplate");
...
//---------------------------------------Dash Board-----------------------------------------------------//
    ...
    //Find StagingLine
    public UnLoadingDashBoardResponse[] findUnLoadinDashBoard(UnLoadingDashBoardRequest request) {
        try {
            HttpHeaders headers = new HttpHeaders();
            headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
            headers.add("User-Agent", " RestTemplate");
//        headers.add("Authorization", "Bearer " + authToken);
            ...
            UriComponentsBuilder builder =
                    UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "/unloading/vehicle/dashboard");
            HttpEntity<?> entity = new HttpEntity<>(request, headers);
            ResponseEntity<UnLoadingDashBoardResponse[]> result =
                    getRestTemplate().exchange(builder.toUriString(), HttpMethod.POST, entity, UnLoadingDashBoardResponse[].class);
            log.info("result : " + result.getStatusCode());
            return result.getBody();
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public PalletizationDashBoardResponse[] findUnLoadingPalletization(UnLoadingDashBoardRequest unLoadingDashBoardRequest) {
        try {
            HttpHeaders headers = new HttpHeaders();
            headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
            headers.add("User-Agent", " RestTemplate");
            ...
            UriComponentsBuilder builder =
                    UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "/palletization/dashboard");
            HttpEntity<?> entity = new HttpEntity<>(unLoadingDashBoardRequest, headers);
            ResponseEntity<PalletizationDashBoardResponse[]> result =
                    getRestTemplate().exchange(builder.toUriString(), HttpMethod.POST, entity, PalletizationDashBoardResponse[].class);
            log.info("result : " + result.getStatusCode());
            return result.getBody();
        } catch (Exception e) {
            e.printStackTrace();
    ...
    //PutAway DashBoard
    public PutAwayDashBoardByTruckResponse[] findPutAwayByTruck(UnLoadingDashBoardRequest unLoadingDashBoardRequest) {
        try {
            HttpHeaders headers = new HttpHeaders();
            headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
            headers.add("User-Agent", " RestTemplate");
            ...
            UriComponentsBuilder builder =
                    UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "/putaway/vehicle/dashboard");
            HttpEntity<?> entity = new HttpEntity<>(unLoadingDashBoardRequest, headers);
            ResponseEntity<PutAwayDashBoardByTruckResponse[]> result =
                    getRestTemplate().exchange(builder.toUriString(), HttpMethod.POST, entity, PutAwayDashBoardByTruckResponse[].class);
            log.info("result : " + result.getStatusCode());
            return result.getBody();
        } catch (Exception e) {
            e.printStackTrace();
    ...
    //PutAway DashBoard
    public PutAwayDashBoardByUserResponse[] findPutAwayByUser(UnLoadingDashBoardRequest unLoadingDashBoardRequest) {
        try {
            HttpHeaders headers = new HttpHeaders();
            headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
            headers.add("User-Agent", " RestTemplate");
            ...
            UriComponentsBuilder builder =
                    UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "/putaway/user/dashboard");
            HttpEntity<?> entity = new HttpEntity<>(unLoadingDashBoardRequest, headers);
            ResponseEntity<PutAwayDashBoardByUserResponse[]> result =
                    getRestTemplate().exchange(builder.toUriString(), HttpMethod.POST, entity, PutAwayDashBoardByUserResponse[].class);
            log.info("result : " + result.getStatusCode());
            return result.getBody();
        } catch (Exception e) {
            e.printStackTrace();
    ...
    //Palletization DashBoard
    public PalletizationDashBoardResponseList[] findUnLoadingPalletizationList(UnLoadingDashBoardRequest unLoadingDashBoardRequest) {
        try {
            HttpHeaders headers = new HttpHeaders();
            headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
            headers.add("User-Agent", " RestTemplate");
            ...
            UriComponentsBuilder builder =
                    UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "/palletization/dashboard/list");
            HttpEntity<?> entity = new HttpEntity<>(unLoadingDashBoardRequest, headers);
            ResponseEntity<PalletizationDashBoardResponseList[]> result =
                    getRestTemplate().exchange(builder.toUriString(), HttpMethod.POST, entity, PalletizationDashBoardResponseList[].class);
            log.info("result : " + result.getStatusCode());
            return result.getBody();
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public CapacityUtilizationByPlantResponse[] capacityUtilizationByPlant(CapacityUtilizationByPlantRequest request) {
        try {
            HttpHeaders headers = new HttpHeaders();
            headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
            headers.add("User-Agent", " RestTemplate");
            ...
            UriComponentsBuilder builder =
                    UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "/capacity/Utilization/by/plant");
            HttpEntity<?> entity = new HttpEntity<>(request, headers);
            ResponseEntity<CapacityUtilizationByPlantResponse[]> result =
                    getRestTemplate().exchange(builder.toUriString(), HttpMethod.POST, entity, CapacityUtilizationByPlantResponse[].class);
            log.info("result : " + result.getStatusCode());
            return result.getBody();
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public PutAwayDashBoardUserListRes[] findPutAwayByUsersList(UnLoadingDashBoardRequest unLoadingDashBoardRequest) {
        try {
            HttpHeaders headers = new HttpHeaders();
            headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
            headers.add("User-Agent", " RestTemplate");
            ...
            UriComponentsBuilder builder =
                    UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "/putaway/user/dashboard/list");
            HttpEntity<?> entity = new HttpEntity<>(unLoadingDashBoardRequest, headers);
            ResponseEntity<PutAwayDashBoardUserListRes[]> result =
                    getRestTemplate().exchange(builder.toUriString(), HttpMethod.POST, entity, PutAwayDashBoardUserListRes[].class);
            log.info("result : " + result.getStatusCode());
            return result.getBody();
        } catch (Exception e) {
            e.printStackTrace();
    ...
    // Occupancy Dashboard
    public OccupancyDashboardCountRes[] occupancyDashboardByPlant(CapacityUtilizationByPlantRequest request) {
        try {
            HttpHeaders headers = new HttpHeaders();
            headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
            headers.add("User-Agent", " RestTemplate");
            ...
            UriComponentsBuilder builder =
                    UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "/occupancy/dashboard");
            HttpEntity<?> entity = new HttpEntity<>(request, headers);
            ResponseEntity<OccupancyDashboardCountRes[]> result =
                    getRestTemplate().exchange(builder.toUriString(), HttpMethod.POST, entity, OccupancyDashboardCountRes[].class);
            log.info("result : " + result.getStatusCode());
            return result.getBody();
        } catch (Exception e) {
            e.printStackTrace();
    ...
    //Palletization DashBoard
    public VehicleCountDashboardRes[] findVehicleCountStaging(UnLoadingDashBoardRequest unLoadingDashBoardRequest) {
        try {
            HttpHeaders headers = new HttpHeaders();
            headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
            headers.add("User-Agent", " RestTemplate");
            ...
            UriComponentsBuilder builder =
                    UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "/staging/truckcount");
            HttpEntity<?> entity = new HttpEntity<>(unLoadingDashBoardRequest, headers);
            ResponseEntity<VehicleCountDashboardRes[]> result =
                    getRestTemplate().exchange(builder.toUriString(), HttpMethod.POST, entity, VehicleCountDashboardRes[].class);
            log.info("result : " + result.getStatusCode());
            return result.getBody();
        } catch (Exception e) {
            e.printStackTrace();
    ...
    //Palletization DashBoard
    public VehicleCountDashboardRes[] findVehicleCountPutAway(UnLoadingDashBoardRequest unLoadingDashBoardRequest) {
        try {
            HttpHeaders headers = new HttpHeaders();
            headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
            headers.add("User-Agent", " RestTemplate");
            ...
            UriComponentsBuilder builder =
                    UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "/putaway/truckcount");
            HttpEntity<?> entity = new HttpEntity<>(unLoadingDashBoardRequest, headers);
            ResponseEntity<VehicleCountDashboardRes[]> result =
                    getRestTemplate().exchange(builder.toUriString(), HttpMethod.POST, entity, VehicleCountDashboardRes[].class);
            log.info("result : " + result.getStatusCode());
    ...
    public PickupDashBoardResponse[] pickupDashBoardByCustomer(PickupDashBoardRequest request) {
        try {
            HttpHeaders headers = new HttpHeaders();
            headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
            headers.add("User-Agent", " RestTemplate");
            ...
            UriComponentsBuilder builder =
                    UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "/pickup/customer/dashboard");
            HttpEntity<?> entity = new HttpEntity<>(request, headers);
            ResponseEntity<PickupDashBoardResponse[]> result =
                    getRestTemplate().exchange(builder.toUriString(), HttpMethod.POST, entity, PickupDashBoardResponse[].class);
            log.info("result : " + result.getStatusCode());
            return result.getBody();
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public PickupDashBoardResponse[] pickupDashBoardByOrder(PickupDashBoardRequest request) {
        try {
            HttpHeaders headers = new HttpHeaders();
            headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
            headers.add("User-Agent", " RestTemplate");
            ...
            UriComponentsBuilder builder =
                    UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "/pickup/order/dashboard");
            HttpEntity<?> entity = new HttpEntity<>(request, headers);
            ResponseEntity<PickupDashBoardResponse[]> result =
                    getRestTemplate().exchange(builder.toUriString(), HttpMethod.POST, entity, PickupDashBoardResponse[].class);
            log.info("result : " + result.getStatusCode());
    ...
    public AgingDashBoardResponse[] agingDashBoard(AgingDashBoardRequest request) {
        try {
            HttpHeaders headers = new HttpHeaders();
            headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
            headers.add("User-Agent", " RestTemplate");
            ...
            UriComponentsBuilder builder =
                    UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "/aging/dashboard");
            HttpEntity<?> entity = new HttpEntity<>(request, headers);
            ResponseEntity<AgingDashBoardResponse[]> result =
                    getRestTemplate().exchange(builder.toUriString(), HttpMethod.POST, entity, AgingDashBoardResponse[].class);
            log.info("result : " + result.getStatusCode());
            return result.getBody();
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public InventoryByAgingResponse[] findInventoryByAging(InventoryByAgingRequest request) {
        try {
            HttpHeaders headers = new HttpHeaders();
            headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
            headers.add("User-Agent", " RestTemplate");
            ...
            UriComponentsBuilder builder =
                    UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "/aging/dashboard/by/item");
            HttpEntity<?> entity = new HttpEntity<>(request, headers);
            ResponseEntity<InventoryByAgingResponse[]> result =
                    getRestTemplate().exchange(builder.toUriString(), HttpMethod.POST, entity, InventoryByAgingResponse[].class);
            log.info("result : " + result.getStatusCode());
            return result.getBody();
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public InventoryByAgingResponse[] findAllInventoryByAging(InventoryByAgingRequest request) {
        try {
            HttpHeaders headers = new HttpHeaders();
            headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
            headers.add("User-Agent", " RestTemplate");
            ...
            UriComponentsBuilder builder =
                    UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "/aging/dashboard/by/location");
            HttpEntity<?> entity = new HttpEntity<>(request, headers);
            ResponseEntity<InventoryByAgingResponse[]> result =
                    getRestTemplate().exchange(builder.toUriString(), HttpMethod.POST, entity, InventoryByAgingResponse[].class);
            log.info("result : " + result.getStatusCode());
    ...
    public AgingDashBoardByCategoryResponse[] agingDashBoardByCategory(AgingDashBoardRequest request) {
        try {
            HttpHeaders headers = new HttpHeaders();
            headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
            headers.add("User-Agent", " RestTemplate");
            ...
            UriComponentsBuilder builder =
                    UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "/aging/dashboard/by/category");
            HttpEntity<?> entity = new HttpEntity<>(request, headers);
            ResponseEntity<AgingDashBoardByCategoryResponse[]> result =
                    getRestTemplate().exchange(builder.toUriString(), HttpMethod.POST, entity, AgingDashBoardByCategoryResponse[].class);
            log.info("result : " + result.getStatusCode());
            return result.getBody();
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public AgingByCategoryResponse[] findInventoryByAgingByCategory(AgingByCategoryRequest request) {
        try {
            HttpHeaders headers = new HttpHeaders();
            headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
            headers.add("User-Agent", " RestTemplate");
            ...
            UriComponentsBuilder builder =
                    UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "/aging/by/item/and/category");
            HttpEntity<?> entity = new HttpEntity<>(request, headers);
            ResponseEntity<AgingByCategoryResponse[]> result =
                    getRestTemplate().exchange(builder.toUriString(), HttpMethod.POST, entity, AgingByCategoryResponse[].class);
            log.info("result : " + result.getStatusCode());
            return result.getBody();
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public AgingByCategoryResponse[] findAllInventoryByAgingByCategory(AgingByCategoryRequest request) {
        try {
            HttpHeaders headers = new HttpHeaders();
            headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
            headers.add("User-Agent", " RestTemplate");
            ...
            UriComponentsBuilder builder =
                    UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "/aging/by/location/and/category");
            HttpEntity<?> entity = new HttpEntity<>(request, headers);
            ResponseEntity<AgingByCategoryResponse[]> result =
                    getRestTemplate().exchange(builder.toUriString(), HttpMethod.POST, entity, AgingByCategoryResponse[].class);
            log.info("result : " + result.getStatusCode());
