...
import com.tekclover.wms.api.masters.model.storagebintype.AddStorageBinType;
import com.tekclover.wms.api.masters.model.storagebintype.SearchStorageBinType;
import com.tekclover.wms.api.masters.model.storagebintype.StorageBinType;
import com.tekclover.wms.api.masters.model.storagebintype.UpdateStorageBinType;
import com.tekclover.wms.api.masters.enterprise.service.StorageBinTypeService;
...
public class StorageBinTypeController {
    ...
    public List<StorageBinType> findStorageBinType(@RequestBody SearchStorageBinType searchStorageBinType)
            throws Exception {
        try {
            String currentDB = baseService.getDataBase(searchStorageBinType.getPlantId(), searchStorageBinType.getWarehouseId());
            DataBaseContextHolder.clear();
            DataBaseContextHolder.setCurrentDb(currentDB);
            log.info("Current DB " + currentDB);
    ...
    public ResponseEntity<?> postStorageBinType(@Valid @RequestBody AddStorageBinType newStorageBinType,
        ...
        try {
            String currentDB = baseService.getDataBase(newStorageBinType.getPlantId(), newStorageBinType.getWarehouseId());
            DataBaseContextHolder.clear();
            DataBaseContextHolder.setCurrentDb(currentDB);
            log.info("Current DB " + currentDB);
