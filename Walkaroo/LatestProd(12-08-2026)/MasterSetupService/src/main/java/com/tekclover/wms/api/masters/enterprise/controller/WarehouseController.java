...
import com.tekclover.wms.api.masters.enterprise.service.WarehouseService;
...
public class WarehouseController {
    ...
    public List<Warehouse> findWarehouse(@RequestBody SearchWarehouse searchWarehouse)
            throws Exception {
        try {
            String currentDB = baseService.getDataBase(searchWarehouse.getPlantId(), searchWarehouse.getWarehouseId());
            DataBaseContextHolder.clear();
            DataBaseContextHolder.setCurrentDb(currentDB);
            log.info("Current DB " + currentDB);
    ...
    public ResponseEntity<?> postWarehouse(@Valid @RequestBody AddWarehouse newWarehouse, @RequestParam String loginUserID)
        ...
        try {
            String currentDB = baseService.getDataBase(newWarehouse.getPlantId(), newWarehouse.getWarehouseId());
            DataBaseContextHolder.clear();
            DataBaseContextHolder.setCurrentDb(currentDB);
            log.info("Current DB " + currentDB);
