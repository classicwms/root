...
public class TransactionServiceController {
    ...
    public ResponseEntity<?> patchPutAwayHeaderMobApp(@Valid @RequestBody List<PutAwayHeaderV2> updatePutAwayHeader, @RequestParam String loginUserID,
            ...
            throws IllegalAccessException, InvocationTargetException {
        PutAwayHeader[] updatedPutAwayHeader =
                transactionService.updatePutAwayHeaderMobApp(updatePutAwayHeader, loginUserID, authToken);
        return new ResponseEntity<>(updatedPutAwayHeader, HttpStatus.OK);
    }
...
//		batchJobScheduler.runJobPeriodic();
    ...
    public PreInboundLineOutputReport[] findPreInboundLineReport(@RequestBody SearchPreInboundLineV2 searchPreInboundLine,
                                                         @RequestParam String authToken) throws Exception {
        return transactionService.findPreInboundLineReport(searchPreInboundLine, authToken);
    }
...
// -------------------------------------StagingHeader-V2--------------------------------------------------------------------------------------------
    ...
    public StagingLineEntityV2[] findStagingLineV2Report(@RequestBody SearchStagingLineV2 searchStagingLine,
                                                   @RequestParam String authToken) throws Exception {
        return transactionService.findStagingLineV2Report(searchStagingLine, authToken);
    }
    ...
    public GroupedStagingLineResponse[] findStagingLineMobApp(@RequestBody SearchStagingLineV2 searchStagingLine,
                                                              @RequestParam String authToken) throws Exception {
        return transactionService.findStagingLineMobApp(searchStagingLine, authToken);
    }
    ...
    public GroupedStagingLineResponse[] findStagingLineMobAppVehicleCount(@RequestBody SearchStagingLineV2 searchStagingLine,
        ...
        return transactionService.findStagingLineMobAppVehicle(searchStagingLine, authToken);
    }
    ...
    public ResponseEntity<?> stagingLine(@Valid @RequestBody StagingLineEntityV2[] stagingLine, @RequestParam String loginUserID, @RequestParam String authToken) {
        StagingLineEntityV2[] createdStagingLine =
                transactionService.updateStagingLinev2(stagingLine, loginUserID, authToken);
        return new ResponseEntity<>(createdStagingLine, HttpStatus.OK);
    }
    ...
    public ResponseEntity<?> stagingLineUpdate(@Valid @RequestBody StagingLineEntityV2[] stagingLine, @RequestParam String loginUserID, @RequestParam String authToken) {
        StagingLineEntityV2[] createdStagingLine =
                transactionService.updateVehicleNo(stagingLine, loginUserID, authToken);
        return new ResponseEntity<>(createdStagingLine, HttpStatus.OK);
    }
    ...
    public PutawayUserGroup[] findPutawayLineDistribution(@RequestBody SearchPutAwayLineV2 searchPutAwayLine,
                                             @RequestParam String authToken) throws Exception {
        return transactionService.findPutawayLineDistribution(searchPutAwayLine, authToken);
    }
    ...
    public PutAwayLineV2[] findPutAwayLineV3(@RequestBody SearchPutAwayLineV2 searchPutAwayLine,
                                             @RequestParam String authToken) throws Exception {
        return transactionService.findPutAwayLineV3(searchPutAwayLine, authToken);
    }
...
//                                             @RequestParam String authToken) throws Exception {
//        return transactionService.findPutAwayLineMobApp(searchPutAwayLine, authToken);
//    }
    ...
    public PutAwayPalletGroupResponse[] findPutAwayHeaderMobApp(@RequestBody SearchPutAwayHeaderV2 searchPutAwayLine,
                                                              @RequestParam String authToken) throws Exception {
        return transactionService.findPutAwayHeaderMobApp(searchPutAwayLine, authToken);
    }
...
//        WarehouseApiResponse[] returnedSo = transactionService.postSOReturnUploadExcel(saleOrderReturn, authToken);
...
//    =============================================Walkaroo-Inbound Order List API======================================
    ...
    public ResponseEntity<?> postASNList(@Valid @RequestBody List<ASNV2> asnv2, @RequestParam String authToken)
            throws IllegalAccessException, InvocationTargetException {
        WarehouseApiResponse[] createdSO = transactionService.postASNV3(asnv2, authToken);
        return new ResponseEntity<>(createdSO, HttpStatus.OK);
    }
    ...
    public ResponseEntity<?> postASNList1(@RequestParam String companyCodeId, @RequestParam String plantId,
        ...
        WarehouseApiResponse[] createdSO = transactionService.postASNV3(asnV2Orders, authToken);
        return new ResponseEntity<>(createdSO, HttpStatus.OK);
    }
    ...
    public ResponseEntity<?> postASNListTest(@RequestBody List<AsnList> asnv2, @RequestParam String authToken)
        ...
        List<InboundOrderProcessV4> allRowsList = excelDataProcessService.inboundDataSet(asnv2);
        List<ASNV2> asnV2Orders = orderPreparationService.prepAsnMultipleData(allRowsList);
        WarehouseApiResponse[] createdSO = transactionService.postASNV4(asnV2Orders, authToken);
        return new ResponseEntity<>(createdSO, HttpStatus.OK);
    }
    ...
    public ResponseEntity<?> postCheck(@RequestParam String input, @RequestParam String authToken) throws Exception {
        WarehouseApiResponse created = transactionService.postData(input, authToken);
    ...
    public ResponseEntity<?> inventoryCreate(@RequestBody List<ExcessConfirmation> excessConfirmations, @RequestParam String loginUserID, @RequestParam String authToken) throws Exception {
        WarehouseApiResponse created = transactionService.createInventoryv3(excessConfirmations, loginUserID,authToken);
        return new ResponseEntity<>(created, HttpStatus.OK);
    }
    ...
    public ResponseEntity<?> sapManualProcess(@RequestBody List<SAPData> sapData, @RequestParam String authToken) throws Exception {
        WarehouseApiResponse created = transactionService.sapPush(sapData, authToken);
        return new ResponseEntity<>(created, HttpStatus.OK);
    }
    ...
    public ResponseEntity<?> grReversalUpdate(@RequestBody List<PreInboundLineV2> preInboundLineEntityV2List, @RequestParam String loginUserID, @RequestParam String authToken) {
        GrReversalResponse response = transactionService.grReversalUpdation(preInboundLineEntityV2List, loginUserID, authToken);
        return new ResponseEntity<>(response, HttpStatus.OK);
    }
