...
@Slf4j
@Service
public class InhouseTransferHeaderService {

    Properties connProp = new Properties();
    SparkSession sparkSession = null;

    public InhouseTransferHeaderService() throws ParseException {
        ...
        val df2 = sparkSession.read()
                ...
                .jdbc("jdbc:sqlserver://10.10.10.61;databaseName=WMS_ALMPRD", "tblinhousetransferheader", connProp)
                .repartition(16);
        df2.createOrReplaceTempView("tblinhousetransferheaderv2");
    }
    ...
    public List<InhouseTransferHeader> getAllInhouseTransferHeader() throws ParseException {
        ...
        Dataset<Row> inhouseTransferHeaderQuery = sparkSession.sql("SELECT "
                ...
                + "From tblinhousetransferheaderv2 where IS_DELETED = 0 "
        );
