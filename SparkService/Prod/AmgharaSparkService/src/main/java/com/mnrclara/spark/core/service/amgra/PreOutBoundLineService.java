...
import com.mnrclara.spark.core.model.Almailem.FindPreOutBoundLineV2;
import com.mnrclara.spark.core.model.Almailem.PreOutBoundLineV2;
...
@Service
@Slf4j
public class PreOutBoundLineService {

    Properties connProp = new Properties();
    SparkSession sparkSession = null;
    private static final SimpleDateFormat dateFormat = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");

    public PreOutBoundLineService() {
        ...
        val df2 = sparkSession.read()
                ...
                .jdbc("jdbc:sqlserver://10.10.10.61;databaseName=WMS_ALMPRD", "tblpreoutboundline", connProp)
                .repartition(16);
        df2.createOrReplaceTempView("tblpreoutboundlinev3");
    }
    ...
    public List<PreOutBoundLineV2> findPreOutBoundLine(FindPreOutBoundLineV2 findPreOutBoundLineV2) throws ParseException {
        ...
        Dataset<Row> periodicLineQuery = sparkSession.sql("Select "
                ...
                + "From tblpreoutboundlinev3 Where IS_DELETED = 0 "
        );
