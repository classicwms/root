...
@Service
@Slf4j
public class StagingLineV2Service {
    ...
    public StagingLineV2Service() throws ParseException {
        ...
        //Read from Sql Table
        val df2 = sparkSession.read().option("fetchSize", "10000").jdbc("jdbc:sqlserver://10.10.10.61;databaseName=WMS_ALMPRD", "tblstagingline", connProp)
                .repartition(16);
        df2.createOrReplaceTempView("tblstaginglineV3");
    }
    ...
    public List<StagingLineV2> findStagingLineV2(FindStagingLineV2 findStagingLineV2) throws ParseException {
        ...
        Dataset<Row>
                ...
                "FROM tblstaginglineV3 WHERE IS_DELETED = 0 ");
