...
public class SparkStagingLineV2Service {
    ...
    public SparkStagingLineV2Service() throws ParseException {
        ...
        sparkSession = SparkSession.builder().master("local[*]").appName("StagingLine.com")
//                .config("spark.executor.memory", "4g")
//                .config("spark.executor.cores", "4")
                .getOrCreate();

        //Read from Sql Table
        val df2 = sparkSession.read().option("fetchSize", "10000").jdbc("jdbc:sqlserver://10.10.6.30;databaseName=WMS_ALMPRD", "tblstagingline", connProp)
                .repartition(16);
