...
public class SparkPreOutBoundLineService {
    ...
    public SparkPreOutBoundLineService() {
        ...
        sparkSession = SparkSession.builder().master("local[*]").appName("PeriodicHeader.com")
...
//                .config("spark.executor.cores", "4")
        ...
        val df2 = sparkSession.read()
                ...
                .jdbc("jdbc:sqlserver://10.10.6.30;databaseName=WMS_ALMPRD", "tblpreoutboundline", connProp)
                .repartition(16);
