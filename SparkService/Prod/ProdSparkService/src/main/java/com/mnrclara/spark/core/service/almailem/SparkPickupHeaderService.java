...
public class SparkPickupHeaderService {
    ...
    public SparkPickupHeaderService() throws ParseException {
        ...
        sparkSession = SparkSession.builder().master("local[*]").appName("PickupHeader.com")
...
//                .config("spark.executor.cores", "4")
        ...
        val df2 = sparkSession.read()
                .option("fetchSize", "10000").jdbc("jdbc:sqlserver://10.10.6.30;databaseName=WMS_ALMPRD", "tblpickupheader", connProp)
                .repartition(16);
