...
public class SparkQualityLineService {
    ...
    public SparkQualityLineService() throws ParseException {
        ...
        sparkSession = SparkSession.builder().master("local[*]").appName("QualityLineExample.com")
//                .config("spark.executor.memory", "4g")
//                .config("spark.executor.cores", "4")
                .getOrCreate();

        //Read from Sql Table
        val df2 = sparkSession.read().jdbc("jdbc:sqlserver://10.10.6.30;databaseName=WMS_ALMPRD", "tblqualityline", connProp)
                .repartition(16);
