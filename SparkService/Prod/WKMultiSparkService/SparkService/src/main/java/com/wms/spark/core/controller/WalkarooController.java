package com.wms.spark.core.controller;


import com.wms.spark.core.model.walkaroo.*;
import com.wms.spark.core.service.WalkarooService;
...
public class WalkarooController {
    ...
    //Get GrLine
    @ApiOperation(response = GrLineV3.class, value = "Spark FindGrLine")
    @PostMapping("/grline")
    public ResponseEntity<?> findGrLineV2(@RequestBody FindGrLineV2 findGrLineV2) throws Exception {
        List<GrLineV3> grLineV2 = walkarooService.findGrLineV2(findGrLineV2);
    ...
    //InboundLine
    @ApiOperation(response = InboundLineV3.class, value = "SparkInboundLine")
    ...
    @PostMapping("/outboundHeader/new/find/v2")
    public ResponseEntity<?> getOutboundHeader(@RequestBody FindOutboundHeaderNew findOutboundHeaderNew) {
        List<OutboundHeaderSpark> outboundHeader =  walkarooService.getOutboundHeader(findOutboundHeaderNew);
        return new ResponseEntity<>(outboundHeader, HttpStatus.OK);
    }

    //=======Find PreOutboundHeader New
    @ApiOperation(response = PreOutboundHeaderNewRes.class, value = "Spark Find PreOutboundHeader New")
    @PostMapping("/preoutboundheader/new")
    public ResponseEntity<?> searchPreOutboundHeaderNew(@RequestBody FindPreOutboundHeaderV2 findPreObHeader) throws Exception {
        List<PreOutboundHeaderNewRes> preObList = walkarooService.findPreOutboundHeaderNew(findPreObHeader);
        return new ResponseEntity<>(preObList, HttpStatus.OK);
    }

    // PickupHeaderV2
    @ApiOperation(response = PickupHeaderNewV2.class, value = "Spark Find PickupHeader")
    @PostMapping("/pickupheader/new")
    public ResponseEntity<?> findPickupHeaderV3(@RequestBody SearchPickupHeaderV2 findPickupHeaderV2) throws Exception {
        List<PickupHeaderNewV2> pickupHeaderV2List = walkarooService.findPickupHeaderV3(findPickupHeaderV2);
        return new ResponseEntity<>(pickupHeaderV2List, HttpStatus.OK);
    }

    // PickupHeaderV2 -- New -- Response
    @ApiOperation(response = NewPickupHeaderRes.class, value = "Spark Find PickupHeader V2 New")
    @PostMapping("/pickupheader/v2/new")
    public ResponseEntity<?> findPickupHeaderV2New(@RequestBody SearchPickupHeaderV2 findPickupHeaderV2) throws Exception {
        List<NewPickupHeaderRes> pickupHeaderV2List = walkarooService.findPickupHeaderV2New(findPickupHeaderV2);
        return new ResponseEntity<>(pickupHeaderV2List, HttpStatus.OK);
    }
}