...
@Service
@Slf4j
public class TPLSparkPreOutBoundLineService {

    Properties connProp = new Properties();
    SparkSession sparkSession = null;
    private static final SimpleDateFormat dateFormat = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");

    public TPLSparkPreOutBoundLineService() {
        ...
        val df2 = sparkSession.read()
                ...
                .jdbc("jdbc:sqlserver://10.10.18.14;databaseName=WMS_3PL", "tblpreoutboundline", connProp)
                .repartition(16);
        df2.createOrReplaceTempView("tblpreoutboundlinev6");
    }
    ...
    public List<PreOutBoundLineV2> findPreOutBoundLine(FindPreOutBoundLineV2 findPreOutBoundLineV2) throws ParseException {
        ...
        Dataset<Row> periodicLineQuery = sparkSession.sql("Select "
                ...
                + "From tblpreoutboundlinev6 Where IS_DELETED = 0 "
        );
