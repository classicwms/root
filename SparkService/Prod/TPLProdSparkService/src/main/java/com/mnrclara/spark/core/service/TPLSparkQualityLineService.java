...
public class TPLSparkQualityLineService {
    ...
    public TPLSparkQualityLineService() throws ParseException {
        ...
        //Read from Sql Table
        val df2 = sparkSession.read().jdbc("jdbc:sqlserver://10.10.18.14;databaseName=WMS_3PL", "tblqualityline", connProp)
                .repartition(16);
        df2.createOrReplaceTempView("tblqualitylinev6");
    ...
    public List<QualityLineV2> findQualityLineV2(FindQualityLineV2 findQualityLineV2) throws ParseException {
        Dataset<Row>
                ...
                "FROM tblqualitylinev6 WHERE IS_DELETED = 0 ");
