...
@Service
@Slf4j
public class TPLSparkInventoryServiceV3 {
     ...
     * @return
     */
    public List<InventoryV4> getInventory(FindInventoryV3 findInventory) {
        String sqlQuery = "SELECT INV_ID, LANG_ID, C_ID, PLANT_ID, WH_ID, " +
                ...
                "IU_CTD_BY, IU_CTD_ON, UTD_BY, UTD_ON, MFR_CODE, BARCODE_ID, CBM, level_id, tpl_partner_id, tpl_partner_text, CBM_UNIT, CBM_PER_QTY, MFR_NAME, " +
                "ORIGIN, BRAND, REF_DOC_NO, C_TEXT, PLANT_TEXT, WH_TEXT, STCK_TYP_TEXT, STATUS_TEXT, TPL_CBM, TPL_UOM, RATE, " +
                "CURRENCY, TPL_CBM_PER_QTY, TPL_RATE_PER_QTY, TOTAL_TPL_CBM, TOTAL_RATE FROM tblinventory";
        ...
        addCondition(conditions, "tpl_partner_id", findInventory.getThreePLPartnerId());
...
//                .repartition(16);
        ...
        Dataset<InventoryV4> dsJntwebhook = data.as(encJntwebhook);
        List<InventoryV4> result = dsJntwebhook.collectAsList();
