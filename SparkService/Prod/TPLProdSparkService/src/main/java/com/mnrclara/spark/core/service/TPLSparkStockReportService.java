...
@Slf4j
@Service
public class TPLSparkStockReportService {

    Properties connProp = new Properties();
    SparkSession sparkSession = null;

    public TPLSparkStockReportService() throws ParseException {
        ...
        val df2 = sparkSession.read()
                ...
                .jdbc("jdbc:sqlserver://10.10.10.61;databaseName=WMS_3PL", "tblinventory", connProp)
                .repartition(16);
        df2.createOrReplaceTempView("tblinventoryv6");
    }
...
//                + " as availableQty, "
                        ...
                        + "FROM tblinventoryv6 WHERE IS_DELETED = 0 "
        );
