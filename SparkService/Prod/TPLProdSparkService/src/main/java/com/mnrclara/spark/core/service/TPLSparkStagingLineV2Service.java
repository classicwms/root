...
@Service
@Slf4j
public class TPLSparkStagingLineV2Service {
    ...
    public TPLSparkStagingLineV2Service() throws ParseException {
        ...
        //Read from Sql Table
        val df2 = sparkSession.read().option("fetchSize", "10000").jdbc("jdbc:sqlserver://10.10.10.61;databaseName=WMS_3PL", "tblstagingline", connProp)
                .repartition(16);
        df2.createOrReplaceTempView("tblstaginglineV6");
    }
    ...
    public List<StagingLineV2> findStagingLineV2(FindStagingLineV2 findStagingLineV2) throws ParseException {
        ...
        Dataset<Row>
                ...
                "FROM tblstaginglineV6 WHERE IS_DELETED = 0 ");
