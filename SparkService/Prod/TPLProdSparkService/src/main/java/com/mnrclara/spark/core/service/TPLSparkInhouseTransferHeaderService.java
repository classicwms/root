...
@Slf4j
@Service
public class TPLSparkInhouseTransferHeaderService {

    Properties connProp = new Properties();
    SparkSession sparkSession = null;

    public TPLSparkInhouseTransferHeaderService() throws ParseException {
        ...
        val df2 = sparkSession.read()
                ...
                .jdbc("jdbc:sqlserver://10.10.10.61;databaseName=WMS_3PL", "tblinhousetransferheader", connProp)
                .repartition(16);
        df2.createOrReplaceTempView("tblinhousetransferheaderv6");
    }
    ...
    public List<InhouseTransferHeader> getAllInhouseTransferHeader() throws ParseException {
        ...
        Dataset<Row> inhouseTransferHeaderQuery = sparkSession.sql("SELECT "
                ...
                + "From tblinhousetransferheaderv6 where IS_DELETED = 0 "
        );
