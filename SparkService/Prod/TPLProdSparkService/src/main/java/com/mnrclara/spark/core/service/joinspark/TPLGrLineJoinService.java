...
@Service
@Slf4j
public class TPLGrLineJoinService {
    ...
    public List<GrLineV3> findGrLine(FindGrLineV2 findGrLineV2) {
        ...
        ConditionUtils.doubleConditions(conditions, "gl.TPL_CBM", findGrLineV2.getThreePLCbm());
        ConditionUtils.addCondition(conditions, "gl.TPL_UOM", findGrLineV2.getThreePLUom());
        ConditionUtils.addCondition(conditions, "gl.TPL_BILL_STATUS", findGrLineV2.getThreePLBillStatus());
        ConditionUtils.doubleConditions(conditions, "gl.TPL_WIDTH", findGrLineV2.getThreePLWidth());
        ConditionUtils.doubleConditions(conditions, "gl.TPL_LENGTH", findGrLineV2.getThreePLLength());
        ConditionUtils.doubleConditions(conditions, "gl.TPL_HEIGHT", findGrLineV2.getThreePLHeight());
        ...
        Properties conn = DatabaseConnectionUtil.getDatabaseConnectionPropertiesThreePL();
        String jdbcUrl = DatabaseConnectionUtil.getThreePLJdbcUrl();
