...
@Service
@Slf4j
public class TPLSparkPickupHeaderService {

    Properties connProp = new Properties();
    SparkSession sparkSession = null;

    public TPLSparkPickupHeaderService() throws ParseException {
        ...
        val df2 = sparkSession.read()
                .option("fetchSize", "10000").jdbc("jdbc:sqlserver://10.10.18.14;databaseName=WMS_3PL", "tblpickupheader", connProp)
                .repartition(16);
        df2.createOrReplaceTempView("tblpickupheaderv6");
    }
    ...
    public List<PickupHeaderV2> findPickupHeaderV2(FindPickupHeaderV2 findPickupHeaderV2) throws ParseException {
        ...
        Dataset<Row> imPickupHeaderQuery = sparkSession.sql("SELECT "
                                                                    ...
                                                                    + "FROM tblpickupheaderv6 WHERE IS_DELETED = 0 ");
